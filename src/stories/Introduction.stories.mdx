...
<Meta title="Deposits Vue UI Kit" />
...
# Welcome to the Deposits Vue UI-Kit

<p className="copy-text">
  The Deposits Vue UI Kit is a collection of reusable, fully themeable and
...
<div className="link-list">
  <a
    className="link-item"
    href="https://doc.api.deposits.dev/docs/ui-kit/vue"
    target="_blank"
  >
    <img src={Repo} alt="repo" />
    <span>
      <strong>Ui-Kit Documentation</strong>
      Learn more from our docs
    </span>
  </a>
  <a
    className="link-item"
    href="https://www.figma.com/file/Wi9wPkCWJIbzyriC0oKAW9/Deposits-UI-Kit%2FDesign-System"
    target="_blank"
  >
    <img src={Figma} alt="direction" />
    <span>
      <strong>Figma Components</strong>
      Check out our design system
    </span>
  </a>
  <a
    className="link-item"
    href="https://github.com/DepositsTeam/ui-kit-vue"
    target="_blank"
  >
