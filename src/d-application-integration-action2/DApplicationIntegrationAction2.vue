<template>
  <d-box class="ui-application__card">
    <d-box class="ui-header">
      <d-box is="img" class="ui-logo" :src="logo" :alt="title" />
      <d-text class="ui-label" font-face="heroNew">{{ title }}</d-text>
      <d-text class="ui-text" font-face="circularSTD">{{ description }}</d-text>
    </d-box>
    <d-box class="ui-body">
      <slot name="buttons">
        <d-button
