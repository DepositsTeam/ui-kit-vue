...
const TemplateWithContent = (args) => ({
  ...
  template: `
    <d-box>
      <d-tabs v-bind="args" v-model="activeTab" />
      <d-box v-if="activeTab === 0">
        First set of content
      </d-box>
      <d-box v-if="activeTab === 1">
        Second set of content
      </d-box>
      <d-box v-if="activeTab === 2">
        Third set of content
      </d-box>
      <d-box v-if="activeTab === 3">
        Fourth set of content
      </d-box>
      <d-box v-if="activeTab === 4">
        Fifth set of content
      </d-box>
    </d-box>`,
});
