import{a7 as R,q as $e,k as ze,j as Ge,_ as He}from"./UndoOutlineIcon-7f54b2d3.js";import"./vue.esm-bundler-d253c880.js";import"./floating-ui.dom-c3a31ea6.js";import"./_commonjsHelpers-042e6b4d.js";const Xe={title:"Banner",component:R,argTypes:{title:{control:{type:"text"}},description:{control:{type:"text"}},colorScheme:{control:{type:"select"},options:["default","info","warning","error","success"]},removable:{control:{type:"boolean"}},alignTop:{control:{type:"boolean"}},full:{control:{type:"boolean"},default:!0},smartColor:{control:{type:"color"}},iconColor:{control:{type:"color"}}}},e=o=>({components:{DBanner:R},setup(){return{args:o}},template:'<d-banner v-bind="args" />'}),Je=o=>({components:{DBanner:R,DarkModeProvider:He},setup(){return{args:o}},template:`
  ...
  template: \`<d-banner v-bind="args" />\`
})`,...(ve=(De=v.parameters)==null?void 0:De.docs)==null?void 0:ve.source}}};var Se,ke,Te;S.parameters={...S.parameters,docs:{...(Se=S.parameters)==null?void 0:Se.docs,source:{originalSource:"DarkModeTemplateFactory()",...(Te=(ke=S.parameters)==null?void 0:ke.docs)==null?void 0:Te.source}}};var ye,fe,Be;k.parameters={...k.parameters,docs:{...(ye=k.parameters)==null?void 0:ye.docs,source:{originalSource:`args => ({
  components: {
    DBanner
  },
  setup() {
  ...
  template: \`<d-banner v-bind="args" />\`
})`,...(Be=(fe=k.parameters)==null?void 0:fe.docs)==null?void 0:Be.source}}};var he,Le,Re;T.parameters={...T.parameters,docs:{...(he=T.parameters)==null?void 0:he.docs,source:{originalSource:"DarkModeTemplateFactory()",...(Re=(Le=T.parameters)==null?void 0:Le.docs)==null?void 0:Re.source}}};var xe,Fe,Me;y.parameters={...y.parameters,docs:{...(xe=y.parameters)==null?void 0:xe.docs,source:{originalSource:`args => ({
  components: {
    DBanner
  },
  setup() {
  ...
  template: \`<d-banner v-bind="args" />\`
})`,...(Ae=(we=B.parameters)==null?void 0:we.docs)==null?void 0:Ae.source}}};var Ce,Oe,Ye;h.parameters={...h.parameters,docs:{...(Ce=h.parameters)==null?void 0:Ce.docs,source:{originalSource:"DarkModeTemplateFactory()",...(Ye=(Oe=h.parameters)==null?void 0:Oe.docs)==null?void 0:Ye.source}}};var je,qe,Pe;L.parameters={...L.parameters,docs:{...(je=L.parameters)==null?void 0:je.docs,source:{originalSource:`args => ({
  components: {
    DBanner,
    DAutoLayout,
    DText,
  ...
  \`
})`,...(Pe=(qe=L.parameters)==null?void 0:qe.docs)==null?void 0:Pe.source}}};const Ze=["Default","OnlyDescription","OnlyDescriptionRemoveable","DarkDefault","Success","DarkSuccess","Error","DarkError","Warning","DarkWarning","Info","DarkInfo","DefaultRemovable","DarkDefaultRemovable","SuccessRemovable","DarkSuccessRemovable","ErrorRemovable","DarkErrorRemovable","WarningRemovable","DarkWarningRemovable","InfoRemovable","DarkInfoRemovable","CustomBanner"];export{L as CustomBanner,n as DarkDefault,D as DarkDefaultRemovable,m as DarkError,T as DarkErrorRemovable,g as DarkInfo,h as DarkInfoRemovable,c as DarkSuccess,S as DarkSuccessRemovable,p as DarkWarning,f as DarkWarningRemovable,t as Default,b as DefaultRemovable,d as Error,k as ErrorRemovable,u as Info,B as InfoRemovable,a as OnlyDescription,s as OnlyDescriptionRemoveable,i as Success,v as SuccessRemovable,l as Warning,y as WarningRemovable,Ze as __namedExportsOrder,Xe as default};
//# sourceMappingURL=DBanner.stories-085d18e1.js.map
