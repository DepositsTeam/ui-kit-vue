import{Z as e,C as s,F as A,G as B,q as U,n as F,f as H,E as O}from"./DWysiwyg-b3dacf98.js";import"./vue.esm-bundler-41d8d808.js";import"./floating-ui.dom-c3a31ea6.js";import"./_commonjsHelpers-042e6b4d.js";const j={title:"Forms/Radio Card",component:e,tags:["autodocs"],argTypes:{}},P=a=>({components:{DRadioCard:e,CardIcon:s},data:()=>({value:""}),setup(){return{args:a}},template:`<d-radio-card v-model="value" value="value" v-bind="args">
  <template #icon>
    <card-icon />
  </template>
  </d-radio-card>
  ...
  `}),o=w.bind({});o.args={heading:"One time payment",description:"Use this option to collect a one off payment",expandable:!0};const L=a=>({components:{DRadioCard:e,DFilePicker:A,CardIcon:s},data:()=>({value:""}),setup(){return{args:a}},template:`
    ...
    <p>Radio value is: {{value}}</p>
  `}),r=L.bind({});r.args={heading:"One time payment",description:"Use this option to collect a one off payment",expandable:!0};const N=a=>({components:{DRadioCard:e,CardIcon:s,DHeading:B,DText:U,DAutoLayout:F,DBox:H},data:()=>({value:""}),setup(){return{args:a}},template:`<d-radio-card v-model="value" value="value" v-bind="args">
  <template #icon>
    <card-icon />
  </template>
  <template #heading>
  ...
  template: \`
    ...
    <p>The selected value is {{value}}</p>
  \`
})`,...(S=(E=c.parameters)==null?void 0:E.docs)==null?void 0:S.source}}};const z=["Default","WithLabel","NoIcon","ExpandMode","ExpandModeWithoutIcon","CustomHeadingAndDescription","MultipleCards"];export{i as CustomHeadingAndDescription,n as Default,o as ExpandMode,r as ExpandModeWithoutIcon,c as MultipleCards,d as NoIcon,t as WithLabel,z as __namedExportsOrder,j as default};
//# sourceMappingURL=DRadioCard.stories-e9eb7731.js.map
