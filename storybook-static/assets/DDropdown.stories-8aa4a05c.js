import{ag as p,m as G,a6 as J,h as $}from"./DVerticalMovable-2454bcb3.js";import{s as K}from"./selectProps-2e81a4d1.js";import"./vue.esm-bundler-c1de2c1e.js";import"./iframe-b809c49e.js";import"../sb-preview/runtime.js";import"./_commonjsHelpers-042e6b4d.js";import"./floating-ui.dom-c3a31ea6.js";const te={title:"Forms/Dropdown",component:p,tags:["autodocs"],argTypes:{...G,...K}},l=e=>({components:{DDropdown:p,ThemeProvider:J},data:()=>({value:""}),setup(){return{args:e}},template:`
    <ThemeProvider :initial-theme="{defaultInputSize: 'medium'}">
      <d-dropdown v-model="value" v-bind="args" />
    </ThemeProvider>
  `}),q=e=>({components:{DDropdown:p},data:()=>({value:"identity",internalOptions:[{text:"Banking kit",value:"banking"},{text:"Money kit",value:"money"},{text:"Identity kit",value:"identity"},{text:"UI kit",value:"ui"},{text:"Commerce kit",value:"commerce"}]}),setup(){return{args:e}},mounted(){setTimeout(()=>{this.value="ui",this.internalOptions=[{text:"Money kit",value:"money"},{text:"Identity kit",value:"identity"},{text:"UI kit",value:"ui"},{text:"Commerce kit",value:"commerce"}]},3e3)},template:`
    <d-dropdown v-model="value" v-bind="args" :options="internalOptions" />
    <p>Selected value is: {{value}}</p>
  `}),N=e=>({components:{DDropdown:p,DarkModeProvider:$},data:()=>({value:"identity"}),setup(){return{args:e}},template:`
    <dark-mode-provider :dark-mode="true">
      <d-dropdown v-bind="args" v-model="value" />
    </dark-mode-provider>
    `}),Q=e=>({components:{DDropdown:p,DarkModeProvider:$},data:()=>({value:""}),setup(){return{args:e}},template:`
    <dark-mode-provider :dark-mode="true">
      <d-dropdown v-bind="args" v-model="value" />
    </dark-mode-provider>
  ...
  \`
})`,...(b=(x=r.parameters)==null?void 0:x.docs)==null?void 0:b.source}}};var T,P,h;a.parameters={...a.parameters,docs:{...(T=a.parameters)==null?void 0:T.docs,source:{originalSource:`args => ({
  components: {
    DDropdown,
    ThemeProvider
  },
  ...
  template: \`
    ...
    <p>Selected value is: {{value}}</p>
  \`
})`,...(j=(L=m.parameters)==null?void 0:L.docs)==null?void 0:j.source}}};var A,H,R;u.parameters={...u.parameters,docs:{...(A=u.parameters)==null?void 0:A.docs,source:{originalSource:"DarkModeTemplateFactory(DarkModePredefinedTemplate)",...(R=(H=u.parameters)==null?void 0:H.docs)==null?void 0:R.source}}};const re=["Default","HasError","TextOptions","DefaultDark","Label","LabelDark","Predefined","PredefinedReturnFullObject","PredefinedDark"];export{t as Default,o as DefaultDark,r as HasError,i as Label,d as LabelDark,s as Predefined,u as PredefinedDark,m as PredefinedReturnFullObject,a as TextOptions,re as __namedExportsOrder,te as default};
//# sourceMappingURL=DDropdown.stories-8aa4a05c.js.map
