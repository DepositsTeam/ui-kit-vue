import{f as u,i as Z,g as ee,_ as X}from"./UndoOutlineIcon-7f54b2d3.js";import"./vue.esm-bundler-d253c880.js";import"./floating-ui.dom-c3a31ea6.js";import"./_commonjsHelpers-042e6b4d.js";const de={title:"Forms/Tag Dropdown",component:u,argTypes:{...Z,placeholder:{control:{type:"text"}},showCheckboxes:{control:{type:"boolean"}},options:{control:{type:"object"}}}},g=e=>({components:{DTagDropdown:u},data:()=>({value:[]}),setup(){return{args:e}},template:'<d-tag-dropdown v-model="value" v-bind="args" />'}),b=e=>({components:{DTagDropdown:u},data:()=>({value:["banking","money"]}),setup(){return{args:e}},template:`
  ...
  template: \`<d-tag-dropdown v-model="value" v-bind="args" />\`
})`,...(V=(R=m.parameters)==null?void 0:R.docs)==null?void 0:V.source}}};const pe=["Default","DefaultDark","Label","LabelDark","StringOptions","StringOptionsDark","PredefinedOptions","PredefinedOptionsWithFullObject","PredefinedOptionsDark","LeftIcon","Loading"];export{n as Default,r as DefaultDark,o as Label,t as LabelDark,c as LeftIcon,m as Loading,p as PredefinedOptions,l as PredefinedOptionsDark,i as PredefinedOptionsWithFullObject,s as StringOptions,d as StringOptionsDark,pe as __namedExportsOrder,de as default};
//# sourceMappingURL=DTagDropdown.stories-4a4bd435.js.map
