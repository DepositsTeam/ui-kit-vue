import{B as v,n as ye,p as We,C as ke,E as _e,_ as Ae}from"./DWysiwyg-c244d28d.js";import"./vue.esm-bundler-a99e1ba3.js";import"./floating-ui.dom-c3a31ea6.js";import"./_commonjsHelpers-042e6b4d.js";const Pe={title:"Tabs",component:v,tags:["autodocs"],argTypes:{tabs:{control:{type:"object"}},horizontal:{control:{type:"boolean"}},spacing:{control:{type:"text"}},initiallyActive:{control:{type:"text"}},inline:{control:{type:"boolean"}},scheme:{control:{type:"select"},options:["button","underline","inline","underline_card"]}}},e=t=>({components:{DTabs:v},setup(){return{args:t}},template:'<d-tabs v-bind="args" />'}),Fe=t=>({components:{DTabs:v,DarkModeProvider:Ae},setup(){return{args:t}},template:`
  ...
  template: \`
    ...
    <d-text>Active Tab Index: {{activeTabIndex}}</d-text>
  \`
})`,...(M=(w=D.parameters)==null?void 0:w.docs)==null?void 0:M.source}}};var E,j,z;s.parameters={...s.parameters,docs:{...(E=s.parameters)==null?void 0:E.docs,source:{originalSource:`args => ({
  components: {
    DTabs
  },
  setup() {
...
//# sourceMappingURL=DTabs.stories-f72010a1.js.map
