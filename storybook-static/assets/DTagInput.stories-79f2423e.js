import{az as h,R as te,_ as re}from"./DAccordion-a3e21a48.js";import"./vue.esm-bundler-e81cbe33.js";import"./iframe-003e986f.js";import"../sb-preview/runtime.js";import"./_commonjsHelpers-87174ba5.js";const pe={title:"Forms/Tag Input",component:h,tags:["autodocs"],argTypes:{...te,label:{control:{type:"text"}},size:{control:{type:"select"},options:["small","medium","large","xlarge","huge","massive"]},values:{control:{type:"object"},table:{defaultValue:["Option 1","Option 2","Option 3"]}},tagDelimiterKey:{control:{type:"select"},options:["enter","comma","space"],table:{defaultValue:"enter"}}}},n=o=>({components:{DTagInput:h},data:()=>({input:["Option one","Option 2","Option 3"]}),methods:{onTagAdded:function(e,a){console.log(e,a)},onTagChanged:function(e,a){console.log(e,a)},onTagDeleted:function(e,a){console.log(e,a)},onTextChanged:function(e){console.log(e)}},setup(){return{args:o}},template:'<d-tag-input @tag-added="onTagAdded" @text-changed="onTextChanged" @tag-deleted="onTagDeleted" @tag-changed="onTagChanged" v-model="input" v-bind="args" />'}),ge=o=>({components:{DTagInput:h,DarkModeProvider:re},data:()=>({input:["Option one","Option 2","Option 3"]}),methods:{onTagAdded:function(e,a){console.log(e,a)},onTagChanged:function(e,a){console.log(e,a)},onTagDeleted:function(e,a){console.log(e,a)},onTextChanged:function(e){console.log(e)}},setup(){return{args:o}},template:`
  ...
  template: \`<d-tag-input @tag-added="onTagAdded" @text-changed="onTextChanged" @tag-deleted="onTagDeleted" @tag-changed="onTagChanged" v-model="input" v-bind="args" />\`
})`,...(ee=($=A.parameters)==null?void 0:$.docs)==null?void 0:ee.source}}};var ae,ne,oe;y.parameters={...y.parameters,docs:{...(ae=y.parameters)==null?void 0:ae.docs,source:{originalSource:"DarkModeTemplateFactory()",...(oe=(ne=y.parameters)==null?void 0:ne.docs)==null?void 0:oe.source}}};const ue=["SizeMassive","HasError","SizeMassiveDark","SizeHuge","SizeHugeDark","SizeXLarge","SizeXLargeDark","SizeLarge","SizeLargeDark","SizeMedium","SizeMediumDark","SizeSmall","SizeSmallDark"];export{g as HasError,d as SizeHuge,l as SizeHugeDark,p as SizeLarge,u as SizeLargeDark,r as SizeMassive,s as SizeMassiveDark,m as SizeMedium,T as SizeMediumDark,A as SizeSmall,y as SizeSmallDark,c as SizeXLarge,i as SizeXLargeDark,ue as __namedExportsOrder,pe as default};
