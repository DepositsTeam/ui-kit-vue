import{U as l,c as X,g as Z,e as ee,_ as re}from"./DAccordion-15ab541e.js";import"./vue.esm-bundler-90c41ac5.js";import"./_commonjsHelpers-87174ba5.js";const ce={component:l,title:"Stepper",argTypes:{steps:{control:{type:"object"}},currentStep:{control:{type:"number"}},scheme:{control:{type:"select"},options:["variant-1","variant-2"]},activeColor:{control:{type:"color"}},stepMode:{control:{type:"boolean"}}}},r=e=>({components:{DStepper:l},setup(){return{args:e}},template:'<d-stepper v-bind="args" />'}),te=e=>({components:{DStepper:l,DarkModeProvider:re},setup(){return{args:e}},template:`<dark-mode-provider :dark-mode="true">
  ...
  template: \`<d-stepper v-bind="args" />\`
})`,...(A=(h=o.parameters)==null?void 0:h.docs)==null?void 0:A.source}}};var K,T,Y;n.parameters={...n.parameters,docs:{...(K=n.parameters)==null?void 0:K.docs,source:{originalSource:`args => ({
  components: {
    DStepper
  },
  setup() {
  ...
  template: \`<d-stepper v-bind="args" />\`
})`,...(Y=(T=n.parameters)==null?void 0:T.docs)==null?void 0:Y.source}}};var O,_,P;p.parameters={...p.parameters,docs:{...(O=p.parameters)==null?void 0:O.docs,source:{originalSource:`args => ({
  components: {
    DStepper
  },
  setup() {
...
})`,...(L=(J=i.parameters)==null?void 0:J.docs)==null?void 0:L.source}}};var Q,R,V;g.parameters={...g.parameters,docs:{...(Q=g.parameters)==null?void 0:Q.docs,source:{originalSource:`args => ({
  components: {
    DStepper,
    DText,
    DBadge
