import{X as c,_ as X}from"./UndoOutlineIcon-91ddd5e0.js";import"./vue.esm-bundler-d253c880.js";import"./floating-ui.dom-c3a31ea6.js";import"./_commonjsHelpers-042e6b4d.js";const K={title:"Forms/Phone Field",component:c,argTypes:{size:{control:{type:"select"},options:["small","medium","large","xlarge","huge","massive"]},disabled:{control:{type:"boolean"}},errorMessage:{control:{type:"text"}},code:{control:{type:"text"}},phoneNumber:{control:{type:"boolean"}}}},m=e=>({components:{DPhoneInput:c},data:()=>({code:"",number:""}),setup(){return{args:e}},template:'<d-phone-input v-bind="args" v-model:code.lazy="code" v-model:phone-number="number"  />'}),j=e=>({components:{DPhoneInput:c},data:()=>({code:"",number:"+13332392383"}),setup(){return{args:e}},template:'<d-phone-input v-bind="args" v-model:code.lazy="code" v-model:phone-number="number"  />'}),r=j.bind({});r.args={isUs:!0};const q=e=>({components:{DPhoneInput:c,DarkModeProvider:X},data:()=>({code:"",number:""}),setup(){return{args:e}},template:`
    <dark-mode-provider :dark-mode="true">
      <d-phone-input v-bind="args" v-model:code.lazy="code" v-model:phone-number="number"  />
    </dark-mode-provider>
  `}),u=()=>{const e=q.bind({});return e.decorators=[()=>({template:'<div style="padding: 3em; background: #121A26;"><story /></div>'})],e},o=m.bind({});o.args={placeholder:"Input placeholder",label:"Form Label"};const a=u();a.args={placeholder:"Input placeholder",label:"Form Label"};const n=m.bind({});n.args={placeholder:"US Number",label:"Form Label",isUs:!0};const t=u();t.args={placeholder:"US Number",label:"Form Label",isUs:!0};const s=m.bind({});s.args={placeholder:"Input placeholder",label:"Form Label",disabled:!0};const d=u();d.args={placeholder:"Input placeholder",label:"Form Label",disabled:!0};const p=m.bind({});p.args={placeholder:"Input placeholder",label:"Form Label",errorMessage:"Error Message"};const l=u();l.args={placeholder:"Input placeholder",label:"Form Label",errorMessage:"Error Message"};var i,b,g;r.parameters={...r.parameters,docs:{...(i=r.parameters)==null?void 0:i.docs,source:{originalSource:`args => ({
  components: {
    DPhoneInput
  },
  data: () => ({
...
//# sourceMappingURL=DPhoneInput.stories-a4446afa.js.map
