import{O as d,f as M}from"./DAccordion-CN3Js_XK.js";import"./vue.esm-bundler-DYd614QV.js";import"./iframe-DxcWvM7r.js";import"../sb-preview/runtime.js";import"./_commonjsHelpers-BosuxZz1.js";const T={title:"Forms/Counter",component:d,tags:["autodocs"],argTypes:{fontFace:{control:{type:"text"}},errorMessage:{control:{type:"text"}},name:{control:{type:"text"}},label:{control:{type:"text"}},labelFontFace:{control:{type:"text"}},labelClass:{control:{type:"text"}},placeholder:{control:{type:"text"}}}},o=s=>({components:{DCounter:d},data:()=>({value:""}),setup(){return{args:s}},template:'<d-counter v-model="value" v-bind="args"></d-counter>'}),I=s=>({components:{DCounter:d,DarkModeProvider:M},data:()=>({value:""}),setup(){return{args:s}},template:`
