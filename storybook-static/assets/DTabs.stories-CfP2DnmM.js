import{aq as v,h as ye,n as _e,r as We,a0 as ke,f as Ae}from"./DAccordion-DtIPJR-6.js";import"./vue.esm-bundler-CUqwZzoc.js";import"./iframe-CP2-vDLq.js";import"../sb-preview/runtime.js";import"./_commonjsHelpers-BosuxZz1.js";const Oe={title:"Tabs",component:v,tags:["autodocs"],argTypes:{tabs:{control:{type:"object"}},horizontal:{control:{type:"boolean"}},spacing:{control:{type:"text"}},initiallyActive:{control:{type:"text"}},inline:{control:{type:"boolean"}},scheme:{control:{type:"select"},options:["button","underline","inline","underline_card"]}}},e=t=>({components:{DTabs:v},setup(){return{args:t}},template:'<d-tabs v-bind="args" />'}),Fe=t=>({components:{DTabs:v,DarkModeProvider:Ae},setup(){return{args:t}},template:`
  ...
  template: \`
    ...
    <d-text>Active Tab Index: {{activeTabIndex}}</d-text>
  \`
})`,...(M=(w=D.parameters)==null?void 0:w.docs)==null?void 0:M.source}}};var $,j,q;s.parameters={...s.parameters,docs:{...($=s.parameters)==null?void 0:$.docs,source:{originalSource:`args => ({
  components: {
    DTabs
  },
  setup() {
  ...
  template: \`<d-tabs v-bind="args" />\`
})`,...(q=(j=s.parameters)==null?void 0:j.docs)==null?void 0:q.source}}};var z,E,O;o.parameters={...o.parameters,docs:{...(z=o.parameters)==null?void 0:z.docs,source:{originalSource:`args => ({
  components: {
    DTabs
  },
  setup() {
  ...
  template: \`<d-tabs v-bind="args" />\`
})`,...(O=(E=o.parameters)==null?void 0:E.docs)==null?void 0:O.source}}};var P,G,H;d.parameters={...d.parameters,docs:{...(P=d.parameters)==null?void 0:P.docs,source:{originalSource:`args => ({
  components: {
    DTabs
  },
  setup() {
