import{I as f,j as k}from"./DVerticalMovable-29e3531d.js";import"./vue.esm-bundler-d8a916b0.js";import"./_commonjsHelpers-042e6b4d.js";import"./floating-ui.dom-c3a31ea6.js";const H={title:"Menu (Context or Dropdown menu)",component:f,tags:["autodocs"],argTypes:{}},i=n=>({components:{DMenu:f,DButton:k},data:()=>({}),methods:{consoleOption:function(B){}},setup(){return{args:n}},template:`<d-menu v-bind="args" @option-clicked="(option) => consoleOption(option, item)">
  <d-button>...</d-button>
...
})`,...(h=(v=s.parameters)==null?void 0:v.docs)==null?void 0:h.source}}};const T=["Default","StringOptions","CustomOptionColor","DisabledOption","HoverTrigger"];export{e as CustomOptionColor,t as Default,r as DisabledOption,s as HoverTrigger,o as StringOptions,T as __namedExportsOrder,H as default};
//# sourceMappingURL=DMenu.stories-7590004c.js.map
