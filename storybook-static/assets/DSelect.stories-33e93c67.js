import{z as V,o as e,i as rr}from"./WalletOutlineIcon-52115379.js";import"./vue.esm-bundler-d57a814c.js";import"./floating-ui.dom-c3a31ea6.js";import"./_commonjsHelpers-87174ba5.js";const dr={title:"Forms/Select Field",component:V,tags:["autodocs"],argTypes:{label:{control:{type:"text"}},size:{control:{type:"select"},options:["small","medium","large","xlarge","huge","massive"]},leftIcon:{control:{type:"object"}},errorMessage:{control:{type:"text"}},wrapperClass:{control:{type:"text"}},options:{control:{type:"object"},table:{defaultValue:["Item 1","Item 2","Item 3"]}},placeholderEffect:{control:{type:"boolean"},table:{defaultValue:!0}},disabled:{control:{type:"boolean"}},optionTitle:{control:{type:"text"}},optionValue:{control:{type:"text"}},returnFullObject:{control:{type:"boolean"}}}},ar=o=>({components:{DSelect:V,DarkModeProvider:rr},data:()=>({value:""}),setup(){return{args:o}},template:`
  ...
  template: \`
    <d-select v-bind="args" />\`
})`,...(we=(Ie=k.parameters)==null?void 0:Ie.docs)==null?void 0:we.source}}};var Te,xe,Ve;F.parameters={...F.parameters,docs:{...(Te=F.parameters)==null?void 0:Te.docs,source:{originalSource:"DarkModeTemplateFactory()",...(Ve=(xe=F.parameters)==null?void 0:xe.docs)==null?void 0:Ve.source}}};var he,Ee,Pe;f.parameters={...f.parameters,docs:{...(he=f.parameters)==null?void 0:he.docs,source:{originalSource:`args => ({
  components: {
    DSelect
  },
  setup() {
...
//# sourceMappingURL=DSelect.stories-33e93c67.js.map
