import{n as i,M as t,f as m}from"./DTooltip-2f321ebd.js";import"./vue.esm-bundler-673e2372.js";import"./floating-ui.dom-c3a31ea6.js";import"./_commonjsHelpers-042e6b4d.js";const f={components:{DAutoLayout:i},title:"Forms/Restricted Color Config",component:t,argTypes:{label:{control:{type:"text"},default:"Color"},colors:{control:{type:"object"}}}},u=r=>({components:{DRestrictedColorConfig:t},data:()=>({value:""}),setup(){return{args:r}},template:`
...
`}),e=C.bind({});e.args={colors:[{colorCode:"#0C9CCC",colorName:"Teal"},{colorCode:"#1A8B5A",colorName:"Green"},{colorCode:"#2A2E33",colorName:"Black"},{colorCode:"#971E31",colorName:"Red"},{colorCode:"#E1E7EC",colorName:"White"},{colorCode:"#E06104",colorName:"Orange"},{colorCode:"#0059AC",colorName:"Blue"},{colorCode:"#4D36C0",colorName:"Purple"}],label:"Color"};var a,l,n;o.parameters={...o.parameters,docs:{...(a=o.parameters)==null?void 0:a.docs,source:{originalSource:`args => ({
  ...
  template: \`
      <d-restricted-color-config v-model="value" v-bind="args"/>\`
})`,...(n=(l=o.parameters)==null?void 0:l.docs)==null?void 0:n.source}}};var c,d,s;e.parameters={...e.parameters,docs:{...(c=e.parameters)==null?void 0:c.docs,source:{originalSource:`args => ({
  components: {
    DRestrictedColorConfig,
    DText,
    DAutoLayout
...
//# sourceMappingURL=DRestrictedColorConfig.stories-3fd4c470.js.map
