import{au as c,h as P,_ as A}from"./DWysiwyg-df288270.js";import"./vue.esm-bundler-2d9db5c2.js";import"./iframe-f2f86901.js";import"../sb-preview/runtime.js";import"./_commonjsHelpers-042e6b4d.js";import"./floating-ui.dom-c3a31ea6.js";const H={title:"Forms/Checkbox",component:c,tags:["autodocs"],argTypes:{wrapperClass:{control:{type:"text"}},disabled:{control:{type:"boolean"}},alignToTop:{control:{type:"boolean"}},dashed:{control:{type:"boolean"}},label:{control:{type:"text"}},labelClass:{control:{type:"text"}},top:{control:{type:"boolean"}},alignRight:{control:{type:"boolean"}}}},l=e=>({components:{DCheckbox:c},data:()=>({value:!1}),setup:function(){return{args:e}},template:'<d-checkbox v-bind="args" v-model="value" />'}),L=e=>({components:{DCheckbox:c,DarkModeProvider:A},data:()=>({value:!1}),setup(){return{args:e}},template:`
...
//# sourceMappingURL=DCheckbox.stories-bd6fdf78.js.map
