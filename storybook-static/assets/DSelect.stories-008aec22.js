import{C as E,n as rr,o as e,h as ar}from"./DVerticalMovable-37a23178.js";import"./vue.esm-bundler-c1de2c1e.js";import"./_commonjsHelpers-042e6b4d.js";import"./floating-ui.dom-c3a31ea6.js";const mr={title:"Forms/Select Field",component:E,tags:["autodocs"],argTypes:{...rr,leftIcon:{control:{type:"object"}},placeholderEffect:{control:{type:"boolean"},table:{defaultValue:!0}}}},or=o=>({components:{DSelect:E,DarkModeProvider:ar},data:()=>({value:""}),setup(){return{args:o}},template:`
    <dark-mode-provider :dark-mode="true">
    <d-select v-bind="args" />
    </dark-mode-provider>
  `}),r=()=>{const o=or.bind({});return o.decorators=[()=>({template:'<div style="padding: 3em; background: #121A26;"><story /></div>'})],o},a=o=>({components:{DSelect:E},setup(){return{args:o}},template:`
    <d-select v-bind="args" />`}),sr=o=>({components:{DSelect:E},data:()=>({value:""}),setup(){return{args:o}},template:`
    <d-select v-bind="args" v-model="value" />
    <span>Selected value is: {{value}}</span>
  `}),nr=o=>({components:{DSelect:E},data:()=>({value:"001",options:[{id:"001",name:"Ted Mosby",sitcom:"How I Met Your Mother"},{id:"002",name:"Cameron Tucker",sitcom:"Modern Family"},{id:"003",name:"Ron Swanson",sitcom:"Parks and Recreation"}]}),setup(){return{args:o}},template:`
    s<d-select v-bind="args" v-model="value" :options="options" />
    <span>Selected value is: {{value}}</span>
  `}),s=a.bind({});s.args={label:"Form Label",size:"huge",options:["Plastic off the sofa","Flaccid gyroscopy"]};const n=r();n.args={label:"Form Label"};const t=a.bind({});t.args={label:"Form Label",disabled:!0};const c=r();c.args={label:"Form Label",disabled:!0};const l=a.bind({});l.args={label:"Form Label",errorMessage:"Error Message"};const d=r();d.args={label:"Form Label",errorMessage:"Error Message"};const m=a.bind({});m.args={label:"Form Label",leftIcon:e};const p=r();p.args={label:"Form Label",leftIcon:e};const i=a.bind({});i.args={label:"Form Label",dropDown:!0};const u=r();u.args={label:"Form Label",dropDown:!0};const g=a.bind({});g.args={label:"Form Label",dropDown:!0,leftIcon:e};const D=r();D.args={label:"Form Label",dropDown:!0,leftIcon:e};const b=a.bind({});b.args={label:"Form Label",dropDown:!0,leftIcon:e,size:"massive"};const S=r();S.args={label:"Form Label",dropDown:!0,leftIcon:e,size:"massive"};const M=a.bind({});M.args={label:"Form Label",dropDown:!0,leftIcon:e,size:"huge"};const v=r();v.args={label:"Form Label",dropDown:!0,leftIcon:e,size:"huge"};const k=a.bind({});k.args={label:"Form Label",dropDown:!0,leftIcon:e,size:"xlarge"};const F=r();F.args={label:"Form Label",dropDown:!0,leftIcon:e,size:"xlarge"};const L=a.bind({});L.args={label:"Form Label",dropDown:!0,leftIcon:e,size:"large"};const f=r();f.args={label:"Form Label",dropDown:!0,leftIcon:e,size:"large"};const z=a.bind({});z.args={label:"Form Label",dropDown:!0,leftIcon:e,size:"medium"};const w=r();w.args={label:"Form Label",dropDown:!0,leftIcon:e,size:"medium"};const I=a.bind({});I.args={label:"Form Label",dropDown:!0,leftIcon:e,size:"small"};const y=r();y.args={label:"Form Label",dropDown:!0,leftIcon:e,size:"small"};const T=sr.bind({});T.args={size:"medium"};const h=nr.bind({});h.args={optionTitle:"name",optionValue:"id",returnFullObject:!0};var V,P,_;s.parameters={...s.parameters,docs:{...(V=s.parameters)==null?void 0:V.docs,source:{originalSource:`args => ({
  components: {
    DSelect
  },
  setup() {
  ...
  template: \`
    <d-select v-bind="args" />\`
})`,...(_=(P=s.parameters)==null?void 0:P.docs)==null?void 0:_.source}}};var A,H,x;n.parameters={...n.parameters,docs:{...(A=n.parameters)==null?void 0:A.docs,source:{originalSource:"DarkModeTemplateFactory()",...(x=(H=n.parameters)==null?void 0:H.docs)==null?void 0:x.source}}};var R,X,C;t.parameters={...t.parameters,docs:{...(R=t.parameters)==null?void 0:R.docs,source:{originalSource:`args => ({
  components: {
    DSelect
  },
  setup() {
  ...
  template: \`
    <d-select v-bind="args" />\`
})`,...(ye=(Ie=k.parameters)==null?void 0:Ie.docs)==null?void 0:ye.source}}};var Te,he,Ee;F.parameters={...F.parameters,docs:{...(Te=F.parameters)==null?void 0:Te.docs,source:{originalSource:"DarkModeTemplateFactory()",...(Ee=(he=F.parameters)==null?void 0:he.docs)==null?void 0:Ee.source}}};var Ve,Pe,_e;L.parameters={...L.parameters,docs:{...(Ve=L.parameters)==null?void 0:Ve.docs,source:{originalSource:`args => ({
  components: {
    DSelect
  },
  setup() {
  ...
  template: \`
    <d-select v-bind="args" />\`
})`,...(_e=(Pe=L.parameters)==null?void 0:Pe.docs)==null?void 0:_e.source}}};var Ae,He,xe;f.parameters={...f.parameters,docs:{...(Ae=f.parameters)==null?void 0:Ae.docs,source:{originalSource:"DarkModeTemplateFactory()",...(xe=(He=f.parameters)==null?void 0:He.docs)==null?void 0:xe.source}}};var Re,Xe,Ce;z.parameters={...z.parameters,docs:{...(Re=z.parameters)==null?void 0:Re.docs,source:{originalSource:`args => ({
  components: {
    DSelect
  },
  setup() {
  ...
  template: \`
    ...
    <span>Selected value is: {{value}}</span>
  \`
})`,...(Ue=(Qe=T.parameters)==null?void 0:Qe.docs)==null?void 0:Ue.source}}};var We,Ze,er;h.parameters={...h.parameters,docs:{...(We=h.parameters)==null?void 0:We.docs,source:{originalSource:`args => ({
  components: {
    DSelect
  },
  data: () => ({
