import{B as x,d as Q,c as R,C as V,E as X,_ as Y}from"./DWysiwyg-d71235a5.js";import"./vue.esm-bundler-64d654d1.js";import"./floating-ui.dom-c3a31ea6.js";import"./_commonjsHelpers-87174ba5.js";const oe={title:"Tabs",component:x,argTypes:{tabs:{control:{type:"object"}},horizontal:{control:{type:"boolean"}},spacing:{control:{type:"text"}},initiallyActive:{control:{type:"text"}},inline:{control:{type:"boolean"}},scheme:{control:{type:"select"},options:["button","underline","inline","underline_card"]}}},t=e=>({components:{DTabs:x},setup(){return{args:e}},template:'<d-tabs v-bind="args" />'}),Z=e=>({components:{DTabs:x,DarkModeProvider:Y},setup(){return{args:e}},template:`
  ...
  template: \`<d-tabs v-bind="args" />\`
})`,...(k=(y=n.parameters)==null?void 0:y.docs)==null?void 0:k.source}}};var B,_,U;s.parameters={...s.parameters,docs:{...(B=s.parameters)==null?void 0:B.docs,source:{originalSource:`args => ({
  components: {
    DTabs
  },
  setup() {
  ...
  template: \`<d-tabs v-bind="args" />\`
})`,...(U=(_=s.parameters)==null?void 0:_.docs)==null?void 0:U.source}}};var A,W,F;d.parameters={...d.parameters,docs:{...(A=d.parameters)==null?void 0:A.docs,source:{originalSource:`args => ({
  components: {
    DTabs
  },
  setup() {
  ...
  template: \`<d-tabs v-bind="args" />\`
})`,...(F=(W=d.parameters)==null?void 0:W.docs)==null?void 0:F.source}}};var w,M,E;o.parameters={...o.parameters,docs:{...(w=o.parameters)==null?void 0:w.docs,source:{originalSource:`args => ({
  components: {
    DTabs,
    DFilterDropdown
  },
  ...
  \`
})`,...(E=(M=o.parameters)==null?void 0:M.docs)==null?void 0:E.source}}};var j,z,O;b.parameters={...b.parameters,docs:{...(j=b.parameters)==null?void 0:j.docs,source:{originalSource:`args => ({
  components: {
    DTabs
  },
  setup() {
  ...
  template: \`<d-tabs v-bind="args" />\`
})`,...(O=(z=b.parameters)==null?void 0:z.docs)==null?void 0:O.source}}};var P,$,q;c.parameters={...c.parameters,docs:{...(P=c.parameters)==null?void 0:P.docs,source:{originalSource:`args => ({
  components: {
    DTabs
  },
  setup() {
...
//# sourceMappingURL=DTabs.stories-33e0c075.js.map
