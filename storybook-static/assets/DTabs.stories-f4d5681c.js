import{Q as v,r as ye,o as We,R as ke,S as _e,_ as Ae}from"./DWysiwyg-2a95663d.js";import"./vue.esm-bundler-77038495.js";import"./iframe-8f914adc.js";import"../sb-preview/runtime.js";import"./_commonjsHelpers-042e6b4d.js";import"./floating-ui.dom-c3a31ea6.js";const Re={title:"Tabs",component:v,tags:["autodocs"],argTypes:{tabs:{control:{type:"object"}},horizontal:{control:{type:"boolean"}},spacing:{control:{type:"text"}},initiallyActive:{control:{type:"text"}},inline:{control:{type:"boolean"}},scheme:{control:{type:"select"},options:["button","underline","inline","underline_card"]}}},e=t=>({components:{DTabs:v},setup(){return{args:t}},template:'<d-tabs v-bind="args" />'}),Fe=t=>({components:{DTabs:v,DarkModeProvider:Ae},setup(){return{args:t}},template:`
  ...
  template: \`<d-tabs v-bind="args" />\`
})`,...(E=(z=s.parameters)==null?void 0:z.docs)==null?void 0:E.source}}};var O,P,Q;o.parameters={...o.parameters,docs:{...(O=o.parameters)==null?void 0:O.docs,source:{originalSource:`args => ({
  components: {
    DTabs
  },
  setup() {
  ...
  template: \`<d-tabs v-bind="args" />\`
})`,...(Q=(P=o.parameters)==null?void 0:P.docs)==null?void 0:Q.source}}};var R,$,q;d.parameters={...d.parameters,docs:{...(R=d.parameters)==null?void 0:R.docs,source:{originalSource:`args => ({
  components: {
    DTabs
  },
  setup() {
  ...
  template: \`<d-tabs v-bind="args" />\`
})`,...(N=(L=c.parameters)==null?void 0:L.docs)==null?void 0:N.source}}};var V,X,Y;i.parameters={...i.parameters,docs:{...(V=i.parameters)==null?void 0:V.docs,source:{originalSource:`args => ({
  components: {
    DTabs
  },
  setup() {
