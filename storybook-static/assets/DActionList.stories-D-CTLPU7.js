import{c as a,b as T,d as R}from"./DAccordion-BVk4RD25.js";import"./vue.esm-bundler-CUqwZzoc.js";import"./iframe-DyUYSNBQ.js";import"../sb-preview/runtime.js";import"./_commonjsHelpers-BosuxZz1.js";const j={title:"Action List",component:a,tags:["autodocs"],argTypes:{label:{control:{type:"text"}},list:{control:{type:"object"}},size:{control:{type:"select"},options:["small","medium","large","xlarge","huge","massive"]}}},r=l=>({components:{DActionList:a},setup(){return{args:l}},methods:{alertMessage(J){alert("Hello"),console.log(J)}},template:`
