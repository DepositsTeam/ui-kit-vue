var l=Object.defineProperty;var n=(o,t)=>l(o,"name",{value:t,configurable:!0});import{Z as i,_ as c,g as d}from"./DAccordion-8b25468e.js";import{v as r}from"./vue.esm-bundler-da4a8dbf.js";import"./iframe-e1a5a4b4.js";const u=n(()=>{const o=r("d__pushToast"),t=r("d__clearToasts");return{pushToast:n(p=>{if(o&&typeof o=="function")return o(p);throw Error("The `pushToast` function is not enabled. You probably omitted the ToastProvider.")},"pushToast"),clearToasts:n(()=>t(),"clearToasts")}},"useToast"),w={parameters:{storySource:{source:`import { DButton, ToastProvider, DarkModeProvider, useToast } from "../main";
...
//# sourceMappingURL=DToast.stories-cb24c2d6.js.map
