import{X as j,V as q}from"./DAccordion-DYIgxZVa.js";import"./vue.esm-bundler-XIZ-WwZ4.js";import"./iframe-C0jbynlU.js";import"../sb-preview/runtime.js";import"./_commonjsHelpers-BosuxZz1.js";const J={component:j,title:"Debit Card",tags:["autodocs"],argTypes:{logo:{control:{type:"text"}},cardNo:{control:{type:"text"}},exp:{control:{type:"text"}},cvv:{control:{type:"text"}},name:{control:{type:"text"}},brand:{control:{type:"select"},options:q}}},r=k=>({components:{DDebitCard:j},setup(){return{args:k}},template:'<d-debit-card v-bind="args" />'}),c=r.bind({}),e=r.bind({});e.args={exp:"2032-12"};e.storyName="Exp (YYYY-MM)";const a=r.bind({});a.args={exp:"12-2032"};a.storyName="Exp (MM-YYYY)";const s=r.bind({});s.args={exp:"2032/12"};s.storyName="Exp (YYYY/MM)";const t=r.bind({});t.args={exp:"12/2032"};t.storyName="Exp (MM/YYYY)";const n=r.bind({});n.args={exp:"12-32"};n.storyName="Exp (MM-YY)";const o=r.bind({});o.args={exp:"12/32"};o.storyName="Exp (MM/YY)";const p=r.bind({});p.args={lastFourCardNo:"1234",exp:"12/2032"};const d=r.bind({});d.args={firstFourCardNo:"5399",lastFourCardNo:"1234",exp:"12/2032"};var i,m,u;c.parameters={...c.parameters,docs:{...(i=c.parameters)==null?void 0:i.docs,source:{originalSource:`args => ({
  components: {
    DDebitCard
  },
  setup() {
  ...
  template: \`<d-debit-card v-bind="args" />\`
})`,...(O=(B=p.parameters)==null?void 0:B.docs)==null?void 0:O.source}}};var V,X,h;d.parameters={...d.parameters,docs:{...(V=d.parameters)==null?void 0:V.docs,source:{originalSource:`args => ({
  components: {
    DDebitCard
  },
  setup() {
  ...
  template: \`<d-debit-card v-bind="args" />\`
})`,...(h=(X=d.parameters)==null?void 0:X.docs)==null?void 0:h.source}}};const K=["Default","ExpYYYMMMM1","ExpYYYMMMM2","ExpYYYMMMM3","ExpYYYMMMM4","ExpMMYY1","ExpMMYY4","LastFourDigits","FirstAndLastFourDigits"];export{c as Default,n as ExpMMYY1,o as ExpMMYY4,e as ExpYYYMMMM1,a as ExpYYYMMMM2,s as ExpYYYMMMM3,t as ExpYYYMMMM4,d as FirstAndLastFourDigits,p as LastFourDigits,K as __namedExportsOrder,J as default};
