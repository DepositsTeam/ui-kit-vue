import{B as s}from"./DWysiwyg-3bd6c6b4.js";import"./vue.esm-bundler-673e2372.js";import"./floating-ui.dom-c3a31ea6.js";import"./_commonjsHelpers-042e6b4d.js";const C={title:"Forms/Filter Dropdown",component:s,argTypes:{}},_=e=>({components:{DFilterDropdown:s},data:()=>({value:""}),setup(){return{args:e}},template:'<d-filter-dropdown v-model="value" v-bind="args" />'}),t=_.bind({});t.args={options:[{text:"All Time",value:"all_time"},{text:"Today",value:"today"},{text:"This month",value:"this_month"}]};const d=e=>({components:{DFilterDropdown:s},setup(){return{args:e}},data:()=>({value:""}),template:`
  ...
  template: \`
    ...
    <p>{{value}}</p>
  \`
})`,...(V=(D=l.parameters)==null?void 0:D.docs)==null?void 0:V.source}}};const B=["Default","ReturnFullObject","ReturnOnlyValue","PredefinedValueWithOnlyValue","PredefinedValueWithOnlyFullObject","CustomOptionTitleAndValue"];export{l as CustomOptionTitleAndValue,t as Default,o as PredefinedValueWithOnlyFullObject,r as PredefinedValueWithOnlyValue,n as ReturnFullObject,a as ReturnOnlyValue,B as __namedExportsOrder,C as default};
//# sourceMappingURL=DFilterDropdown.stories-4e1bf2c7.js.map
