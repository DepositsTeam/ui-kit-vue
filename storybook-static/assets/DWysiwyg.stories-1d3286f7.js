import{f as a,c as p}from"./DTooltip-ca5caf4e.js";import"./vue.esm-bundler-673e2372.js";import"./floating-ui.dom-c3a31ea6.js";import"./_commonjsHelpers-042e6b4d.js";const b={components:a,title:"Forms/WYSIWYG Editor",component:a,argTypes:{label:{control:{type:"text"}},labelClass:{control:{type:"text"}},fontFace:{control:{type:"select"},options:["circularSTD","heroNew"]},labelFontFace:{control:{type:"text"}}}},m=e=>({components:{DWysiwyg:a},data:()=>({value:""}),setup(){return{args:e}},template:'<d-wysiwyg v-bind="args" v-model="value"  />'}),i=e=>({components:{DWysiwyg:a,DarkModeProvider:p},data:()=>({value:""}),setup(){return{args:e}},template:`
...
})`,...(n=(s=r.parameters)==null?void 0:s.docs)==null?void 0:n.source}}};var d,l,c;t.parameters={...t.parameters,docs:{...(d=t.parameters)==null?void 0:d.docs,source:{originalSource:"DarkModeTemplateFactory()",...(c=(l=t.parameters)==null?void 0:l.docs)==null?void 0:c.source}}};const k=["Default","DarkDefault"];export{t as DarkDefault,r as Default,k as __namedExportsOrder,b as default};
//# sourceMappingURL=DWysiwyg.stories-1d3286f7.js.map
