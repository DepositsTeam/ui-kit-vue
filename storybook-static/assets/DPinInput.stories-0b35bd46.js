import{V as c,c as L}from"./DTooltip-ca5caf4e.js";import"./vue.esm-bundler-673e2372.js";import"./floating-ui.dom-c3a31ea6.js";import"./_commonjsHelpers-042e6b4d.js";const $={title:"Forms/Pin Input",component:c,argTypes:{spacing:{control:{type:"text"}},password:{control:{type:"boolean"}},noOfCharacters:{control:{type:"number"}}}},l=r=>({components:{DPinInput:c},data:()=>({pin:""}),setup(){return{args:r}},template:`
  ...
  template: \`
    <d-pin-input v-model="pin" v-bind="args" />\`
})`,...(N=(F=n.parameters)==null?void 0:F.docs)==null?void 0:N.source}}};var O,E,V;s.parameters={...s.parameters,docs:{...(O=s.parameters)==null?void 0:O.docs,source:{originalSource:"DarkModeTemplateFactory()",...(V=(E=s.parameters)==null?void 0:E.docs)==null?void 0:V.source}}};var _,H,h;o.parameters={...o.parameters,docs:{...(_=o.parameters)==null?void 0:_.docs,source:{originalSource:`args => ({
  components: {
    DPinInput
  },
  data: () => ({
...
//# sourceMappingURL=DPinInput.stories-0b35bd46.js.map
