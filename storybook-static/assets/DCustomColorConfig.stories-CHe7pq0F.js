import { S as l } from "./DAccordion-DdDUMQ09.js";
...
const u = {
    ...
    argTypes: {
      ...
      colorHeight: { control: { type: "text" }, default: "28.997px" },
  ...
  a = (s) => ({
    components: { DCustomColorConfig: l },
    data: () => ({ value: "#000000" }),
    setup() {
      return { args: s };
    },
...
o.parameters = {
  ...
  template: \`
      ...
      ...((r = (e = o.parameters) == null ? void 0 : e.docs) == null
        ? void 0
        : r.source),
    },
  },
...
const d = ["Default"];
export { o as Default, d as __namedExportsOrder, u as default };
