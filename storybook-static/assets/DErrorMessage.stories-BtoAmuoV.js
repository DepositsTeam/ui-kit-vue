import{$ as s,f as c}from"./DAccordion-DYIgxZVa.js";import"./vue.esm-bundler-XIZ-WwZ4.js";import"./iframe-C0jbynlU.js";import"../sb-preview/runtime.js";import"./_commonjsHelpers-BosuxZz1.js";const v={component:s,title:"Error Message",tags:["autodocs"],argTypes:{errorMessage:{control:{type:"text"}},showIcon:{control:{type:"text"}},redText:{control:{type:"boolean"}},alignToTop:{control:{type:"boolean"}}}},i=o=>({components:{DErrorMessage:s},setup(){return{args:o}},template:'<d-error-message v-bind="args" />'}),g=o=>({components:{DErrorMessage:s,DarkModeProvider:c},setup(){return{args:o}},template:`
