import{F as f,l as k}from"./DVerticalMovable-b7d344e7.js";import"./vue.esm-bundler-c1de2c1e.js";import"./iframe-011ae96e.js";import"../sb-preview/runtime.js";import"./_commonjsHelpers-042e6b4d.js";import"./floating-ui.dom-c3a31ea6.js";const T={title:"Menu (Context or Dropdown menu)",component:f,tags:["autodocs"],argTypes:{}},i=t=>({components:{DMenu:f,DButton:k},data:()=>({}),methods:{consoleOption:function(B){}},setup(){return{args:t}},template:`<d-menu v-bind="args" @option-clicked="(option) => consoleOption(option, item)">
  <d-button>...</d-button>
...
})`,...(h=(v=s.parameters)==null?void 0:v.docs)==null?void 0:h.source}}};const w=["Default","StringOptions","CustomOptionColor","DisabledOption","HoverTrigger"];export{e as CustomOptionColor,n as Default,r as DisabledOption,s as HoverTrigger,o as StringOptions,w as __namedExportsOrder,T as default};
//# sourceMappingURL=DMenu.stories-d0bb230a.js.map
