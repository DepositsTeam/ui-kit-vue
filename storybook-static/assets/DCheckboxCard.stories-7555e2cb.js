import{as as a,I as n,J as w,f as M,K as U,L as J,q as N,p as P}from"./DVerticalMovable-b7d344e7.js";import"./vue.esm-bundler-c1de2c1e.js";import"./iframe-011ae96e.js";import"../sb-preview/runtime.js";import"./_commonjsHelpers-042e6b4d.js";import"./floating-ui.dom-c3a31ea6.js";const ee={title:"Forms/Checkbox Card",component:a,tags:["autodocs"],argTypes:{labelClass:{control:{type:"text"}},labelFontFace:{control:{type:"text"}},heading:{control:{type:"text"}},description:{control:{type:"text"}},label:{control:{type:"text"}},expandOnChecked:{control:{type:"text"}},expandable:{control:{type:"text"}}}},H=e=>({components:{DCheckboxCard:a,CardIcon:n},data:()=>({value:!1}),setup(){return{args:e}},template:`
  ...
  `}),i=$.bind({}),q=e=>({components:{DCheckboxCard:a},data:()=>({value:""}),setup(){return{args:e}},template:`
    ...
    <p>Checkbox value is: {{value}}</p>
  `}),r=q.bind({});r.args={heading:"One time payment",description:"Use this option to collect a one off payment"};const K=e=>({components:{DCheckboxCard:a,DFilePicker:U,CardIcon:n},data:()=>({value:""}),setup(){return{args:e}},template:`
    <d-checkbox-card v-model="value" value="value" v-bind="args">
      <template #icon>
        <card-icon />
      </template>
    ...
    <p>Checkbox value is: {{value}}</p>
  `}),d=K.bind({});d.args={heading:"One time payment",description:"Use this option to collect a one off payment",expandable:!0};const j=e=>({components:{DCheckboxCard:a,DFilePicker:U,CardIcon:n},data:()=>({value:""}),setup(){return{args:e}},template:`
    <d-checkbox-card v-model="value" value="value" v-bind="args">
      <d-file-picker />
    </d-checkbox-card>
    <p>Checkbox value is: {{value}}</p>
  ...
  <p>Checkbox value is: {{value}}</p>
  \`
})`,...(L=(B=l.parameters)==null?void 0:B.docs)==null?void 0:L.source}}};const ae=["WithLabel","TrueOrFalseCheckbox","CheckboxWithValue","CheckboxArray","NoIcon","ExpandMode","ExpandModeWithoutIcon","CustomHeadingAndDescription"];export{i as CheckboxArray,c as CheckboxWithValue,l as CustomHeadingAndDescription,d as ExpandMode,s as ExpandModeWithoutIcon,r as NoIcon,o as TrueOrFalseCheckbox,t as WithLabel,ae as __namedExportsOrder,ee as default};
//# sourceMappingURL=DCheckboxCard.stories-7555e2cb.js.map
