import{aH as c,f as _,i as A}from"./DVerticalMovable-368236d0.js";import"./vue.esm-bundler-c1de2c1e.js";import"./_commonjsHelpers-042e6b4d.js";import"./floating-ui.dom-c3a31ea6.js";const q={title:"Forms/Checkbox",component:c,tags:["autodocs"],argTypes:{wrapperClass:{control:{type:"text"}},disabled:{control:{type:"boolean"}},alignToTop:{control:{type:"boolean"}},dashed:{control:{type:"boolean"}},label:{control:{type:"text"}},labelClass:{control:{type:"text"}},top:{control:{type:"boolean"}},alignRight:{control:{type:"boolean"}}}},l=e=>({components:{DCheckbox:c},data:()=>({value:!1}),setup:function(){return{args:e}},template:'<d-checkbox v-bind="args" v-model="value" />'}),L=e=>({components:{DCheckbox:c,DarkModeProvider:A},data:()=>({value:!1}),setup(){return{args:e}},template:`
  ...
  \`
})`,...(P=(I=d.parameters)==null?void 0:I.docs)==null?void 0:P.source}}};const z=["Default","DarkDefault","Dashed","DarkDashed","Disabled","DarkDisabled","Multiple"];export{r as DarkDashed,o as DarkDefault,n as DarkDisabled,t as Dashed,a as Default,s as Disabled,d as Multiple,z as __namedExportsOrder,q as default};
//# sourceMappingURL=DCheckbox.stories-d0a67a6d.js.map
