import{a0 as s,h as x,_ as M}from"./DWysiwyg-515702cd.js";import"./vue.esm-bundler-77038495.js";import"./iframe-734e6c86.js";import"../sb-preview/runtime.js";import"./_commonjsHelpers-042e6b4d.js";import"./floating-ui.dom-c3a31ea6.js";const Y={title:"Forms/Radio",component:s,tags:["autodocs"],argTypes:{ringed:{control:{type:"boolean"}},alignToTop:{control:{type:"boolean"}},label:{control:{type:"text"}},value:{control:{type:"text"}},disabled:{control:{type:"boolean"}},alignRight:{control:{type:"boolean"}},ringSize:{control:{type:"text"},default:"16px"},ringThickness:{control:{type:"text"},default:"5px"}}},R=e=>({components:{DRadio:s},setup:function(){return{args:e}},template:'<d-radio v-bind="args" />'}),S=e=>({components:{DRadio:s,DarkModeProvider:M},data:()=>({value:""}),setup(){return{args:e}},template:`
  ...
  template: \`
    ...
    \`
})`,...(f=(h=n.parameters)==null?void 0:h.docs)==null?void 0:f.source}}};const z=["Default","DarkDefault","Ringed","DarkRinged","Multiple"];export{o as DarkDefault,t as DarkRinged,a as Default,n as Multiple,r as Ringed,z as __namedExportsOrder,Y as default};
//# sourceMappingURL=DRadio.stories-bc21da1b.js.map
