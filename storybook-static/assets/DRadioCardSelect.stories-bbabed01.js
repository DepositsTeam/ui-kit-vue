import{k as x,l as Z,A as G,H as J,e as c,f as a,u as e,o as r,n as K,j as m,t as g,p as f,g as t,z as Q,B as ee,F as ae}from"./vue.esm-bundler-4e4410a9.js";import{c as te,X as ne,Y as oe,d as h,z as i,e as u,Z as le,$ as w}from"./DWysiwyg-308857eb.js";import"./floating-ui.dom-c3a31ea6.js";import"./_commonjsHelpers-87174ba5.js";const H={__name:"DRadioCardSelect",props:{...ne,label:{type:String},labelClass:{type:String},labelFontFace:{type:String,default:"heroNew"},modelValue:{default:!1},value:{default:!1},options:{type:Array,default:()=>[{title:"Wells Fargo",description:"Checking **7698",otherValue:"othervalue",icon:"https://assets.ondeposits.com/img/ui-kit-demo/payment-methods/wells-fargo.png"},{title:"Bank of America",description:"Checking **1243",otherValue:"othervalue",icon:"https://assets.ondeposits.com/img/ui-kit-demo/payment-methods/bank-of-america.png"},{title:"Citibank",description:"Checking **8350",otherValue:"othervalue",icon:"https://assets.ondeposits.com/img/ui-kit-demo/payment-methods/citi-bank.png"}]},optionTitle:{type:String,default:"title"},optionDescription:{type:String,default:"description"},optionIcon:{type:String,default:"icon"},optionValue:{type:String,default:"value"},returnFullObject:{type:Boolean,default:!1},changeButtonText:{type:String,default:"Change"},radioValue:{default:!1},borderedIcon:{type:Boolean}},emits:["update:radioValue","update:modelValue"],setup(n,{emit:k}){const o=n,{computedOptions:p}=oe(o),D=x(!1);Z(()=>{D.value=!0});const T=G(()=>D.value?o.radioValue===o.value:!1),V=x(!1),U=()=>{V.value=!V.value},l=x(null),X=s=>{l.value=s,V.value=!1,k("update:modelValue",l.value.originalOption)};J(()=>{if(o.modelValue){let s;if(typeof o.modelValue=="string")s=p.value.find(b=>b.value===o.modelValue);else{let b=o.modelValue[o.optionValue]?o.modelValue[o.optionValue]:o.modelValue[o.optionTitle];s=p.value.find(d=>d.value===b)}s||(s=p.value[0]),l.value=s,k("update:modelValue",s.originalOption)}else l.value=p.value[0],k("update:modelValue",l.value.originalOption)});const Y=()=>{k("update:radioValue",o.value)};return(s,b)=>(r(),c(e(u),{class:"d-radio-card-select__wrapper"},{default:a(()=>[n.label?(r(),c(e(h),{key:0,"margin-top":"0px",class:K(["ui-text-field__label",n.labelClass]),scale:"subhead","font-face":n.labelFontFace},{default:a(()=>[m(g(n.label),1)]),_:1},8,["class","font-face"])):f("",!0),t(e(u),{class:"d-radio-card-select",cursor:"pointer"},{default:a(()=>[t(e(i),{"align-items":"center","justify-content":"space-between"},{default:a(()=>[t(e(i),null,{default:a(()=>[l.value.icon?(r(),c(e(u),{key:0,is:"img",src:l.value.icon,alt:l.value.text},null,8,["src","alt"])):f("",!0),t(e(i),{direction:"vertical","item-spacing":"2px"},{default:a(()=>[t(e(h),{my0:"",scale:"subhead","font-weight":"600","font-face":"heroNew"},{default:a(()=>[m(g(l.value.text),1)]),_:1}),t(e(h),{my0:"","font-size":"12px",color:"#8C97A7"},{default:a(()=>[m(g(l.value.description),1)]),_:1})]),_:1})]),_:1}),t(e(i),{"align-items":"center"},{default:a(()=>[e(p).length>1?(r(),c(e(u),{key:0,class:"d-radio-card-select__change-button",onClick:U},{default:a(()=>[t(e(h),{color:"#6D7786",my0:"","font-size":"12px","font-face":"heroNew"},{default:a(()=>[m(g(n.changeButtonText),1)]),_:1}),t(e(le),{"smart-color":"#6D7786"})]),_:1})):f("",!0),t(e(u),{onClick:Y},{default:a(()=>[t(e(w),{ringed:"","ring-size":"24px",checked:e(T),"ring-thickness":"8px"},null,8,["checked"])]),_:1})]),_:1})]),_:1}),V.value?(r(),c(e(u),{key:0,class:"d-radio-card-select__options"},{default:a(()=>[(r(!0),Q(ae,null,ee(e(p),d=>(r(),c(e(u),{class:"d-radio-card-select__option",key:d.unique_identifier_for_dropdown,onClick:ce=>X(d)},{default:a(()=>[t(e(i),{"justify-content":"space-between"},{default:a(()=>[t(e(i),null,{default:a(()=>[d.icon?(r(),c(e(u),{key:0,is:"img",src:d.icon,alt:d.text},null,8,["src","alt"])):f("",!0),t(e(i),{direction:"vertical","item-spacing":"2px"},{default:a(()=>[t(e(h),{my0:"",scale:"subhead","font-weight":"600","font-face":"heroNew"},{default:a(()=>[m(g(d.text),1)]),_:2},1024),t(e(h),{my0:"","font-size":"12px",color:"#8C97A7"},{default:a(()=>[m(g(d.description),1)]),_:2},1024)]),_:2},1024)]),_:2},1024),t(e(i),null,{default:a(()=>[t(e(w),{checked:e(T),ringed:"","ring-size":"24px","ring-thickness":"8px"},null,8,["checked"])]),_:1})]),_:2},1024)]),_:2},1032,["onClick"]))),128))]),_:1})):f("",!0)]),_:1})]),_:1}))}},v=te(H,[["__scopeId","data-v-53653f57"]]);H.__docgenInfo={exportName:"default",displayName:"DRadioCardSelect",description:"",tags:{},props:[{name:"label",type:{name:"string"}},{name:"labelClass",type:{name:"string"}},{name:"labelFontFace",type:{name:"string"},defaultValue:{func:!1,value:'"heroNew"'}},{name:"modelValue",type:{name:"boolean"},defaultValue:{func:!1,value:"false"}},{name:"value",type:{name:"boolean"},defaultValue:{func:!1,value:"false"}},{name:"options",type:{name:"array"},defaultValue:{func:!1,value:`[
  ...
  template: \`
    ...
    <p>Selected value is: {{selected}}</p>
  \`
})`,...(A=(B=y.parameters)==null?void 0:B.docs)==null?void 0:A.source}}};var R,N,z;C.parameters={...C.parameters,docs:{...(R=C.parameters)==null?void 0:R.docs,source:{originalSource:`args => ({
  components: {
    DRadioCardSelect
  },
  setup() {
  ...
  template: \`
    ...
    <p>Selected value is: {{selected}}</p>
  \`
})`,...(z=(N=C.parameters)==null?void 0:N.docs)==null?void 0:z.source}}};var E,M,W;_.parameters={..._.parameters,docs:{...(E=_.parameters)==null?void 0:E.docs,source:{originalSource:`args => ({
  components: {
    DRadioCardSelect
  },
  setup() {
  ...
  <d-radio-card-select v-model="selected" :options="options" v-bind="args" />
  \`
})`,...(W=(M=_.parameters)==null?void 0:M.docs)==null?void 0:W.source}}};var I,P,j;O.parameters={...O.parameters,docs:{...(I=O.parameters)==null?void 0:I.docs,source:{originalSource:`args => ({
  components: {
    DRadioCardSelect,
    DAutoLayout
  },
  ...
  <p>The selected option (radio option) is: {{radioValue}}</p>
  \`
})`,...(j=(P=O.parameters)==null?void 0:P.docs)==null?void 0:j.source}}};var L,$,q;S.parameters={...S.parameters,docs:{...(L=S.parameters)==null?void 0:L.docs,source:{originalSource:`args => ({
  components: {
    DRadioCardSelect,
    DAutoLayout
  },
...
//# sourceMappingURL=DRadioCardSelect.stories-bbabed01.js.map
