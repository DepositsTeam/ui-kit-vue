import{aj as w,n as O,H as T}from"./DVerticalMovable-346dfdf9.js";import"./vue.esm-bundler-c1de2c1e.js";import{s as j}from"./selectProps-2e81a4d1.js";import"./_commonjsHelpers-042e6b4d.js";import"./floating-ui.dom-c3a31ea6.js";const V={component:w,title:"Forms/Country Dropdown",tags:["autodocs"],argTypes:{...O,...j}},r=x=>({components:{DCountryDropdown:w,DSelect:T},data:()=>({country:"",states:[],selectedState:""}),setup(){return{args:x}},methods:{hydrateStates:function(C){this.states=C.map(o=>({text:o.name,value:o.name}))}},template:`
  ...
  template: \`
    ...
    <p>Selected country: {{ country }}</p>
  \`
})`,...(f=(b=a.parameters)==null?void 0:b.docs)==null?void 0:f.source}}};const _=["Default","HasError","ReturnFullObject","UseDifferentTitleAndValue","OnlyUS"];export{t as Default,e as HasError,a as OnlyUS,n as ReturnFullObject,s as UseDifferentTitleAndValue,_ as __namedExportsOrder,V as default};
//# sourceMappingURL=DCountryDropdown.stories-bcdf4b43.js.map
