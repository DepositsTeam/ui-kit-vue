import{ak as d,i as I}from"./WalletOutlineIcon-52115379.js";import"./vue.esm-bundler-d57a814c.js";import"./floating-ui.dom-c3a31ea6.js";import"./_commonjsHelpers-87174ba5.js";const T={title:"Forms/Counter",component:d,tags:["autodocs"],argTypes:{}},t=s=>({components:{DCounter:d},data:()=>({value:""}),setup(){return{args:s}},template:'<d-counter v-model="value" v-bind="args"></d-counter>'}),S=s=>({components:{DCounter:d,DarkModeProvider:I},data:()=>({value:""}),setup(){return{args:s}},template:`
...
//# sourceMappingURL=DCounter.stories-1791c303.js.map
