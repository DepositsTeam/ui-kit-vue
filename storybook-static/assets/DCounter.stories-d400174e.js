import{ab as t,_ as M}from"./DWysiwyg-c27d57d4.js";import"./vue.esm-bundler-f842f4aa.js";import"./floating-ui.dom-c3a31ea6.js";import"./_commonjsHelpers-042e6b4d.js";const E={title:"Forms/Counter",component:t,argTypes:{}},s=o=>({components:{DCounter:t},data:()=>({value:""}),setup(){return{args:o}},template:'<d-counter v-model="value" v-bind="args"></d-counter>'}),f=o=>({components:{DCounter:t,DarkModeProvider:M},data:()=>({value:""}),setup(){return{args:o}},template:`
  ...
  template: \`
    ...
    \`
})`,...(g=(v=a.parameters)==null?void 0:v.docs)==null?void 0:g.source}}};var D,b,k;r.parameters={...r.parameters,docs:{...(D=r.parameters)==null?void 0:D.docs,source:{originalSource:`args => ({
  components: {
    DCounter
  },
  data: () => ({
  ...
  template: \`<d-counter v-model="value" v-bind="args"></d-counter>\`
})`,...(k=(b=r.parameters)==null?void 0:b.docs)==null?void 0:k.source}}};const I=["Default","HasError","DarkDefault","MaxIs10AndMinIs0"];export{a as DarkDefault,n as Default,e as HasError,r as MaxIs10AndMinIs0,I as __namedExportsOrder,E as default};
//# sourceMappingURL=DCounter.stories-d400174e.js.map
