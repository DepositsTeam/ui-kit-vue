import{g as y,_ as ee}from"./DWysiwyg-27755fa2.js";import"./vue.esm-bundler-d253c880.js";import"./floating-ui.dom-c3a31ea6.js";import"./_commonjsHelpers-042e6b4d.js";const ge={title:"Forms/Tag Input",component:y,argTypes:{label:{control:{type:"text"}},size:{control:{type:"select"},options:["small","medium","large","xlarge","huge","massive"]},values:{control:{type:"object"},table:{defaultValue:["Option 1","Option 2","Option 3"]}},tagDelimiterKey:{control:{type:"select"},options:["enter","comma","space"],table:{defaultValue:"enter"}}}},o=n=>({components:{DTagInput:y},data:()=>({input:["Option one","Option 2","Option 3"]}),methods:{onTagAdded:function(e,a){console.log(e,a)},onTagChanged:function(e,a){console.log(e,a)},onTagDeleted:function(e,a){console.log(e,a)},onTextChanged:function(e){console.log(e)}},setup(){return{args:n}},template:'<d-tag-input @tag-added="onTagAdded" @text-changed="onTextChanged" @tag-deleted="onTagDeleted" @tag-changed="onTagChanged" v-model="input" v-bind="args" />'}),ae=n=>({components:{DTagInput:y,DarkModeProvider:ee},data:()=>({input:["Option one","Option 2","Option 3"]}),methods:{onTagAdded:function(e,a){console.log(e,a)},onTagChanged:function(e,a){console.log(e,a)},onTagDeleted:function(e,a){console.log(e,a)},onTextChanged:function(e){console.log(e)}},setup(){return{args:n}},template:`
...
})`,...(b=(D=r.parameters)==null?void 0:D.docs)==null?void 0:b.source}}};var v,S,f;g.parameters={...g.parameters,docs:{...(v=g.parameters)==null?void 0:v.docs,source:{originalSource:"DarkModeTemplateFactory()",...(f=(S=g.parameters)==null?void 0:S.docs)==null?void 0:f.source}}};var z,C,x;s.parameters={...s.parameters,docs:{...(z=s.parameters)==null?void 0:z.docs,source:{originalSource:`args => ({
  components: {
    DTagInput
  },
  data: () => ({
  ...
  template: \`<d-tag-input @tag-added="onTagAdded" @text-changed="onTextChanged" @tag-deleted="onTagDeleted" @tag-changed="onTagChanged" v-model="input" v-bind="args" />\`
})`,...(W=(U=T.parameters)==null?void 0:U.docs)==null?void 0:W.source}}};var Y,Z,$;A.parameters={...A.parameters,docs:{...(Y=A.parameters)==null?void 0:Y.docs,source:{originalSource:"DarkModeTemplateFactory()",...($=(Z=A.parameters)==null?void 0:Z.docs)==null?void 0:$.source}}};const se=["SizeMassive","SizeMassiveDark","SizeHuge","SizeHugeDark","SizeXLarge","SizeXLargeDark","SizeLarge","SizeLargeDark","SizeMedium","SizeMediumDark","SizeSmall","SizeSmallDark"];export{s as SizeHuge,d as SizeHugeDark,i as SizeLarge,p as SizeLargeDark,r as SizeMassive,g as SizeMassiveDark,u as SizeMedium,m as SizeMediumDark,T as SizeSmall,A as SizeSmallDark,l as SizeXLarge,c as SizeXLargeDark,se as __namedExportsOrder,ge as default};
//# sourceMappingURL=DTagInput.stories-668f3f11.js.map
