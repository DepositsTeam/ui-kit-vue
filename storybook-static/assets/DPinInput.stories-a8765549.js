import{a2 as r,a3 as te,_ as ae}from"./DWysiwyg-01175861.js";import"./vue.esm-bundler-64d654d1.js";import"./floating-ui.dom-c3a31ea6.js";import"./_commonjsHelpers-87174ba5.js";const le={title:"Forms/Pin Input",component:r,tags:["autodocs"],argTypes:{spacing:{control:{type:"text"}},password:{control:{type:"boolean"}},noOfCharacters:{control:{type:"number"}}}},u=e=>({components:{DPinInput:r},data:()=>({pin:""}),setup(){return{args:e}},template:`
  ...
  template: \`
    <d-pin-input v-model="pin" v-bind="args" />\`
})`,...(T=(S=n.parameters)==null?void 0:S.docs)==null?void 0:T.source}}};var I,h,w;D.parameters={...D.parameters,docs:{...(I=D.parameters)==null?void 0:I.docs,source:{originalSource:"DarkModeTemplateFactory(DarkDefaultTemplate)",...(w=(h=D.parameters)==null?void 0:h.docs)==null?void 0:w.source}}};var M,F,_;a.parameters={...a.parameters,docs:{...(M=a.parameters)==null?void 0:M.docs,source:{originalSource:`args => ({
  components: {
    DPinInput
  },
  data: () => ({
...
//# sourceMappingURL=DPinInput.stories-a8765549.js.map
