...
export const Default = Template.bind({});
`,locationsMap:{default:{startLoc:{col:17,line:47},endLoc:{col:2,line:53},startBody:{col:17,line:47},endBody:{col:2,line:53}}}}},title:"DatePicker",component:Lo,argTypes:{label:{control:{type:"text"}},dropDown:{control:{type:"boolean"}},size:{control:{type:"select"},options:["small","medium","large","xlarge","huge","massive"]},errorMessage:{control:{type:"text"}},rightIcon:{control:{type:"object"}},leftIcon:{control:{type:"object"}},onlyNumbers:{control:{type:"bolean"}},wrapperClass:{control:{type:"text"}},disabled:{control:{type:"boolean"}},format:{control:{type:"string"}},formatDate:{control:{type:"boolean"}},placeholder:{control:{type:"text"}}}};const Xr=e=>({components:{DDatePicker:Lo},setup(){return{args:e}},template:'<d-date-picker v-bind="args" />'}),Kr=Xr.bind({}),Zr=["Default"];var Qr=Object.freeze(Object.defineProperty({__proto__:null,default:Jr,Default:Kr,__namedExportsOrder:Zr},Symbol.toStringTag,{value:"Module"})),es={parameters:{storySource:{source:`import DHeading from "./DHeading.vue";
