import{a1 as e,n as P,z as s,B,C as U,v as H,h as O,p as W,A as w}from"./DWysiwyg-3c0e030f.js";import"./vue.esm-bundler-77038495.js";import"./iframe-6ddd522f.js";import"../sb-preview/runtime.js";import"./_commonjsHelpers-042e6b4d.js";import"./floating-ui.dom-c3a31ea6.js";const V={title:"Forms/Radio Card",component:e,tags:["autodocs"],argTypes:{...P,value:{control:{type:"text"}},ringed:{control:{type:"boolean"}},ringSize:{control:{type:"text"}},ringThickness:{control:{type:"text"}}}},E=a=>({components:{DRadioCard:e,CardIcon:s},data:()=>({value:""}),setup(){return{args:a}},template:`<d-radio-card v-model="value" value="value" v-bind="args">
  <template #icon>
    <card-icon />
  </template>
  </d-radio-card>
  ...
  template: \`
    ...
    <p>The selected value is {{value}}</p>
  \`
})`,...(_=(S=c.parameters)==null?void 0:S.docs)==null?void 0:_.source}}};const X=["Default","WithLabel","NoIcon","ExpandMode","ExpandModeWithoutIcon","CustomHeadingAndDescription","MultipleCards"];export{i as CustomHeadingAndDescription,n as Default,d as ExpandMode,r as ExpandModeWithoutIcon,c as MultipleCards,o as NoIcon,t as WithLabel,X as __namedExportsOrder,V as default};
//# sourceMappingURL=DRadioCard.stories-e114e7e1.js.map
