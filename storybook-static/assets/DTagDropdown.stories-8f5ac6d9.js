import{w as g,m as ne,x as oe,i as ae}from"./DVerticalMovable-dfd18b3e.js";import"./vue.esm-bundler-c67ca6b0.js";import"./iframe-9d2cdbc2.js";import"../sb-preview/runtime.js";import"./_commonjsHelpers-042e6b4d.js";import"./floating-ui.dom-c3a31ea6.js";const ue={title:"Forms/Tag Dropdown",component:g,tags:["autodocs"],argTypes:{...ne,showCheckboxes:{control:{type:"boolean"}},loading:{control:{type:"boolean"}}}},v=e=>({components:{DTagDropdown:g},data:()=>({value:[]}),setup(){return{args:e}},template:'<d-tag-dropdown v-model="value" v-bind="args" />'}),D=e=>({components:{DTagDropdown:g},data:()=>({value:["banking","money"]}),setup(){return{args:e}},template:`
  ...
  `}),te=e=>({components:{DTagDropdown:g,DarkModeProvider:ae},data:()=>({value:"identity"}),setup(){return{args:e}},template:`
    ...
    `}),b=(e=null)=>{const k=e?e.bind({}):se.bind({});return k.decorators=[()=>({template:'<div style="padding: 3em; background: #121A26;"><story /></div>'})],k},a=[{text:"Banking kit",value:"banking"},{text:"Money kit",value:"money"},{text:"Identity kit",value:"identity"},{text:"UI kit",value:"ui"},{text:"Commerce kit",value:"commerce"},{text:"Benefits",value:"benefits"},{text:"API Docs",value:"api_docs"},{text:"Console",value:"console"},{text:"Statements",value:"statements"},{text:"Payouts",value:"payouts"}],re=["Commerce","Identity","UI","Money","Banking"],r=v.bind({});r.args={options:[...a]};const n=b();n.args={options:[...a]};const o=v.bind({});o.args={options:[...a],label:"Dropdown"};const t=v.bind({});t.args={options:[...a],label:"Error",errorMessage:"Error message"};const s=b();s.args={options:[...a],label:"Dropdown"};const d=v.bind({});d.args={options:[...re],label:"String Options"};const p=b();p.args={options:[...re],label:"String Options"};const i=D.bind({});i.args={options:[...a],label:"Predefined Options"};const l=D.bind({});l.args={options:[...a],label:"Predefined Options",returnFullObject:!0};const c=b(te);c.args={options:[...a],label:"Predefined Options"};const m=D.bind({});m.args={options:[...a],label:"Predefined Options",leftIcon:oe};const u=v.bind({});u.args={options:[...a],label:"Loading",loading:!0};var w,f,y;r.parameters={...r.parameters,docs:{...(w=r.parameters)==null?void 0:w.docs,source:{originalSource:`args => ({
  components: {
    DTagDropdown
  },
  data: () => ({
  ...
  template: \`<d-tag-dropdown v-model="value" v-bind="args" />\`
})`,...(M=(x=o.parameters)==null?void 0:x.docs)==null?void 0:M.source}}};var F,L,I;t.parameters={...t.parameters,docs:{...(F=t.parameters)==null?void 0:F.docs,source:{originalSource:`args => ({
  components: {
    DTagDropdown
  },
  data: () => ({
  ...
  template: \`<d-tag-dropdown v-model="value" v-bind="args" />\`
})`,...(ee=(Z=u.parameters)==null?void 0:Z.docs)==null?void 0:ee.source}}};const ge=["Default","DefaultDark","Label","HasError","LabelDark","StringOptions","StringOptionsDark","PredefinedOptions","PredefinedOptionsWithFullObject","PredefinedOptionsDark","LeftIcon","Loading"];export{r as Default,n as DefaultDark,t as HasError,o as Label,s as LabelDark,m as LeftIcon,u as Loading,i as PredefinedOptions,c as PredefinedOptionsDark,l as PredefinedOptionsWithFullObject,d as StringOptions,p as StringOptionsDark,ge as __namedExportsOrder,ue as default};
//# sourceMappingURL=DTagDropdown.stories-8f5ac6d9.js.map
