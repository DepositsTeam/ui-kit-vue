import{g as i,ah as t,n as m}from"./DAccordion-c00eb372.js";import"./vue.esm-bundler-e81cbe33.js";import"./iframe-f71edc5d.js";import"../sb-preview/runtime.js";import"./_commonjsHelpers-87174ba5.js";const f={components:{DAutoLayout:i},title:"Forms/Restricted Color Config",component:t,tags:["autodocs"],argTypes:{label:{control:{type:"text"},default:"Color"},colors:{control:{type:"object"}}}},u=r=>({components:{DRestrictedColorConfig:t},data:()=>({value:""}),setup(){return{args:r}},template:`
...
\`
})`,...(s=(d=e.parameters)==null?void 0:d.docs)==null?void 0:s.source}}};const A=["Default","InitialValue"];export{o as Default,e as InitialValue,A as __namedExportsOrder,f as default};
