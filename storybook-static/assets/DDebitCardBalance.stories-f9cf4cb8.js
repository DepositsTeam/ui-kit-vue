import{ae as G,af as J}from"./DVerticalMovable-99916a1b.js";import"./vue.esm-bundler-aecd4be6.js";import"./_commonjsHelpers-042e6b4d.js";import"./floating-ui.dom-c3a31ea6.js";const U={title:"Debit Card Balance",component:G,tags:["autodocs"],argTypes:{logo:{control:{type:"text"}},cardNo:{control:{type:"text"}},exp:{control:{type:"text"}},cvv:{control:{type:"text"}},name:{control:{type:"text"}},brand:{control:{type:"select"},options:J},width:{control:{type:"text"}},balance:{control:{type:"text"}},theme:{control:{type:"select"},options:["dark","light"]},enableHiding:{control:{type:"boolean"},default:!0}}},e=I=>({components:{DDebitCardBalance:G},setup(){return{args:I}},template:'<d-debit-card-balance v-bind="args" />'}),i=e.bind({}),c=e.bind({});c.args={enableHiding:!1};const a=e.bind({});a.args={exp:"2032-12"};a.storyName="Exp (YYYY-MM)";const r=e.bind({});r.args={exp:"12-2032"};r.storyName="Exp (MM-YYYY)";const n=e.bind({});n.args={exp:"2032/12"};n.storyName="Exp (YYYY/MM)";const t=e.bind({});t.args={exp:"12/2032"};t.storyName="Exp (MM/YYYY)";const s=e.bind({});s.args={exp:"12-32"};s.storyName="Exp (MM-YY)";const o=e.bind({});o.args={exp:"12/32"};o.storyName="Exp (MM/YY)";const p=e.bind({});p.args={lastFourCardNo:"1234",exp:"12/2032"};const d=e.bind({});d.args={firstFourCardNo:"5399",lastFourCardNo:"1234",exp:"12/2032"};var m,l,u;i.parameters={...i.parameters,docs:{...(m=i.parameters)==null?void 0:m.docs,source:{originalSource:`args => ({
  components: {
    DDebitCardBalance
  },
  setup() {
...
//# sourceMappingURL=DDebitCardBalance.stories-f9cf4cb8.js.map
