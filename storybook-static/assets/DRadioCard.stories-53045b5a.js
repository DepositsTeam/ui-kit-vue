import{V as e,k as B,F as s,H as E,I as H,o as U,f as F,m as O,G as W}from"./DVerticalMovable-256bb483.js";import"./vue.esm-bundler-aecd4be6.js";import"./_commonjsHelpers-042e6b4d.js";import"./floating-ui.dom-c3a31ea6.js";const q={title:"Forms/Radio Card",component:e,tags:["autodocs"],argTypes:{...B,value:{control:{type:"text"}},ringed:{control:{type:"boolean"}},ringSize:{control:{type:"text"}},ringThickness:{control:{type:"text"}}}},P=a=>({components:{DRadioCard:e,CardIcon:s},data:()=>({value:""}),setup(){return{args:a}},template:`<d-radio-card v-model="value" value="value" v-bind="args">
  ...
  `}),d=L.bind({});d.args={heading:"One time payment",description:"Use this option to collect a one off payment",expandable:!0};const N=a=>({components:{DRadioCard:e,DFilePicker:E,CardIcon:s},data:()=>({value:""}),setup(){return{args:a}},template:`
    ...
    <p>Radio value is: {{value}}</p>
  `}),r=N.bind({});r.args={heading:"One time payment",description:"Use this option to collect a one off payment",expandable:!0};const J=a=>({components:{DRadioCard:e,CardIcon:s,DHeading:H,DText:U,DAutoLayout:F,DBox:O},data:()=>({value:""}),setup(){return{args:a}},template:`<d-radio-card v-model="value" value="value" v-bind="args">
  <template #icon>
    <card-icon />
  </template>
  <template #heading>
  ...
  template: \`
    ...
    <p>Radio value is: {{value}}</p>
  \`
})`,...(R=(k=r.parameters)==null?void 0:k.docs)==null?void 0:R.source}}};var I,T,M;i.parameters={...i.parameters,docs:{...(I=i.parameters)==null?void 0:I.docs,source:{originalSource:`args => ({
  components: {
    DRadioCard,
    CardIcon,
    DHeading,
  ...
  template: \`
    ...
    <p>The selected value is {{value}}</p>
  \`
})`,...(A=(_=c.parameters)==null?void 0:_.docs)==null?void 0:A.source}}};const K=["Default","WithLabel","NoIcon","ExpandMode","ExpandModeWithoutIcon","CustomHeadingAndDescription","MultipleCards"];export{i as CustomHeadingAndDescription,n as Default,d as ExpandMode,r as ExpandModeWithoutIcon,c as MultipleCards,o as NoIcon,t as WithLabel,K as __namedExportsOrder,q as default};
//# sourceMappingURL=DRadioCard.stories-53045b5a.js.map
