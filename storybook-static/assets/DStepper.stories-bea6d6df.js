import{M as g,p as ae,r as te,y as se,h as oe}from"./DVerticalMovable-37a23178.js";import"./vue.esm-bundler-c1de2c1e.js";import"./_commonjsHelpers-042e6b4d.js";import"./floating-ui.dom-c3a31ea6.js";const ie={component:g,title:"Stepper",tags:["autodocs"],argTypes:{steps:{control:{type:"object"}},currentStep:{control:{type:"number"}},scheme:{control:{type:"select"},options:["variant-1","variant-2"]},activeColor:{control:{type:"color"}},stepMode:{control:{type:"boolean"}}}},r=e=>({components:{DStepper:g},setup(){return{args:e}},template:'<d-stepper v-bind="args" />'}),ne=e=>({components:{DStepper:g,DarkModeProvider:oe},setup(){return{args:e}},template:`<dark-mode-provider :dark-mode="true">
  ...
  template: \`<d-stepper v-bind="args" />\`
})`,...(C=(b=t.parameters)==null?void 0:b.docs)==null?void 0:C.source}}};var y,v,h;s.parameters={...s.parameters,docs:{...(y=s.parameters)==null?void 0:y.docs,source:{originalSource:`args => ({
  components: {
    DStepper
  },
  setup() {
  ...
  template: \`<d-stepper v-bind="args" />\`
})`,...(h=(v=s.parameters)==null?void 0:v.docs)==null?void 0:h.source}}};var B,M,K;o.parameters={...o.parameters,docs:{...(B=o.parameters)==null?void 0:B.docs,source:{originalSource:`args => ({
  components: {
    DStepper
  },
  setup() {
...
//# sourceMappingURL=DStepper.stories-bea6d6df.js.map
