import{az as R,f as $e,q as je,o as Ge,i as He}from"./DVerticalMovable-368236d0.js";import"./vue.esm-bundler-c1de2c1e.js";import"./_commonjsHelpers-042e6b4d.js";import"./floating-ui.dom-c3a31ea6.js";const Xe={title:"Banner",component:R,tags:["autodocs"],argTypes:{title:{control:{type:"text"}},description:{control:{type:"text"}},colorScheme:{control:{type:"select"},options:["default","info","warning","error","success"]},removable:{control:{type:"boolean"}},alignTop:{control:{type:"boolean"}},full:{control:{type:"boolean"},default:!0},smartColor:{control:{type:"color"}},iconColor:{control:{type:"color"}}}},e=o=>({components:{DBanner:R},setup(){return{args:o}},template:'<d-banner v-bind="args" />'}),Je=o=>({components:{DBanner:R,DarkModeProvider:He},setup(){return{args:o}},template:`
  ...
  template: \`<d-banner v-bind="args" />\`
})`,...(W=(I=a.parameters)==null?void 0:I.docs)==null?void 0:W.source}}};var w,_,A;s.parameters={...s.parameters,docs:{...(w=s.parameters)==null?void 0:w.docs,source:{originalSource:`args => ({
  components: {
    DBanner
  },
  setup() {
  ...
  template: \`<d-banner v-bind="args" />\`
})`,...(P=(z=i.parameters)==null?void 0:z.docs)==null?void 0:P.source}}};var $,j,G;c.parameters={...c.parameters,docs:{...($=c.parameters)==null?void 0:$.docs,source:{originalSource:"DarkModeTemplateFactory()",...(G=(j=c.parameters)==null?void 0:j.docs)==null?void 0:G.source}}};var H,J,K;d.parameters={...d.parameters,docs:{...(H=d.parameters)==null?void 0:H.docs,source:{originalSource:`args => ({
  components: {
    DBanner
  },
  setup() {
  ...
  template: \`<d-banner v-bind="args" />\`
})`,...(Ae=(_e=B.parameters)==null?void 0:_e.docs)==null?void 0:Ae.source}}};var Ce,Oe,Ye;h.parameters={...h.parameters,docs:{...(Ce=h.parameters)==null?void 0:Ce.docs,source:{originalSource:"DarkModeTemplateFactory()",...(Ye=(Oe=h.parameters)==null?void 0:Oe.docs)==null?void 0:Ye.source}}};var qe,ze,Pe;L.parameters={...L.parameters,docs:{...(qe=L.parameters)==null?void 0:qe.docs,source:{originalSource:`args => ({
  components: {
    DBanner,
    DAutoLayout,
    DText,
