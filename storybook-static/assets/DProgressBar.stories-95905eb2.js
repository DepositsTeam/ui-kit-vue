import{L as g,_ as K}from"./UndoOutlineIcon-7f54b2d3.js";import"./vue.esm-bundler-d253c880.js";import"./floating-ui.dom-c3a31ea6.js";import"./_commonjsHelpers-042e6b4d.js";const X={title:"Progress bar",component:g,argTypes:{percentage:{control:{type:"text"}},totalSteps:{control:{type:"number"}},currentStep:{control:{type:"number"}},fillColor:{control:{type:"color"}},emptyColor:{control:{type:"color"}},darkFillColor:{control:{type:"color"}},darkEmptyColor:{control:{type:"color"}},variant:{control:{type:"select"},options:["variant-1","variant-2"],default:"variant-1"},height:{control:{type:"text"},default:"6px"}}},e=r=>({components:{DProgressBar:g},setup(){return{args:r}},template:'<d-progress-bar v-bind="args" />'}),N=r=>({components:{DProgressBar:g,DarkModeProvider:K},setup(){return{args:r}},template:`
...
//# sourceMappingURL=DProgressBar.stories-95905eb2.js.map
