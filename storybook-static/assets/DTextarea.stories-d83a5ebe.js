import{q as c,n as w,_ as H}from"./DWysiwyg-515702cd.js";import"./vue.esm-bundler-77038495.js";import"./iframe-734e6c86.js";import"../sb-preview/runtime.js";import"./_commonjsHelpers-042e6b4d.js";import"./floating-ui.dom-c3a31ea6.js";const P={title:"Forms/Text Area",component:c,tags:["autodocs"],argTypes:{...w,label:{control:{type:"text"}},disabled:{control:{type:"boolean"}},errorMessage:{control:{type:"text"}},textAreaClassName:{control:{type:"text"}},size:{control:{type:"select"},options:["small","medium","large","xlarge","huge","massive"]},fontFace:{control:{type:"select"},options:["circularSTD","heroNew"]},rows:{control:{type:"text"}},minHeight:{control:{type:"text"}},maxHeight:{control:{type:"text"}}}},d=e=>({components:{DTextarea:c},data:()=>({text:"dd"}),setup:function(){return{args:e}},template:'<d-textarea v-bind="args" v-model="text" />'}),N=e=>({components:{DTextarea:c,DarkModeProvider:H},data:()=>({value:""}),setup(){return{args:e}},template:`
...
//# sourceMappingURL=DTextarea.stories-d83a5ebe.js.map
