import{Q as w,R as O,S as T}from"./DAccordion-c00eb372.js";import"./vue.esm-bundler-e81cbe33.js";import{s as F}from"./selectProps-2e81a4d1.js";import"./iframe-f71edc5d.js";import"../sb-preview/runtime.js";import"./_commonjsHelpers-87174ba5.js";const _={component:w,title:"Forms/Country Dropdown",tags:["autodocs"],argTypes:{...O,...F}},r=x=>({components:{DCountryDropdown:w,DSelect:T},data:()=>({country:"",states:[],selectedState:""}),setup(){return{args:x}},methods:{hydrateStates:function(C){this.states=C.map(o=>({text:o.name,value:o.name}))}},template:`
