import{as as g,Q as ne,at as oe,f as ae}from"./DAccordion-DYIgxZVa.js";import"./vue.esm-bundler-XIZ-WwZ4.js";import"./iframe-C0jbynlU.js";import"../sb-preview/runtime.js";import"./_commonjsHelpers-BosuxZz1.js";const me={title:"Forms/Tag Dropdown",component:g,tags:["autodocs"],argTypes:{...ne,showCheckboxes:{control:{type:"boolean"}},loading:{control:{type:"boolean"}}}},v=e=>({components:{DTagDropdown:g},data:()=>({value:[]}),setup(){return{args:e}},template:'<d-tag-dropdown v-model="value" v-bind="args" />'}),b=e=>({components:{DTagDropdown:g},data:()=>({value:["banking","money"]}),setup(){return{args:e}},template:`
