import{Z as e,n as B,E as s,G as E,H,o as U,h as F,r as O,F as W}from"./DWysiwyg-2a95663d.js";import"./vue.esm-bundler-77038495.js";import"./iframe-8f914adc.js";import"../sb-preview/runtime.js";import"./_commonjsHelpers-042e6b4d.js";import"./floating-ui.dom-c3a31ea6.js";const Q={title:"Forms/Radio Card",component:e,tags:["autodocs"],argTypes:{...B,value:{control:{type:"text"}},ringed:{control:{type:"boolean"}},ringSize:{control:{type:"text"}},ringThickness:{control:{type:"text"}}}},P=a=>({components:{DRadioCard:e,CardIcon:s},data:()=>({value:""}),setup(){return{args:a}},template:`<d-radio-card v-model="value" value="value" v-bind="args">
  ...
  `}),r=L.bind({});r.args={heading:"One time payment",description:"Use this option to collect a one off payment",expandable:!0};const N=a=>({components:{DRadioCard:e,DFilePicker:E,CardIcon:s},data:()=>({value:""}),setup(){return{args:a}},template:`
    ...
    <p>Radio value is: {{value}}</p>
  `}),d=N.bind({});d.args={heading:"One time payment",description:"Use this option to collect a one off payment",expandable:!0};const J=a=>({components:{DRadioCard:e,CardIcon:s,DHeading:H,DText:U,DAutoLayout:F,DBox:O},data:()=>({value:""}),setup(){return{args:a}},template:`<d-radio-card v-model="value" value="value" v-bind="args">
  <template #icon>
    <card-icon />
  </template>
  <template #heading>
  ...
  template: \`
    ...
    <p>The selected value is {{value}}</p>
  \`
})`,...(A=(_=c.parameters)==null?void 0:_.docs)==null?void 0:A.source}}};const V=["Default","WithLabel","NoIcon","ExpandMode","ExpandModeWithoutIcon","CustomHeadingAndDescription","MultipleCards"];export{i as CustomHeadingAndDescription,n as Default,r as ExpandMode,d as ExpandModeWithoutIcon,c as MultipleCards,o as NoIcon,t as WithLabel,V as __namedExportsOrder,Q as default};
//# sourceMappingURL=DRadioCard.stories-2c46c651.js.map
