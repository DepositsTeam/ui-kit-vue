import{w as V,l as e,_ as rr}from"./DWysiwyg-ceedb84c.js";import"./vue.esm-bundler-41d8d808.js";import"./floating-ui.dom-c3a31ea6.js";import"./_commonjsHelpers-042e6b4d.js";const dr={title:"Forms/Select Field",component:V,tags:["autodocs"],argTypes:{label:{control:{type:"text"}},size:{control:{type:"select"},options:["small","medium","large","xlarge","huge","massive"]},leftIcon:{control:{type:"object"}},errorMessage:{control:{type:"text"}},wrapperClass:{control:{type:"text"}},options:{control:{type:"object"},table:{defaultValue:["Item 1","Item 2","Item 3"]}},placeholderEffect:{control:{type:"boolean"},table:{defaultValue:!0}},disabled:{control:{type:"boolean"}},optionTitle:{control:{type:"text"}},optionValue:{control:{type:"text"}},returnFullObject:{control:{type:"boolean"}}}},ar=o=>({components:{DSelect:V,DarkModeProvider:rr},data:()=>({value:""}),setup(){return{args:o}},template:`
  ...
  template: \`
    <d-select v-bind="args" />\`
})`,...(_=(E=s.parameters)==null?void 0:E.docs)==null?void 0:_.source}}};var P,H,A;t.parameters={...t.parameters,docs:{...(P=t.parameters)==null?void 0:P.docs,source:{originalSource:"DarkModeTemplateFactory()",...(A=(H=t.parameters)==null?void 0:H.docs)==null?void 0:A.source}}};var j,R,X;n.parameters={...n.parameters,docs:{...(j=n.parameters)==null?void 0:j.docs,source:{originalSource:`args => ({
  components: {
    DSelect
  },
  setup() {
  ...
  template: \`
    <d-select v-bind="args" />\`
})`,...(Fe=(ke=M.parameters)==null?void 0:ke.docs)==null?void 0:Fe.source}}};var fe,Le,ze;v.parameters={...v.parameters,docs:{...(fe=v.parameters)==null?void 0:fe.docs,source:{originalSource:"DarkModeTemplateFactory()",...(ze=(Le=v.parameters)==null?void 0:Le.docs)==null?void 0:ze.source}}};var ye,we,Ie;k.parameters={...k.parameters,docs:{...(ye=k.parameters)==null?void 0:ye.docs,source:{originalSource:`args => ({
  components: {
    DSelect
  },
  setup() {
  ...
  template: \`
    <d-select v-bind="args" />\`
})`,...(_e=(Ee=f.parameters)==null?void 0:Ee.docs)==null?void 0:_e.source}}};var Pe,He,Ae;L.parameters={...L.parameters,docs:{...(Pe=L.parameters)==null?void 0:Pe.docs,source:{originalSource:"DarkModeTemplateFactory()",...(Ae=(He=L.parameters)==null?void 0:He.docs)==null?void 0:Ae.source}}};var je,Re,Xe;z.parameters={...z.parameters,docs:{...(je=z.parameters)==null?void 0:je.docs,source:{originalSource:`args => ({
  components: {
    DSelect
  },
  setup() {
  ...
  template: \`
    <d-select v-bind="args" />\`
})`,...(Xe=(Re=z.parameters)==null?void 0:Re.docs)==null?void 0:Xe.source}}};var Ce,Oe,Ye;y.parameters={...y.parameters,docs:{...(Ce=y.parameters)==null?void 0:Ce.docs,source:{originalSource:"DarkModeTemplateFactory()",...(Ye=(Oe=y.parameters)==null?void 0:Oe.docs)==null?void 0:Ye.source}}};var Be,$e,qe;w.parameters={...w.parameters,docs:{...(Be=w.parameters)==null?void 0:Be.docs,source:{originalSource:`args => ({
  components: {
    DSelect
  },
  setup() {
  ...
  template: \`
    <d-select v-bind="args" />\`
})`,...(qe=($e=w.parameters)==null?void 0:$e.docs)==null?void 0:qe.source}}};var Ge,Je,Ke;I.parameters={...I.parameters,docs:{...(Ge=I.parameters)==null?void 0:Ge.docs,source:{originalSource:"DarkModeTemplateFactory()",...(Ke=(Je=I.parameters)==null?void 0:Je.docs)==null?void 0:Ke.source}}};var Ne,Qe,Ue;T.parameters={...T.parameters,docs:{...(Ne=T.parameters)==null?void 0:Ne.docs,source:{originalSource:`args => ({
  components: {
    DSelect
  },
  data: () => ({
