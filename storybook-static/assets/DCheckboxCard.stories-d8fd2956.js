import{d as q,Q as K,e as p,u as m,o as R,x as v,f as X}from"./vue.esm-bundler-64d654d1.js";import{ar as Y,as as Z,at as ee,ap as ae,G as o,H as ne,y as $,I as L,J as oe,b as te,c as ce}from"./DWysiwyg-10565f11.js";import"./floating-ui.dom-c3a31ea6.js";import"./_commonjsHelpers-87174ba5.js";const P={__name:"DCheckboxCard",props:{...Y,checked:{type:Boolean,default:null},value:{type:[String,Number],default:""},modelValue:{default:!1},trueValue:{default:!0},falseValue:{default:!1},values:{type:Array,default:()=>[]},dashed:{type:Boolean},disabled:{type:Boolean}},emits:["update:modelValue"],setup(e,{emit:j}){const z=e,{isChecked:b,triggerChange:G}=Z(z,j),Q=()=>{G()};return(a,pe)=>(R(),q(ee,{heading:a.heading,description:a.description,expandable:a.expandable,label:a.label,"label-class":a.labelClass,"label-font-face":a.labelFontFace,"expand-on-checked":a.expandOnChecked,"is-checked":m(b),onClicked:Q},K({selector:p(()=>[X(m(ae),{dashed:e.dashed,size:"18px",checked:m(b)},null,8,["dashed","checked"])]),default:p(()=>[v(a.$slots,"default")]),_:2},[a.$slots.icon?{name:"icon",fn:p(()=>[v(a.$slots,"icon")]),key:"0"}:void 0]),1032,["heading","description","expandable","label","label-class","label-font-face","expand-on-checked","is-checked"]))}},n=P;P.__docgenInfo={exportName:"default",displayName:"DCheckboxCard",description:"",tags:{},props:[{name:"checked",type:{name:"boolean"},defaultValue:{func:!1,value:"null"}},{name:"value",type:{name:"string|number"},defaultValue:{func:!1,value:'""'}},{name:"modelValue",type:{name:"boolean"},defaultValue:{func:!1,value:"false"}},{name:"trueValue",type:{name:"boolean"},defaultValue:{func:!1,value:"true"}},{name:"falseValue",type:{name:"boolean"},defaultValue:{func:!1,value:"false"}},{name:"values",type:{name:"array"},defaultValue:{func:!1,value:"[]"}},{name:"dashed",type:{name:"boolean"}},{name:"disabled",type:{name:"boolean"}}],events:[{name:"update:modelValue"}],slots:[{name:"default"},{name:"icon"}],sourceFiles:["/Users/ericmcwinner/Documents/Work/Projects/Work/Vue/deposits-ui-kit-vue/src/d-checkbox-card/DCheckboxCard.vue"]};const ke={title:"Forms/Checkbox Card",component:n,tags:["autodocs"],argTypes:{}},J=e=>({components:{DCheckboxCard:n,CardIcon:o},data:()=>({value:!1}),setup(){return{args:e}},template:`
  ...
  `}),u=re.bind({}),se=e=>({components:{DCheckboxCard:n},data:()=>({value:""}),setup(){return{args:e}},template:`
    <d-checkbox-card v-model="value" value="value" v-bind="args">
    </d-checkbox-card>
    <p>Checkbox value is: {{value}}</p>
  `}),r=se.bind({});r.args={heading:"One time payment",description:"Use this option to collect a one off payment"};const le=e=>({components:{DCheckboxCard:n,DFilePicker:L,CardIcon:o},data:()=>({value:""}),setup(){return{args:e}},template:`
    <d-checkbox-card v-model="value" value="value" v-bind="args">
      <template #icon>
        <card-icon />
      </template>
    ...
    <p>Checkbox value is: {{value}}</p>
  `}),s=le.bind({});s.args={heading:"One time payment",description:"Use this option to collect a one off payment",expandable:!0};const ie=e=>({components:{DCheckboxCard:n,DFilePicker:L,CardIcon:o},data:()=>({value:""}),setup(){return{args:e}},template:`
    <d-checkbox-card v-model="value" value="value" v-bind="args">
      <d-file-picker />
    </d-checkbox-card>
    <p>Checkbox value is: {{value}}</p>
  `}),l=ie.bind({});l.args={heading:"One time payment",description:"Use this option to collect a one off payment",expandable:!0};const ue=e=>({components:{DCheckboxCard:n,CardIcon:o,DHeading:oe,DText:te,DAutoLayout:$,DBox:ce},data:()=>({value:""}),setup(){return{args:e}},template:`<d-checkbox-card v-model="value" value="value" v-bind="args">
  <template #icon>
    <card-icon />
  </template>
  <template #heading>
  ...
  template: \`
    ...
    <p>Checkbox value is: {{value}}</p>
  \`
})`,...(F=(B=r.parameters)==null?void 0:B.docs)==null?void 0:F.source}}};var O,W,E;s.parameters={...s.parameters,docs:{...(O=s.parameters)==null?void 0:O.docs,source:{originalSource:`args => ({
  components: {
    DCheckboxCard,
    DFilePicker,
    CardIcon
  ...
  template: \`
    ...
    <p>Checkbox value is: {{value}}</p>
  \`
})`,...(E=(W=s.parameters)==null?void 0:W.docs)==null?void 0:E.source}}};var N,U,w;l.parameters={...l.parameters,docs:{...(N=l.parameters)==null?void 0:N.docs,source:{originalSource:`args => ({
  components: {
    DCheckboxCard,
    DFilePicker,
    CardIcon
  ...
  template: \`
    ...
    <p>Checkbox value is: {{value}}</p>
  \`
})`,...(w=(U=l.parameters)==null?void 0:U.docs)==null?void 0:w.source}}};var H,M,_;i.parameters={...i.parameters,docs:{...(H=i.parameters)==null?void 0:H.docs,source:{originalSource:`args => ({
  components: {
    DCheckboxCard,
    CardIcon,
    DHeading,
  ...
  <p>Checkbox value is: {{value}}</p>
  \`
})`,...(_=(M=i.parameters)==null?void 0:M.docs)==null?void 0:_.source}}};const xe=["WithLabel","TrueOrFalseCheckbox","CheckboxWithValue","CheckboxArray","NoIcon","ExpandMode","ExpandModeWithoutIcon","CustomHeadingAndDescription"];export{u as CheckboxArray,d as CheckboxWithValue,i as CustomHeadingAndDescription,s as ExpandMode,l as ExpandModeWithoutIcon,r as NoIcon,c as TrueOrFalseCheckbox,t as WithLabel,xe as __namedExportsOrder,ke as default};
//# sourceMappingURL=DCheckboxCard.stories-d8fd2956.js.map
