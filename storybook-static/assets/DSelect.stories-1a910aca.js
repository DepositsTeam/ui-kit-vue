import{G as V,O as e,_ as rr}from"./DWysiwyg-01175861.js";import"./vue.esm-bundler-64d654d1.js";import"./floating-ui.dom-c3a31ea6.js";import"./_commonjsHelpers-87174ba5.js";const dr={title:"Forms/Select Field",component:V,tags:["autodocs"],argTypes:{label:{control:{type:"text"}},size:{control:{type:"select"},options:["small","medium","large","xlarge","huge","massive"]},leftIcon:{control:{type:"object"}},errorMessage:{control:{type:"text"}},wrapperClass:{control:{type:"text"}},options:{control:{type:"object"},table:{defaultValue:["Item 1","Item 2","Item 3"]}},placeholderEffect:{control:{type:"boolean"},table:{defaultValue:!0}},disabled:{control:{type:"boolean"}},optionTitle:{control:{type:"text"}},optionValue:{control:{type:"text"}},returnFullObject:{control:{type:"boolean"}}}},ar=o=>({components:{DSelect:V,DarkModeProvider:rr},data:()=>({value:""}),setup(){return{args:o}},template:`
  ...
  template: \`
    <d-select v-bind="args" />\`
})`,...(_=(E=s.parameters)==null?void 0:E.docs)==null?void 0:_.source}}};var P,H,A;t.parameters={...t.parameters,docs:{...(P=t.parameters)==null?void 0:P.docs,source:{originalSource:"DarkModeTemplateFactory()",...(A=(H=t.parameters)==null?void 0:H.docs)==null?void 0:A.source}}};var j,O,R;n.parameters={...n.parameters,docs:{...(j=n.parameters)==null?void 0:j.docs,source:{originalSource:`args => ({
  components: {
    DSelect
  },
  setup() {
  ...
  template: \`
    <d-select v-bind="args" />\`
})`,...(R=(O=n.parameters)==null?void 0:O.docs)==null?void 0:R.source}}};var X,C,Y;c.parameters={...c.parameters,docs:{...(X=c.parameters)==null?void 0:X.docs,source:{originalSource:"DarkModeTemplateFactory()",...(Y=(C=c.parameters)==null?void 0:C.docs)==null?void 0:Y.source}}};var B,G,$;l.parameters={...l.parameters,docs:{...(B=l.parameters)==null?void 0:B.docs,source:{originalSource:`args => ({
  components: {
    DSelect
  },
  setup() {
  ...
  template: \`
    <d-select v-bind="args" />\`
})`,...(_e=(Ee=f.parameters)==null?void 0:Ee.docs)==null?void 0:_e.source}}};var Pe,He,Ae;L.parameters={...L.parameters,docs:{...(Pe=L.parameters)==null?void 0:Pe.docs,source:{originalSource:"DarkModeTemplateFactory()",...(Ae=(He=L.parameters)==null?void 0:He.docs)==null?void 0:Ae.source}}};var je,Oe,Re;z.parameters={...z.parameters,docs:{...(je=z.parameters)==null?void 0:je.docs,source:{originalSource:`args => ({
  components: {
    DSelect
  },
  setup() {
  ...
  template: \`
    <d-select v-bind="args" />\`
})`,...(Re=(Oe=z.parameters)==null?void 0:Oe.docs)==null?void 0:Re.source}}};var Xe,Ce,Ye;y.parameters={...y.parameters,docs:{...(Xe=y.parameters)==null?void 0:Xe.docs,source:{originalSource:"DarkModeTemplateFactory()",...(Ye=(Ce=y.parameters)==null?void 0:Ce.docs)==null?void 0:Ye.source}}};var Be,Ge,$e;I.parameters={...I.parameters,docs:{...(Be=I.parameters)==null?void 0:Be.docs,source:{originalSource:`args => ({
  components: {
    DSelect
  },
  setup() {
...
//# sourceMappingURL=DSelect.stories-1a910aca.js.map
