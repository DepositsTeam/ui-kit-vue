import{P as d,_ as f}from"./DAccordion-c00eb372.js";import"./vue.esm-bundler-e81cbe33.js";import"./iframe-f71edc5d.js";import"../sb-preview/runtime.js";import"./_commonjsHelpers-87174ba5.js";const P={title:"Forms/Counter",component:d,tags:["autodocs"],argTypes:{fontFace:{control:{type:"text"}},errorMessage:{control:{type:"text"}},name:{control:{type:"text"}},label:{control:{type:"text"}},labelFontFace:{control:{type:"text"}},labelClass:{control:{type:"text"}},placeholder:{control:{type:"text"}}}},o=s=>({components:{DCounter:d},data:()=>({value:""}),setup(){return{args:s}},template:'<d-counter v-model="value" v-bind="args"></d-counter>'}),_=s=>({components:{DCounter:d,DarkModeProvider:f},data:()=>({value:""}),setup(){return{args:s}},template:`
  ...
  template: \`<d-counter v-model="value" v-bind="args"></d-counter>\`
})`,...(M=(C=n.parameters)==null?void 0:C.docs)==null?void 0:M.source}}};const T=["Default","Label","HasError","DarkDefault","MaxIs10AndMinIs0"];export{t as DarkDefault,a as Default,r as HasError,e as Label,n as MaxIs10AndMinIs0,T as __namedExportsOrder,P as default};
