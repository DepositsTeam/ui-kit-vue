import{aj as w,l as O,C as T}from"./DWysiwyg-2b801905.js";import"./vue.esm-bundler-6f1630d7.js";import{s as j}from"./selectProps-2e81a4d1.js";import"./iframe-6b342987.js";import"../sb-preview/runtime.js";import"./_commonjsHelpers-042e6b4d.js";import"./floating-ui.dom-c3a31ea6.js";const R={component:w,title:"Forms/Country Dropdown",tags:["autodocs"],argTypes:{...O,...j}},r=C=>({components:{DCountryDropdown:w,DSelect:T},data:()=>({country:"",states:[],selectedState:""}),setup(){return{args:C}},methods:{hydrateStates:function(x){this.states=x.map(o=>({text:o.name,value:o.name}))}},template:`
  ...
  template: \`
    ...
    <p>Selected country: {{ country }}</p>
  \`
})`,...(f=(b=a.parameters)==null?void 0:b.docs)==null?void 0:f.source}}};const M=["Default","HasError","ReturnFullObject","UseDifferentTitleAndValue","OnlyUS"];export{t as Default,e as HasError,a as OnlyUS,n as ReturnFullObject,s as UseDifferentTitleAndValue,M as __namedExportsOrder,R as default};
//# sourceMappingURL=DCountryDropdown.stories-4f11f51b.js.map
