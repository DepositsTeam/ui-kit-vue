import { M as n, p as m } from "./DAccordion-DdDUMQ09.js";
...
const l = (o) => ({
    components: { DCopyInput: n, ThemeProvider: m },
    setup() {
      return { args: o };
    },
    template: `
...
t.parameters = {
  ...
  \`
      ...
      ...((i = (u = t.parameters) == null ? void 0 : u.docs) == null
        ? void 0
        : i.source),
    },
  },
};
const v = ["Default", "CustomDefaultSize"];
export {
  t as CustomDefaultSize,
  e as Default,
