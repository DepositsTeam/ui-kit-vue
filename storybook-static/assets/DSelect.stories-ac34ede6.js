import{q as V,c as e,_ as rr}from"./DWysiwyg-3bd6c6b4.js";import"./vue.esm-bundler-673e2372.js";import"./floating-ui.dom-c3a31ea6.js";import"./_commonjsHelpers-042e6b4d.js";const dr={title:"Forms/Select Field",component:V,argTypes:{label:{control:{type:"text"}},size:{control:{type:"select"},options:["small","medium","large","xlarge","huge","massive"]},leftIcon:{control:{type:"object"}},errorMessage:{control:{type:"text"}},wrapperClass:{control:{type:"text"}},options:{control:{type:"object"},table:{defaultValue:["Item 1","Item 2","Item 3"]}},placeholderEffect:{control:{type:"boolean"},table:{defaultValue:!0}},disabled:{control:{type:"boolean"}},optionTitle:{control:{type:"text"}},optionValue:{control:{type:"text"}},returnFullObject:{control:{type:"boolean"}}}},ar=o=>({components:{DSelect:V,DarkModeProvider:rr},data:()=>({value:""}),setup(){return{args:o}},template:`
  ...
  template: \`
    <d-select v-bind="args" />\`
})`,...(Xe=(Re=z.parameters)==null?void 0:Re.docs)==null?void 0:Xe.source}}};var Ce,Oe,Ye;y.parameters={...y.parameters,docs:{...(Ce=y.parameters)==null?void 0:Ce.docs,source:{originalSource:"DarkModeTemplateFactory()",...(Ye=(Oe=y.parameters)==null?void 0:Oe.docs)==null?void 0:Ye.source}}};var qe,Be,$e;I.parameters={...I.parameters,docs:{...(qe=I.parameters)==null?void 0:qe.docs,source:{originalSource:`args => ({
  components: {
    DSelect
  },
  setup() {
...
//# sourceMappingURL=DSelect.stories-ac34ede6.js.map
