import{K as g,L as ne,M as oe,_ as ae}from"./DWysiwyg-ceedb84c.js";import"./vue.esm-bundler-41d8d808.js";import"./floating-ui.dom-c3a31ea6.js";import"./_commonjsHelpers-042e6b4d.js";const ce={title:"Forms/Tag Dropdown",component:g,tags:["autodocs"],argTypes:{...ne,placeholder:{control:{type:"text"}},showCheckboxes:{control:{type:"boolean"}},options:{control:{type:"object"}}}},v=e=>({components:{DTagDropdown:g},data:()=>({value:[]}),setup(){return{args:e}},template:'<d-tag-dropdown v-model="value" v-bind="args" />'}),D=e=>({components:{DTagDropdown:g},data:()=>({value:["banking","money"]}),setup(){return{args:e}},template:`
  ...
  template: \`
    ...
    <p>Selected value is {{value}}</p>
  \`
})`,...($=(K=i.parameters)==null?void 0:K.docs)==null?void 0:$.source}}};var q,z,G;l.parameters={...l.parameters,docs:{...(q=l.parameters)==null?void 0:q.docs,source:{originalSource:`args => ({
  components: {
    DTagDropdown
  },
  data: () => ({
  ...
  template: \`
    ...
    <p>Selected value is {{value}}</p>
  \`
})`,...(G=(z=l.parameters)==null?void 0:z.docs)==null?void 0:G.source}}};var J,N,Q;c.parameters={...c.parameters,docs:{...(J=c.parameters)==null?void 0:J.docs,source:{originalSource:"DarkModeTemplateFactory(DarkModePredefinedTemplate)",...(Q=(N=c.parameters)==null?void 0:N.docs)==null?void 0:Q.source}}};var R,V,X;m.parameters={...m.parameters,docs:{...(R=m.parameters)==null?void 0:R.docs,source:{originalSource:`args => ({
  components: {
    DTagDropdown
  },
  data: () => ({
...
//# sourceMappingURL=DTagDropdown.stories-f11a1d0d.js.map
