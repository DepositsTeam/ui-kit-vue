import{ao as D,s as f,O as w}from"./DWysiwyg-27c4e042.js";import"./vue.esm-bundler-c483924c.js";import{s as x}from"./selectProps-2e81a4d1.js";import"./_commonjsHelpers-042e6b4d.js";import"./floating-ui.dom-c3a31ea6.js";const F={component:D,title:"Forms/Country Dropdown",tags:["autodocs"],argTypes:{...f,...x}},a=v=>({components:{DCountryDropdown:D,DSelect:w},data:()=>({country:"",states:[],selectedState:""}),setup(){return{args:v}},methods:{hydrateStates:function(b){this.states=b.map(r=>({text:r.name,value:r.name}))}},template:`
  ...
  template: \`
    ...
    <p>Selected country: {{ country }}</p>
  \`
})`,...(h=(g=s.parameters)==null?void 0:g.docs)==null?void 0:h.source}}};const j=["Default","HasError","ReturnFullObject","UseDifferentTitleAndValue"];export{t as Default,e as HasError,n as ReturnFullObject,s as UseDifferentTitleAndValue,j as __namedExportsOrder,F as default};
//# sourceMappingURL=DCountryDropdown.stories-d5ed027b.js.map
