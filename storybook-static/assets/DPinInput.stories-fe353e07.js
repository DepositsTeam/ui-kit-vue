import{V as c,_ as L}from"./DWysiwyg-e6a75c67.js";import"./vue.esm-bundler-673e2372.js";import"./floating-ui.dom-c3a31ea6.js";import"./_commonjsHelpers-042e6b4d.js";const $={title:"Forms/Pin Input",component:c,argTypes:{spacing:{control:{type:"text"}},password:{control:{type:"boolean"}},noOfCharacters:{control:{type:"number"}}}},l=r=>({components:{DPinInput:c},data:()=>({pin:""}),setup(){return{args:r}},template:`
  ...
  template: \`
    <d-pin-input v-model="pin" v-bind="args" />\`
})`,...(N=(F=n.parameters)==null?void 0:F.docs)==null?void 0:N.source}}};var O,_,E;s.parameters={...s.parameters,docs:{...(O=s.parameters)==null?void 0:O.docs,source:{originalSource:"DarkModeTemplateFactory()",...(E=(_=s.parameters)==null?void 0:_.docs)==null?void 0:E.source}}};var V,H,h;o.parameters={...o.parameters,docs:{...(V=o.parameters)==null?void 0:V.docs,source:{originalSource:`args => ({
  components: {
    DPinInput
  },
  data: () => ({
...
//# sourceMappingURL=DPinInput.stories-fe353e07.js.map
