import{ap as dt,aq as f,a6 as gt}from"./DWysiwyg-30512202.js";import"./vue.esm-bundler-77038495.js";import"./iframe-fb4a8631.js";import"../sb-preview/runtime.js";import"./_commonjsHelpers-042e6b4d.js";import"./floating-ui.dom-c3a31ea6.js";const Lt={components:{HomeFilledIcon:dt},title:"Composite Button",component:f,tags:["autodocs"],argTypes:{size:{control:{type:"select"},options:["small","medium","large","xlarge","huge","massive"]},is:{control:{type:"select"},options:["button","a","span","div"]},colorScheme:{control:{type:"select"},options:["primary","danger","success","outline","invisible"]},loaderType:{control:{type:"select"},options:["text","ring","equalizer","ringed-circle"],table:{defaultValue:"text"}}}},t=n=>({components:{DCompositeButton:f},setup(){return{args:n}},methods:{leftButtonClick:function(){alert("Left button clicked!")},rightButtonClick:function(){alert("Right button clicked!")}},template:'<d-composite-button v-bind="args" @left-button-click="leftButtonClick" @right-button-click="rightButtonClick" />'}),kt=n=>({components:{DCompositeButton:f,ThemeProvider:gt},setup(){return{args:n}},methods:{leftButtonClick:function(){alert("Left button clicked!")},rightButtonClick:function(){alert("Right button clicked!")}},template:`
  ...
  template: \`<d-composite-button v-bind="args" @left-button-click="leftButtonClick" @right-button-click="rightButtonClick" />\`
})`,...(O=(W=i.parameters)==null?void 0:W.docs)==null?void 0:O.source}}};var q,w,F;s.parameters={...s.parameters,docs:{...(q=s.parameters)==null?void 0:q.docs,source:{originalSource:`args => ({
  components: {
    DCompositeButton
  },
  setup() {
  ...
  template: \`<d-composite-button v-bind="args" @left-button-click="leftButtonClick" @right-button-click="rightButtonClick" />\`
})`,...(F=(w=s.parameters)==null?void 0:w.docs)==null?void 0:F.source}}};var X,E,V;l.parameters={...l.parameters,docs:{...(X=l.parameters)==null?void 0:X.docs,source:{originalSource:`args => ({
  components: {
    DCompositeButton
  },
  setup() {
  ...
  template: \`<d-composite-button v-bind="args" @left-button-click="leftButtonClick" @right-button-click="rightButtonClick" />\`
})`,...(V=(E=l.parameters)==null?void 0:E.docs)==null?void 0:V.source}}};var j,A,G;u.parameters={...u.parameters,docs:{...(j=u.parameters)==null?void 0:j.docs,source:{originalSource:`args => ({
  components: {
    DCompositeButton
  },
  setup() {
