import{m as R,g as qe,n as ze,h as Ge,f as He}from"./DAccordion-DYIgxZVa.js";import"./vue.esm-bundler-XIZ-WwZ4.js";import"./iframe-C0jbynlU.js";import"../sb-preview/runtime.js";import"./_commonjsHelpers-BosuxZz1.js";const Ze={title:"Banner",component:R,tags:["autodocs"],argTypes:{title:{control:{type:"text"}},description:{control:{type:"text"}},colorScheme:{control:{type:"select"},options:["default","info","warning","error","success"]},removable:{control:{type:"boolean"}},alignTop:{control:{type:"boolean"}},full:{control:{type:"boolean"},default:!0},smartColor:{control:{type:"color"}},iconColor:{control:{type:"color"}}}},e=o=>({components:{DBanner:R},setup(){return{args:o}},template:'<d-banner v-bind="args" />'}),Je=o=>({components:{DBanner:R,DarkModeProvider:He},setup(){return{args:o}},template:`
...
})`,...(M=(F=t.parameters)==null?void 0:F.docs)==null?void 0:M.source}}};var _,E,I;a.parameters={...a.parameters,docs:{...(_=a.parameters)==null?void 0:_.docs,source:{originalSource:`args => ({
  components: {
    DBanner
  },
  setup() {
  ...
  template: \`<d-banner v-bind="args" />\`
})`,...(I=(E=a.parameters)==null?void 0:E.docs)==null?void 0:I.source}}};var W,w,A;s.parameters={...s.parameters,docs:{...(W=s.parameters)==null?void 0:W.docs,source:{originalSource:`args => ({
  components: {
    DBanner
  },
  setup() {
  ...
  template: \`<d-banner v-bind="args" />\`
})`,...(A=(w=s.parameters)==null?void 0:w.docs)==null?void 0:A.source}}};var C,O,$;n.parameters={...n.parameters,docs:{...(C=n.parameters)==null?void 0:C.docs,source:{originalSource:"DarkModeTemplateFactory()",...($=(O=n.parameters)==null?void 0:O.docs)==null?void 0:$.source}}};var Y,P,j;i.parameters={...i.parameters,docs:{...(Y=i.parameters)==null?void 0:Y.docs,source:{originalSource:`args => ({
  components: {
    DBanner
  },
  setup() {
  ...
  template: \`<d-banner v-bind="args" />\`
})`,...(he=(ye=T.parameters)==null?void 0:ye.docs)==null?void 0:he.source}}};var Be,Le,Re;k.parameters={...k.parameters,docs:{...(Be=k.parameters)==null?void 0:Be.docs,source:{originalSource:"DarkModeTemplateFactory()",...(Re=(Le=k.parameters)==null?void 0:Le.docs)==null?void 0:Re.source}}};var xe,Fe,Me;f.parameters={...f.parameters,docs:{...(xe=f.parameters)==null?void 0:xe.docs,source:{originalSource:`args => ({
  components: {
    DBanner
  },
  setup() {
  ...
  template: \`<d-banner v-bind="args" />\`
})`,...(Me=(Fe=f.parameters)==null?void 0:Fe.docs)==null?void 0:Me.source}}};var _e,Ee,Ie;y.parameters={...y.parameters,docs:{...(_e=y.parameters)==null?void 0:_e.docs,source:{originalSource:"DarkModeTemplateFactory()",...(Ie=(Ee=y.parameters)==null?void 0:Ee.docs)==null?void 0:Ie.source}}};var We,we,Ae;h.parameters={...h.parameters,docs:{...(We=h.parameters)==null?void 0:We.docs,source:{originalSource:`args => ({
  components: {
    DBanner
  },
  setup() {
  ...
  template: \`<d-banner v-bind="args" />\`
})`,...(Ae=(we=h.parameters)==null?void 0:we.docs)==null?void 0:Ae.source}}};var Ce,Oe,$e;B.parameters={...B.parameters,docs:{...(Ce=B.parameters)==null?void 0:Ce.docs,source:{originalSource:"DarkModeTemplateFactory()",...($e=(Oe=B.parameters)==null?void 0:Oe.docs)==null?void 0:$e.source}}};var Ye,Pe,je;L.parameters={...L.parameters,docs:{...(Ye=L.parameters)==null?void 0:Ye.docs,source:{originalSource:`args => ({
  components: {
    DBanner,
    DAutoLayout,
    DText,
  ...
  \`
})`,...(je=(Pe=L.parameters)==null?void 0:Pe.docs)==null?void 0:je.source}}};const er=["Default","OnlyDescription","OnlyDescriptionRemoveable","DarkDefault","Success","DarkSuccess","Error","DarkError","Warning","DarkWarning","Info","DarkInfo","DefaultRemovable","DarkDefaultRemovable","SuccessRemovable","DarkSuccessRemovable","ErrorRemovable","DarkErrorRemovable","WarningRemovable","DarkWarningRemovable","InfoRemovable","DarkInfoRemovable","CustomBanner"];export{L as CustomBanner,n as DarkDefault,D as DarkDefaultRemovable,m as DarkError,k as DarkErrorRemovable,g as DarkInfo,B as DarkInfoRemovable,c as DarkSuccess,S as DarkSuccessRemovable,p as DarkWarning,y as DarkWarningRemovable,t as Default,b as DefaultRemovable,d as Error,T as ErrorRemovable,u as Info,h as InfoRemovable,a as OnlyDescription,s as OnlyDescriptionRemoveable,i as Success,v as SuccessRemovable,l as Warning,f as WarningRemovable,er as __namedExportsOrder,Ze as default};
