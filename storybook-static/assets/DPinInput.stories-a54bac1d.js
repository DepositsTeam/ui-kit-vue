import{aa as e,R as gn,p as vn,_ as un}from"./DAccordion-a3e21a48.js";import"./vue.esm-bundler-e81cbe33.js";import"./iframe-003e986f.js";import"../sb-preview/runtime.js";import"./_commonjsHelpers-87174ba5.js";const In={title:"Forms/Pin Input",component:e,tags:["autodocs"],argTypes:{...gn,spacing:{control:{type:"text"}},password:{control:{type:"boolean"}},noOfCharacters:{control:{type:"number"}}}},u=n=>({components:{DPinInput:e},data:()=>({pin:""}),setup(){return{args:n}},template:`
  ...
  template: \`
    <d-pin-input v-model="pin" v-bind="args" />\`
})`,...(B=(C=s.parameters)==null?void 0:C.docs)==null?void 0:B.source}}};var H,V,A;o.parameters={...o.parameters,docs:{...(H=o.parameters)==null?void 0:H.docs,source:{originalSource:"DarkModeTemplateFactory()",...(A=(V=o.parameters)==null?void 0:V.docs)==null?void 0:A.source}}};var L,R,$;p.parameters={...p.parameters,docs:{...(L=p.parameters)==null?void 0:L.docs,source:{originalSource:`args => ({
  components: {
    DPinInput
  },
  data: () => ({
