import{W as c,_ as K}from"./DTooltip-d12abcff.js";import"./vue.esm-bundler-673e2372.js";import"./floating-ui.dom-c3a31ea6.js";import"./_commonjsHelpers-042e6b4d.js";const $={title:"Forms/Pin Input",component:c,argTypes:{spacing:{control:{type:"text"}},password:{control:{type:"boolean"}},noOfCharacters:{control:{type:"number"}}}},l=r=>({components:{DPinInput:c},data:()=>({pin:""}),setup(){return{args:r}},template:`
  ...
  template: \`
    <d-pin-input v-model="pin" v-bind="args" />\`
})`,...(h=(V=o.parameters)==null?void 0:V.docs)==null?void 0:h.source}}};var A,B,W;t.parameters={...t.parameters,docs:{...(A=t.parameters)==null?void 0:A.docs,source:{originalSource:"DarkModeTemplateFactory()",...(W=(B=t.parameters)==null?void 0:B.docs)==null?void 0:W.source}}};var j,q,z;p.parameters={...p.parameters,docs:{...(j=p.parameters)==null?void 0:j.docs,source:{originalSource:`args => ({
  components: {
    DPinInput
  },
  data: () => ({
...
//# sourceMappingURL=DPinInput.stories-40e6f0b0.js.map
