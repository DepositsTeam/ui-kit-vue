import{a2 as g,i as L}from"./WalletOutlineIcon-89f6eca1.js";import"./vue.esm-bundler-2f75f87e.js";import"./floating-ui.dom-c3a31ea6.js";import"./_commonjsHelpers-87174ba5.js";const X={title:"Progress bar",component:g,tags:["autodocs"],argTypes:{percentage:{control:{type:"text"}},totalSteps:{control:{type:"number"}},currentStep:{control:{type:"number"}},fillColor:{control:{type:"color"}},emptyColor:{control:{type:"color"}},darkFillColor:{control:{type:"color"}},darkEmptyColor:{control:{type:"color"}},variant:{control:{type:"select"},options:["variant-1","variant-2"],default:"variant-1"},height:{control:{type:"text"},default:"6px"}}},e=r=>({components:{DProgressBar:g},setup(){return{args:r}},template:'<d-progress-bar v-bind="args" />'}),N=r=>({components:{DProgressBar:g,DarkModeProvider:L},setup(){return{args:r}},template:`
...
//# sourceMappingURL=DProgressBar.stories-5e29d3ec.js.map
