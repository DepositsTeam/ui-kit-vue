import{M as g,t as ae,o as te,E as se,_ as oe}from"./DWysiwyg-2d436007.js";import"./vue.esm-bundler-a99e1ba3.js";import"./_commonjsHelpers-042e6b4d.js";import"./floating-ui.dom-c3a31ea6.js";const ie={component:g,title:"Stepper",tags:["autodocs"],argTypes:{steps:{control:{type:"object"}},currentStep:{control:{type:"number"}},scheme:{control:{type:"select"},options:["variant-1","variant-2"]},activeColor:{control:{type:"color"}},stepMode:{control:{type:"boolean"}}}},r=e=>({components:{DStepper:g},setup(){return{args:e}},template:'<d-stepper v-bind="args" />'}),ne=e=>({components:{DStepper:g,DarkModeProvider:oe},setup(){return{args:e}},template:`<dark-mode-provider :dark-mode="true">
  ...
  template: \`<d-stepper v-bind="args" />\`
})`,...(F=(_=p.parameters)==null?void 0:_.docs)==null?void 0:F.source}}};var N,I,E;d.parameters={...d.parameters,docs:{...(N=d.parameters)==null?void 0:N.docs,source:{originalSource:`args => ({
  components: {
    DStepper
  },
  setup() {
...
//# sourceMappingURL=DStepper.stories-4bcac31d.js.map
