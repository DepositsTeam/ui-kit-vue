import{U as e,u as s,w as E,x as U,e as B,n as w,b as H,v as O}from"./DTooltip-ca5caf4e.js";import"./vue.esm-bundler-673e2372.js";import"./floating-ui.dom-c3a31ea6.js";import"./_commonjsHelpers-042e6b4d.js";const G={title:"Forms/Cards/Radio Card",component:e,argTypes:{}},P=a=>({components:{DRadioCard:e,CardIcon:s},data:()=>({value:""}),setup(){return{args:a}},template:`<d-radio-card v-model="value" value="value" v-bind="args">
  ...
  `}),o=F.bind({});o.args={heading:"One time payment",description:"Use this option to collect a one off payment",expandable:!0};const L=a=>({components:{DRadioCard:e,DFilePicker:E,CardIcon:s},data:()=>({value:""}),setup(){return{args:a}},template:`
    ...
    <p>Radio value is: {{value}}</p>
  `}),r=L.bind({});r.args={heading:"One time payment",description:"Use this option to collect a one off payment",expandable:!0};const N=a=>({components:{DRadioCard:e,CardIcon:s,DHeading:U,DText:B,DAutoLayout:w,DBox:H},data:()=>({value:""}),setup(){return{args:a}},template:`<d-radio-card v-model="value" value="value" v-bind="args">
  <template #icon>
    <card-icon />
  </template>
  <template #heading>
...
//# sourceMappingURL=DRadioCard.stories-63b5dbf3.js.map
