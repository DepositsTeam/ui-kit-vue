import{w as a,x as n,y as V,h as N,z as P,A as $,r as z,p as j,B as q}from"./DWysiwyg-8b06f99b.js";import"./vue.esm-bundler-77038495.js";import"./iframe-81abf740.js";import"../sb-preview/runtime.js";import"./_commonjsHelpers-042e6b4d.js";import"./floating-ui.dom-c3a31ea6.js";const ce={title:"Forms/Switch Card",component:a,argTypes:{},tags:["autodocs"]},J=e=>({components:{DSwitchCard:a,CardIcon:n},data:()=>({value:!1}),setup(){return{args:e}},template:`
  ...
  `}),t=J.bind({});t.args={heading:"Card",description:"Add your debit / credit card information",label:"Select card option"};const G=e=>({components:{DSwitchCard:a,CardIcon:n},data:()=>({value:!1}),setup(){return{args:e}},template:`
    ...
    <p>Checkbox value is: {{value}}</p>
  `}),o=G.bind({});o.args={heading:"Card",description:"Add your debit / credit card information"};const r=J.bind({});r.args={heading:"Card",description:"Add your debit / credit card information"};const K=e=>({components:{DSwitchCard:a,CardIcon:n,BankIcon:V,DAutoLayout:N},data:()=>({values:[]}),setup(){return{args:e}},template:`
  ...
  `}),d=R.bind({});d.args={heading:"One time payment",description:"Use this option to collect a one off payment",expandable:!0};const X=e=>({components:{DSwitchCard:a,DFilePicker:P,CardIcon:n},data:()=>({value:""}),setup(){return{args:e}},template:`
    ...
    <p>Checkbox value is: {{value}}</p>
  `}),s=X.bind({});s.args={heading:"One time payment",description:"Use this option to collect a one off payment",expandable:!0};const Y=e=>({components:{DSwitchCard:a,CardIcon:n,DHeading:$,DText:z,DAutoLayout:N,DBox:j},data:()=>({value:""}),setup(){return{args:e}},template:`<d-switch-card v-model="value" value="value" v-bind="args">
  <template #icon>
    <card-icon />
  </template>
  <template #heading>
  ...
  <p>Checkbox value is: {{value}}</p>
  `}),i=Y.bind({});i.args={heading:"One time payment",description:"Use this option to collect a one off payment"};const Z=e=>({components:{DSwitchCard:a,CardIcon:n,DAlert:q},data:()=>({value:!1}),setup(){return{args:e}},template:`
    <d-switch-card v-model="value" value="value" v-bind="args">
      <template #footer>
  ...
  template: \`
    ...
    <p>Checkbox value is: {{value}}</p>
  \`
})`,...(F=(T=d.parameters)==null?void 0:T.docs)==null?void 0:F.source}}};var O,_,B;s.parameters={...s.parameters,docs:{...(O=s.parameters)==null?void 0:O.docs,source:{originalSource:`args => ({
  components: {
    DSwitchCard,
    DFilePicker,
    CardIcon
  ...
  template: \`
    ...
    <p>Checkbox value is: {{value}}</p>
  \`
})`,...(B=(_=s.parameters)==null?void 0:_.docs)==null?void 0:B.source}}};var E,U,W;i.parameters={...i.parameters,docs:{...(E=i.parameters)==null?void 0:E.docs,source:{originalSource:`args => ({
  components: {
    DSwitchCard,
    CardIcon,
    DHeading,
  ...
  <p>Checkbox value is: {{value}}</p>
  \`
})`,...(W=(U=i.parameters)==null?void 0:U.docs)==null?void 0:W.source}}};var M,H,L;l.parameters={...l.parameters,docs:{...(M=l.parameters)==null?void 0:M.docs,source:{originalSource:`args => ({
  components: {
    DSwitchCard,
    CardIcon,
    DAlert
  ...
  template: \`
    ...
    <p>Checkbox value is: {{value}}</p>
  \`
})`,...(L=(H=l.parameters)==null?void 0:H.docs)==null?void 0:L.source}}};const de=["WithLabel","TrueOrFalseCheckbox","CheckboxWithValue","CheckboxArray","NoIcon","ExpandMode","ExpandModeWithoutIcon","CustomHeadingAndDescription","FooterSlot"];export{p as CheckboxArray,r as CheckboxWithValue,i as CustomHeadingAndDescription,d as ExpandMode,s as ExpandModeWithoutIcon,l as FooterSlot,c as NoIcon,o as TrueOrFalseCheckbox,t as WithLabel,de as __namedExportsOrder,ce as default};
//# sourceMappingURL=DSwitchCard.stories-5ed55396.js.map
