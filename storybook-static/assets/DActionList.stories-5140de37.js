import{aH as a,aF as T,l as R}from"./DWysiwyg-02771dd6.js";import"./vue.esm-bundler-77038495.js";import"./iframe-468a85b4.js";import"../sb-preview/runtime.js";import"./_commonjsHelpers-042e6b4d.js";import"./floating-ui.dom-c3a31ea6.js";const W={title:"Action List",component:a,tags:["autodocs"],argTypes:{label:{control:{type:"text"}},list:{control:{type:"object"}},size:{control:{type:"select"},options:["small","medium","large","xlarge","huge","massive"]}}},r=l=>({components:{DActionList:a},setup(){return{args:l}},methods:{alertMessage(J){alert("Hello"),console.log(J)}},template:`
  ...
  template: \`
      <d-action-list @list-action-clicked="alertMessage" v-bind="args"/>\`
})`,...(P=(D=s.parameters)==null?void 0:D.docs)==null?void 0:P.source}}};const H=["Default","ActionListWithoutListProps","DifferentButtonColors","WithImage","WithDescription","WithDifferentButtonSizes"];export{e as ActionListWithoutListProps,t as Default,o as DifferentButtonColors,n as WithDescription,s as WithDifferentButtonSizes,i as WithImage,H as __namedExportsOrder,W as default};
//# sourceMappingURL=DActionList.stories-5140de37.js.map
