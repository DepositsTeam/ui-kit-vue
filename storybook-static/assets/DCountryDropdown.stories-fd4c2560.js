import{at as w,n as O,L as T}from"./DWysiwyg-8b06f99b.js";import"./vue.esm-bundler-77038495.js";import{s as F}from"./selectProps-2e81a4d1.js";import"./iframe-81abf740.js";import"../sb-preview/runtime.js";import"./_commonjsHelpers-042e6b4d.js";import"./floating-ui.dom-c3a31ea6.js";const R={component:w,title:"Forms/Country Dropdown",tags:["autodocs"],argTypes:{...O,...F}},r=x=>({components:{DCountryDropdown:w,DSelect:T},data:()=>({country:"",states:[],selectedState:""}),setup(){return{args:x}},methods:{hydrateStates:function(C){this.states=C.map(o=>({text:o.name,value:o.name}))}},template:`
  ...
  template: \`
    ...
    <p>Selected country: {{ country }}</p>
  \`
})`,...(f=(b=a.parameters)==null?void 0:b.docs)==null?void 0:f.source}}};const L=["Default","HasError","ReturnFullObject","UseDifferentTitleAndValue","OnlyUS"];export{t as Default,e as HasError,a as OnlyUS,n as ReturnFullObject,s as UseDifferentTitleAndValue,L as __namedExportsOrder,R as default};
//# sourceMappingURL=DCountryDropdown.stories-fd4c2560.js.map
