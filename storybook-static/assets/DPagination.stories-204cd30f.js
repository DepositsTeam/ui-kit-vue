import{ab as c,_ as f}from"./DWysiwyg-27c4e042.js";import"./vue.esm-bundler-c483924c.js";import"./_commonjsHelpers-042e6b4d.js";import"./floating-ui.dom-c3a31ea6.js";const F={title:"Pagination",component:c,tags:["autodocs"],argTypes:{totalPages:{control:{type:"number"}},currentPage:{control:{type:"number"}},currentPageSiblings:{control:{type:"number"}},smartColor:{control:{type:"color"}}}},s=e=>({components:{DPagination:c},setup(){return{args:e}},template:'<d-pagination v-bind="args" />'}),O=e=>({components:{DPagination:c,DarkModeProvider:f},methods:{console:function(k){console.log("Page changed to: ",k)}},setup(){return{args:e}},template:`
  ...
  template: \`<d-pagination v-bind="args" />\`
})`,...(y=(P=n.parameters)==null?void 0:P.docs)==null?void 0:y.source}}};var b,v,D;r.parameters={...r.parameters,docs:{...(b=r.parameters)==null?void 0:b.docs,source:{originalSource:`args => ({
  components: {
    DPagination
  },
  setup() {
  ...
  template: \`<d-pagination v-bind="args" />\`
})`,...(D=(v=r.parameters)==null?void 0:v.docs)==null?void 0:D.source}}};var x,A,N;a.parameters={...a.parameters,docs:{...(x=a.parameters)==null?void 0:x.docs,source:{originalSource:`args => ({
  components: {
    DPagination
  },
  setup() {
...
//# sourceMappingURL=DPagination.stories-204cd30f.js.map
