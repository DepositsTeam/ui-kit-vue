var u=Object.defineProperty;var n=(o,t)=>u(o,"name",{value:t,configurable:!0});import{Z as s,$ as c,_ as d,g as l}from"./DAccordion-efe34db7.js";import{v as i}from"./vue.esm-bundler-f42bdcc2.js";import"./iframe-6096d5f2.js";const m=n(()=>{const o=i("d__pushToast"),t=i("d__clearToasts");return{pushToast:n(p=>{if(o&&typeof o=="function")return o(p);throw Error("The `pushToast` function is not enabled. You probably omitted the ToastProvider.")},"pushToast"),clearToasts:n(()=>t(),"clearToasts")}},"useToast"),w={parameters:{storySource:{source:`import DToast from "./DToast.vue";
...
//# sourceMappingURL=DToast.stories-b68b5085.js.map
