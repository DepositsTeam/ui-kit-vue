import{N as s,r as x,_ as M}from"./DWysiwyg-688f494a.js";import"./vue.esm-bundler-673e2372.js";import"./floating-ui.dom-c3a31ea6.js";import"./_commonjsHelpers-042e6b4d.js";const N={title:"Forms/Radio",component:s,argTypes:{ringed:{control:{type:"boolean"}},alignToTop:{control:{type:"boolean"}},label:{control:{type:"text"}},value:{control:{type:"text"}},disabled:{control:{type:"boolean"}},alignRight:{control:{type:"boolean"}},ringSize:{control:{type:"text"},default:"16px"},ringThickness:{control:{type:"text"},default:"5px"}}},R=e=>({components:{DRadio:s},setup:function(){return{args:e}},template:'<d-radio v-bind="args" />'}),S=e=>({components:{DRadio:s,DarkModeProvider:M},data:()=>({value:""}),setup(){return{args:e}},template:`
  ...
  template: \`
    ...
    \`
})`,...(h=(f=n.parameters)==null?void 0:f.docs)==null?void 0:h.source}}};const L=["Default","DarkDefault","Ringed","DarkRinged","Multiple"];export{o as DarkDefault,t as DarkRinged,a as Default,n as Multiple,r as Ringed,L as __namedExportsOrder,N as default};
//# sourceMappingURL=DRadio.stories-eb3e35a3.js.map
