import{F as g,G as ne,H as oe,_ as ae}from"./DWysiwyg-666d51f7.js";import"./vue.esm-bundler-673e2372.js";import"./floating-ui.dom-c3a31ea6.js";import"./_commonjsHelpers-042e6b4d.js";const ce={title:"Forms/Tag Dropdown",component:g,argTypes:{...ne,placeholder:{control:{type:"text"}},showCheckboxes:{control:{type:"boolean"}},options:{control:{type:"object"}}}},v=e=>({components:{DTagDropdown:g},data:()=>({value:[]}),setup(){return{args:e}},template:'<d-tag-dropdown v-model="value" v-bind="args" />'}),D=e=>({components:{DTagDropdown:g},data:()=>({value:["banking","money"]}),setup(){return{args:e}},template:`
  ...
  template: \`
    ...
    <p>Selected value is {{value}}</p>
  \`
})`,...($=(G=i.parameters)==null?void 0:G.docs)==null?void 0:$.source}}};var q,z,J;l.parameters={...l.parameters,docs:{...(q=l.parameters)==null?void 0:q.docs,source:{originalSource:`args => ({
  components: {
    DTagDropdown
  },
  data: () => ({
  ...
  template: \`
    ...
    <p>Selected value is {{value}}</p>
  \`
})`,...(J=(z=l.parameters)==null?void 0:z.docs)==null?void 0:J.source}}};var K,N,Q;c.parameters={...c.parameters,docs:{...(K=c.parameters)==null?void 0:K.docs,source:{originalSource:"DarkModeTemplateFactory(DarkModePredefinedTemplate)",...(Q=(N=c.parameters)==null?void 0:N.docs)==null?void 0:Q.source}}};var R,V,X;m.parameters={...m.parameters,docs:{...(R=m.parameters)==null?void 0:R.docs,source:{originalSource:`args => ({
  components: {
    DTagDropdown
  },
  data: () => ({
...
//# sourceMappingURL=DTagDropdown.stories-0dbd8ec0.js.map
