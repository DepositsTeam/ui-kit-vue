import{F as f,d as k}from"./DWysiwyg-f7e28e1f.js";import"./vue.esm-bundler-a99e1ba3.js";import"./_commonjsHelpers-042e6b4d.js";import"./floating-ui.dom-c3a31ea6.js";const H={title:"Menu (Context or Dropdown menu)",component:f,tags:["autodocs"],argTypes:{}},i=n=>({components:{DMenu:f,DButton:k},data:()=>({}),methods:{consoleOption:function(B){}},setup(){return{args:n}},template:`<d-menu v-bind="args" @option-clicked="(option) => consoleOption(option, item)">
  <d-button>...</d-button>
...
//# sourceMappingURL=DMenu.stories-2ce3cadb.js.map
