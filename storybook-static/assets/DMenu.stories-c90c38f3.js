import{v as h,f as k}from"./DTooltip-d412d8f4.js";import"./vue.esm-bundler-d253c880.js";import"./floating-ui.dom-c3a31ea6.js";import"./_commonjsHelpers-042e6b4d.js";const I={title:"Menu (Context or Dropdown menu)",component:h,argTypes:{}},i=n=>({components:{DMenu:h,DButton:k},data:()=>({}),methods:{consoleOption:function(B){}},setup(){return{args:n}},template:`<d-menu v-bind="args" @option-clicked="(option) => consoleOption(option, item)">
  <d-button>...</d-button>
...
})`,...(O=(x=r.parameters)==null?void 0:x.docs)==null?void 0:O.source}}};var C,v,f;s.parameters={...s.parameters,docs:{...(C=s.parameters)==null?void 0:C.docs,source:{originalSource:`args => ({
  components: {
    DMenu,
    DButton
  },
...
})`,...(f=(v=s.parameters)==null?void 0:v.docs)==null?void 0:f.source}}};const T=["Default","StringOptions","CustomOptionColor","DisabledOption","HoverTrigger"];export{e as CustomOptionColor,t as Default,r as DisabledOption,s as HoverTrigger,o as StringOptions,T as __namedExportsOrder,I as default};
//# sourceMappingURL=DMenu.stories-c90c38f3.js.map
