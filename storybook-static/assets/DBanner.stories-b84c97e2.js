import{aj as R,n as qe,f as ze,e as Ge,_ as He}from"./DTooltip-2f321ebd.js";import"./vue.esm-bundler-673e2372.js";import"./floating-ui.dom-c3a31ea6.js";import"./_commonjsHelpers-042e6b4d.js";const Xe={title:"Banner",component:R,argTypes:{title:{control:{type:"text"}},description:{control:{type:"text"}},colorScheme:{control:{type:"select"},options:["default","info","warning","error","success"]},removable:{control:{type:"boolean"}},alignTop:{control:{type:"boolean"}},full:{control:{type:"boolean"},default:!0},smartColor:{control:{type:"color"}},iconColor:{control:{type:"color"}}}},e=o=>({components:{DBanner:R},setup(){return{args:o}},template:'<d-banner v-bind="args" />'}),Je=o=>({components:{DBanner:R,DarkModeProvider:He},setup(){return{args:o}},template:`
  ...
  template: \`<d-banner v-bind="args" />\`
})`,...(W=(I=a.parameters)==null?void 0:I.docs)==null?void 0:W.source}}};var _,w,A;n.parameters={...n.parameters,docs:{...(_=n.parameters)==null?void 0:_.docs,source:{originalSource:`args => ({
  components: {
    DBanner
  },
  setup() {
  ...
  template: \`<d-banner v-bind="args" />\`
})`,...(A=(w=n.parameters)==null?void 0:w.docs)==null?void 0:A.source}}};var C,O,Y;s.parameters={...s.parameters,docs:{...(C=s.parameters)==null?void 0:C.docs,source:{originalSource:"DarkModeTemplateFactory()",...(Y=(O=s.parameters)==null?void 0:O.docs)==null?void 0:Y.source}}};var j,P,$;i.parameters={...i.parameters,docs:{...(j=i.parameters)==null?void 0:j.docs,source:{originalSource:`args => ({
  components: {
    DBanner
  },
  setup() {
  ...
  template: \`<d-banner v-bind="args" />\`
})`,...(Ae=(we=B.parameters)==null?void 0:we.docs)==null?void 0:Ae.source}}};var Ce,Oe,Ye;h.parameters={...h.parameters,docs:{...(Ce=h.parameters)==null?void 0:Ce.docs,source:{originalSource:"DarkModeTemplateFactory()",...(Ye=(Oe=h.parameters)==null?void 0:Oe.docs)==null?void 0:Ye.source}}};var je,Pe,$e;L.parameters={...L.parameters,docs:{...(je=L.parameters)==null?void 0:je.docs,source:{originalSource:`args => ({
  components: {
    DBanner,
    DAutoLayout,
    DText,
  ...
  \`
})`,...($e=(Pe=L.parameters)==null?void 0:Pe.docs)==null?void 0:$e.source}}};const Ze=["Default","OnlyDescription","OnlyDescriptionRemoveable","DarkDefault","Success","DarkSuccess","Error","DarkError","Warning","DarkWarning","Info","DarkInfo","DefaultRemovable","DarkDefaultRemovable","SuccessRemovable","DarkSuccessRemovable","ErrorRemovable","DarkErrorRemovable","WarningRemovable","DarkWarningRemovable","InfoRemovable","DarkInfoRemovable","CustomBanner"];export{L as CustomBanner,s as DarkDefault,D as DarkDefaultRemovable,m as DarkError,k as DarkErrorRemovable,g as DarkInfo,h as DarkInfoRemovable,c as DarkSuccess,S as DarkSuccessRemovable,p as DarkWarning,f as DarkWarningRemovable,t as Default,b as DefaultRemovable,d as Error,T as ErrorRemovable,u as Info,B as InfoRemovable,a as OnlyDescription,n as OnlyDescriptionRemoveable,i as Success,v as SuccessRemovable,l as Warning,y as WarningRemovable,Ze as __namedExportsOrder,Xe as default};
//# sourceMappingURL=DBanner.stories-b84c97e2.js.map
