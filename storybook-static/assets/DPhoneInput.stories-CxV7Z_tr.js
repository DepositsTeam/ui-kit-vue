import{a8 as c,Q,f as j}from"./DAccordion-CN3Js_XK.js";import"./vue.esm-bundler-DYd614QV.js";import"./iframe-DxcWvM7r.js";import"../sb-preview/runtime.js";import"./_commonjsHelpers-BosuxZz1.js";const V={title:"Forms/Phone Field",component:c,tags:["autodocs"],argTypes:{...Q,size:{control:{type:"select"},options:["small","medium","large","xlarge","huge","massive"]},disabled:{control:{type:"boolean"}},errorMessage:{control:{type:"text"}},code:{control:{type:"text"}},phoneNumber:{control:{type:"boolean"}}}},m=e=>({components:{DPhoneInput:c},data:()=>({code:"",number:""}),setup(){return{args:e}},template:'<d-phone-input v-bind="args" v-model:code.lazy="code" v-model:phone-number="number"  />'}),q=e=>({components:{DPhoneInput:c},data:()=>({code:"",number:"+13332392383"}),setup(){return{args:e}},template:'<d-phone-input v-bind="args" v-model:code.lazy="code" v-model:phone-number="number"  />'}),r=q.bind({});r.args={isUs:!0};const w=e=>({components:{DPhoneInput:c,DarkModeProvider:j},data:()=>({code:"",number:""}),setup(){return{args:e}},template:`
