import{h as u,U as t,u as i}from"./DWysiwyg-a82eaa9d.js";import"./vue.esm-bundler-41d8d808.js";import"./floating-ui.dom-c3a31ea6.js";import"./_commonjsHelpers-042e6b4d.js";const E={components:{DAutoLayout:u},title:"Forms/Restricted Color Config",component:t,tags:["autodocs"],argTypes:{label:{control:{type:"text"},default:"Color"},colors:{control:{type:"object"}}}},m=r=>({components:{DRestrictedColorConfig:t},data:()=>({value:""}),setup(){return{args:r}},template:`
      <d-restricted-color-config v-model="value" v-bind="args"/>`}),o=m.bind({});o.args={colors:[{colorCode:"#0C9CCC",colorName:"Teal"},{colorCode:"#1A8B5A",colorName:"Green"},{colorCode:"#2A2E33",colorName:"Black"},{colorCode:"#971E31",colorName:"Red"},{colorCode:"#E1E7EC",colorName:"White"},{colorCode:"#E06104",colorName:"Orange"},{colorCode:"#0059AC",colorName:"Blue"},{colorCode:"#4D36C0",colorName:"Purple"}],label:"Color"};const C=r=>({components:{DRestrictedColorConfig:t,DText:i,DAutoLayout:u},data:()=>({value:"#2A2E33"}),setup(){return{args:r}},template:`
...
//# sourceMappingURL=DRestrictedColorConfig.stories-106e8aa3.js.map
