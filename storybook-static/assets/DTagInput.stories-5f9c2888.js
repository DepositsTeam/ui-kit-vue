import{s as h,n as te,_ as re}from"./DWysiwyg-02771dd6.js";import"./vue.esm-bundler-77038495.js";import"./iframe-468a85b4.js";import"../sb-preview/runtime.js";import"./_commonjsHelpers-042e6b4d.js";import"./floating-ui.dom-c3a31ea6.js";const ue={title:"Forms/Tag Input",component:h,tags:["autodocs"],argTypes:{...te,label:{control:{type:"text"}},size:{control:{type:"select"},options:["small","medium","large","xlarge","huge","massive"]},values:{control:{type:"object"},table:{defaultValue:["Option 1","Option 2","Option 3"]}},tagDelimiterKey:{control:{type:"select"},options:["enter","comma","space"],table:{defaultValue:"enter"}}}},n=o=>({components:{DTagInput:h},data:()=>({input:["Option one","Option 2","Option 3"]}),methods:{onTagAdded:function(e,a){console.log(e,a)},onTagChanged:function(e,a){console.log(e,a)},onTagDeleted:function(e,a){console.log(e,a)},onTextChanged:function(e){console.log(e)}},setup(){return{args:o}},template:'<d-tag-input @tag-added="onTagAdded" @text-changed="onTextChanged" @tag-deleted="onTagDeleted" @tag-changed="onTagChanged" v-model="input" v-bind="args" />'}),se=o=>({components:{DTagInput:h,DarkModeProvider:re},data:()=>({input:["Option one","Option 2","Option 3"]}),methods:{onTagAdded:function(e,a){console.log(e,a)},onTagChanged:function(e,a){console.log(e,a)},onTagDeleted:function(e,a){console.log(e,a)},onTextChanged:function(e){console.log(e)}},setup(){return{args:o}},template:`
    ...
    `}),t=()=>{const o=se.bind({});return o.decorators=[()=>({template:'<div style="padding: 3em; background: #121A26;"><story /></div>'})],o},r=n.bind({});r.args={label:"Form Label",size:"massive"};const s=n.bind({});s.args={label:"Form Label",size:"massive",errorMessage:"Random, default error"};const g=t();g.args={label:"Form Label",size:"massive"};const d=n.bind({});d.args={label:"Form Label",size:"huge"};const l=t();l.args={label:"Form Label",size:"huge"};const c=n.bind({});c.args={label:"Form Label",size:"xlarge"};const i=t();i.args={label:"Form Label",size:"xlarge"};const p=n.bind({});p.args={label:"Form Label",size:"large"};const u=t();u.args={label:"Form Label",size:"large"};const m=n.bind({});m.args={label:"Form Label",size:"medium"};const T=t();T.args={label:"Form Label",size:"medium"};const A=n.bind({});A.args={label:"Form Label",size:"small"};const y=t();y.args={label:"Form Label",size:"small"};var D,b,v;r.parameters={...r.parameters,docs:{...(D=r.parameters)==null?void 0:D.docs,source:{originalSource:`args => ({
  components: {
    DTagInput
  },
  data: () => ({
  ...
  template: \`<d-tag-input @tag-added="onTagAdded" @text-changed="onTextChanged" @tag-deleted="onTagDeleted" @tag-changed="onTagChanged" v-model="input" v-bind="args" />\`
})`,...(ee=($=A.parameters)==null?void 0:$.docs)==null?void 0:ee.source}}};var ae,ne,oe;y.parameters={...y.parameters,docs:{...(ae=y.parameters)==null?void 0:ae.docs,source:{originalSource:"DarkModeTemplateFactory()",...(oe=(ne=y.parameters)==null?void 0:ne.docs)==null?void 0:oe.source}}};const me=["SizeMassive","HasError","SizeMassiveDark","SizeHuge","SizeHugeDark","SizeXLarge","SizeXLargeDark","SizeLarge","SizeLargeDark","SizeMedium","SizeMediumDark","SizeSmall","SizeSmallDark"];export{s as HasError,d as SizeHuge,l as SizeHugeDark,p as SizeLarge,u as SizeLargeDark,r as SizeMassive,g as SizeMassiveDark,m as SizeMedium,T as SizeMediumDark,A as SizeSmall,y as SizeSmallDark,c as SizeXLarge,i as SizeXLargeDark,me as __namedExportsOrder,ue as default};
//# sourceMappingURL=DTagInput.stories-5f9c2888.js.map
