import{a5 as f,d as k}from"./DAccordion-BVk4RD25.js";import"./vue.esm-bundler-CUqwZzoc.js";import"./iframe-DyUYSNBQ.js";import"../sb-preview/runtime.js";import"./_commonjsHelpers-BosuxZz1.js";const T={title:"Menu (Context or Dropdown menu)",component:f,tags:["autodocs"],argTypes:{}},i=n=>({components:{DMenu:f,DButton:k},data:()=>({}),methods:{consoleOption:function(B){}},setup(){return{args:n}},template:`<d-menu v-bind="args" @option-clicked="(option) => consoleOption(option, item)">
  <d-button>...</d-button>
