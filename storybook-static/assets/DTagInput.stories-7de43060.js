import{$ as y,_ as ee}from"./DAccordion-15ab541e.js";import"./vue.esm-bundler-90c41ac5.js";import"./_commonjsHelpers-87174ba5.js";const re={title:"Forms/Tag Input",component:y,argTypes:{label:{control:{type:"text"}},size:{control:{type:"select"},options:["small","medium","large","xlarge","huge","massive"]},values:{control:{type:"object"},table:{defaultValue:["Option 1","Option 2","Option 3"]}},tagDelimiterKey:{control:{type:"select"},options:["enter","comma","space"],table:{defaultValue:"enter"}}}},o=n=>({components:{DTagInput:y},data:()=>({input:["Option one","Option 2","Option 3"]}),methods:{onTagAdded:function(e,a){console.log(e,a)},onTagChanged:function(e,a){console.log(e,a)},onTagDeleted:function(e,a){console.log(e,a)},onTextChanged:function(e){console.log(e)}},setup(){return{args:n}},template:'<d-tag-input @tag-added="onTagAdded" @text-changed="onTextChanged" @tag-deleted="onTagDeleted" @tag-changed="onTagChanged" v-model="input" v-bind="args" />'}),ae=n=>({components:{DTagInput:y,DarkModeProvider:ee},data:()=>({input:["Option one","Option 2","Option 3"]}),methods:{onTagAdded:function(e,a){console.log(e,a)},onTagChanged:function(e,a){console.log(e,a)},onTagDeleted:function(e,a){console.log(e,a)},onTextChanged:function(e){console.log(e)}},setup(){return{args:n}},template:`
  ...
  template: \`<d-tag-input @tag-added="onTagAdded" @text-changed="onTextChanged" @tag-deleted="onTagDeleted" @tag-changed="onTagChanged" v-model="input" v-bind="args" />\`
})`,...(q=($=u.parameters)==null?void 0:$.docs)==null?void 0:q.source}}};var G,J,N;m.parameters={...m.parameters,docs:{...(G=m.parameters)==null?void 0:G.docs,source:{originalSource:"DarkModeTemplateFactory()",...(N=(J=m.parameters)==null?void 0:J.docs)==null?void 0:N.source}}};var Q,R,U;T.parameters={...T.parameters,docs:{...(Q=T.parameters)==null?void 0:Q.docs,source:{originalSource:`args => ({
  components: {
    DTagInput
  },
  data: () => ({
  ...
  template: \`<d-tag-input @tag-added="onTagAdded" @text-changed="onTextChanged" @tag-deleted="onTagDeleted" @tag-changed="onTagChanged" v-model="input" v-bind="args" />\`
})`,...(U=(R=T.parameters)==null?void 0:R.docs)==null?void 0:U.source}}};var W,Y,Z;A.parameters={...A.parameters,docs:{...(W=A.parameters)==null?void 0:W.docs,source:{originalSource:"DarkModeTemplateFactory()",...(Z=(Y=A.parameters)==null?void 0:Y.docs)==null?void 0:Z.source}}};const se=["SizeMassive","SizeMassiveDark","SizeHuge","SizeHugeDark","SizeXLarge","SizeXLargeDark","SizeLarge","SizeLargeDark","SizeMedium","SizeMediumDark","SizeSmall","SizeSmallDark"];export{g as SizeHuge,d as SizeHugeDark,i as SizeLarge,p as SizeLargeDark,r as SizeMassive,s as SizeMassiveDark,u as SizeMedium,m as SizeMediumDark,T as SizeSmall,A as SizeSmallDark,l as SizeXLarge,c as SizeXLargeDark,se as __namedExportsOrder,re as default};
//# sourceMappingURL=DTagInput.stories-7de43060.js.map
