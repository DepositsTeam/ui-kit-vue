import{p as D,a as ye,D as We,q as ke,r as _e,i as Ae}from"./WalletOutlineIcon-89f6eca1.js";import"./vue.esm-bundler-2f75f87e.js";import"./floating-ui.dom-c3a31ea6.js";import"./_commonjsHelpers-87174ba5.js";const Oe={title:"Tabs",component:D,tags:["autodocs"],argTypes:{tabs:{control:{type:"object"}},horizontal:{control:{type:"boolean"}},spacing:{control:{type:"text"}},initiallyActive:{control:{type:"text"}},inline:{control:{type:"boolean"}},scheme:{control:{type:"select"},options:["button","underline","inline","underline_card"]}}},e=t=>({components:{DTabs:D},setup(){return{args:t}},template:'<d-tabs v-bind="args" />'}),Fe=t=>({components:{DTabs:D,DarkModeProvider:Ae},setup(){return{args:t}},template:`
    <dark-mode-provider :dark-mode="true">
      <d-tabs v-bind="args" />
    </dark-mode-provider>
  `}),we=(t=null)=>{const S=t?t.bind({}):Fe.bind({});return S.decorators=[()=>({template:'<div style="padding: 3em; background: #121A26;"><story /></div>'})],S},a=e.bind({});a.args={tabs:[{text:"Tab 1",href:"#"},{text:"Tab 2",href:"#"},{text:"Tab 3",href:"#"},{text:"Tab 4",href:"#"},{text:"Tab 5 (Disabled)",disabled:!0}]};const r=e.bind({});r.args={tabs:[{text:"Tab 1",href:"#",total:4},{text:"Tab 2",href:"#",total:4},{text:"Tab 3",href:"#",total:4},{text:"Tab 4",href:"#",total:4},{text:"Tab 5 (Disabled)",disabled:!0}]};const n=we();n.args={tabs:[{text:"Test link",href:"#"},{text:"Test link",href:"#"},{text:"Test link",href:"#"},{text:"Test link",href:"#"},{text:"Test link",href:"#"}]};const Me=t=>({components:{DTabs:D,DBox:ye,DText:We,DCard:ke},data:()=>({activeTabIndex:0,tabs:[{text:"Tab 1",href:"#"},{text:"Tab 2",href:"#"},{text:"Tab 3",href:"#"},{text:"Tab 4",href:"#"},{text:"Tab 5 (Disabled)",href:"#",disabled:!0}]}),setup(){return{args:t}},template:`
    <d-box>
  ...
  template: \`<d-tabs v-bind="args" />\`
})`,...(W=(y=r.parameters)==null?void 0:y.docs)==null?void 0:W.source}}};var k,_,A;n.parameters={...n.parameters,docs:{...(k=n.parameters)==null?void 0:k.docs,source:{originalSource:"DarkModeTemplateFactory()",...(A=(_=n.parameters)==null?void 0:_.docs)==null?void 0:A.source}}};var F,w,M;v.parameters={...v.parameters,docs:{...(F=v.parameters)==null?void 0:F.docs,source:{originalSource:`args => ({
  components: {
    DTabs,
    DBox,
    DText,
  ...
  template: \`
    ...
    <d-text>Active Tab Index: {{activeTabIndex}}</d-text>
  \`
})`,...(M=(w=v.parameters)==null?void 0:w.docs)==null?void 0:M.source}}};var j,q,z;s.parameters={...s.parameters,docs:{...(j=s.parameters)==null?void 0:j.docs,source:{originalSource:`args => ({
  components: {
    DTabs
  },
  setup() {
  ...
  template: \`<d-tabs v-bind="args" />\`
})`,...(z=(q=s.parameters)==null?void 0:q.docs)==null?void 0:z.source}}};var E,O,P;o.parameters={...o.parameters,docs:{...(E=o.parameters)==null?void 0:E.docs,source:{originalSource:`args => ({
  components: {
    DTabs
  },
  setup() {
  ...
  template: \`<d-tabs v-bind="args" />\`
})`,...(P=(O=o.parameters)==null?void 0:O.docs)==null?void 0:P.source}}};var $,G,H;d.parameters={...d.parameters,docs:{...($=d.parameters)==null?void 0:$.docs,source:{originalSource:`args => ({
  components: {
    DTabs
  },
  setup() {
  ...
  template: \`<d-tabs v-bind="args" />\`
})`,...(ge=(fe=h.parameters)==null?void 0:fe.docs)==null?void 0:ge.source}}};var De,ve,Se;f.parameters={...f.parameters,docs:{...(De=f.parameters)==null?void 0:De.docs,source:{originalSource:`args => ({
  components: {
    DTabs
  },
  setup() {
  ...
  template: \`<d-tabs v-bind="args" />\`
})`,...(Se=(ve=f.parameters)==null?void 0:ve.docs)==null?void 0:Se.source}}};var Be,Ce,Ie;g.parameters={...g.parameters,docs:{...(Be=g.parameters)==null?void 0:Be.docs,source:{originalSource:`args => ({
  components: {
    DTabs
  },
  setup() {
  ...
  template: \`<d-tabs v-bind="args" />\`
})`,...(Ie=(Ce=g.parameters)==null?void 0:Ce.docs)==null?void 0:Ie.source}}};const Pe=["Default","DefaultBadge","DarkDefault","SampleWithContent","UnderlineSchemeTab","UnderlineSchemeTabBadge","UnderlineCardSchemeTab","UnderlineCardSchemeTabBadge","InlineSchemeTab","InlineSchemeTabBadge","UnderlineCardWithSecondaryItem","UnderlineCardWithSecondaryItemBadge","UnderlineSchemeWithoutBorder","UnderlineSchemeWithoutBorderBadge","UnderlineCardSchemeWithoutBorder","UnderlineCardSchemeWithoutBorderBadge","CustomTabActiveTextColor","CustomTabActiveColor","CustomActiveBadgeColor"];export{g as CustomActiveBadgeColor,f as CustomTabActiveColor,h as CustomTabActiveTextColor,n as DarkDefault,a as Default,r as DefaultBadge,c as InlineSchemeTab,i as InlineSchemeTabBadge,v as SampleWithContent,d as UnderlineCardSchemeTab,b as UnderlineCardSchemeTabBadge,u as UnderlineCardSchemeWithoutBorder,x as UnderlineCardSchemeWithoutBorderBadge,l as UnderlineCardWithSecondaryItem,m as UnderlineCardWithSecondaryItemBadge,s as UnderlineSchemeTab,o as UnderlineSchemeTabBadge,p as UnderlineSchemeWithoutBorder,T as UnderlineSchemeWithoutBorderBadge,Pe as __namedExportsOrder,Oe as default};
//# sourceMappingURL=DTabs.stories-44852bf2.js.map
