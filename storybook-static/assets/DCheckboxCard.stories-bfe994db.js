import{an as a,I as n,J as w,h as M,K as U,L as J,o as N,n as P}from"./DWysiwyg-a2525844.js";import"./vue.esm-bundler-a99e1ba3.js";import"./floating-ui.dom-c3a31ea6.js";import"./_commonjsHelpers-042e6b4d.js";const Y={title:"Forms/Checkbox Card",component:a,tags:["autodocs"],argTypes:{}},H=e=>({components:{DCheckboxCard:a,CardIcon:n},data:()=>({value:!1}),setup(){return{args:e}},template:`
  ...
  `}),o=H.bind({});o.args={heading:"Card",description:"Add your debit / credit card information",label:"Select card option"};const V=e=>({components:{DCheckboxCard:a,CardIcon:n},data:()=>({value:!1}),setup(){return{args:e}},template:`
    ...
    <p>Checkbox value is: {{value}}</p>
  `}),t=V.bind({});t.args={heading:"Card",description:"Add your debit / credit card information"};const c=H.bind({});c.args={heading:"Card",description:"Add your debit / credit card information"};const $=e=>({components:{DCheckboxCard:a,CardIcon:n,BankIcon:w,DAutoLayout:M},data:()=>({values:[]}),setup(){return{args:e}},template:`
  ...
  `}),l=$.bind({}),K=e=>({components:{DCheckboxCard:a},data:()=>({value:""}),setup(){return{args:e}},template:`
    <d-checkbox-card v-model="value" value="value" v-bind="args">
    </d-checkbox-card>
    <p>Checkbox value is: {{value}}</p>
  `}),r=K.bind({});r.args={heading:"One time payment",description:"Use this option to collect a one off payment"};const j=e=>({components:{DCheckboxCard:a,DFilePicker:U,CardIcon:n},data:()=>({value:""}),setup(){return{args:e}},template:`
    <d-checkbox-card v-model="value" value="value" v-bind="args">
      <template #icon>
        <card-icon />
      </template>
  ...
  template: \`
    ...
    <p>Checkbox value is: {{value}}</p>
  \`
})`,...(F=(E=s.parameters)==null?void 0:E.docs)==null?void 0:F.source}}};var W,B,L;i.parameters={...i.parameters,docs:{...(W=i.parameters)==null?void 0:W.docs,source:{originalSource:`args => ({
  components: {
    DCheckboxCard,
    CardIcon,
    DHeading,
  ...
  <p>Checkbox value is: {{value}}</p>
  \`
})`,...(L=(B=i.parameters)==null?void 0:B.docs)==null?void 0:L.source}}};const Z=["WithLabel","TrueOrFalseCheckbox","CheckboxWithValue","CheckboxArray","NoIcon","ExpandMode","ExpandModeWithoutIcon","CustomHeadingAndDescription"];export{l as CheckboxArray,c as CheckboxWithValue,i as CustomHeadingAndDescription,d as ExpandMode,s as ExpandModeWithoutIcon,r as NoIcon,t as TrueOrFalseCheckbox,o as WithLabel,Z as __namedExportsOrder,Y as default};
//# sourceMappingURL=DCheckboxCard.stories-bfe994db.js.map
