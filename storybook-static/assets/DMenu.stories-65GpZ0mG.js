import{a4 as f,d as k}from"./DAccordion-wg4yIoXK.js";import"./vue.esm-bundler-CUqwZzoc.js";import"./iframe-CqJBfuYe.js";import"../sb-preview/runtime.js";import"./_commonjsHelpers-BosuxZz1.js";const T={title:"Menu (Context or Dropdown menu)",component:f,tags:["autodocs"],argTypes:{}},i=n=>({components:{DMenu:f,DButton:k},data:()=>({}),methods:{consoleOption:function(B){}},setup(){return{args:n}},template:`<d-menu v-bind="args" @option-clicked="(option) => consoleOption(option, item)">
  <d-button>...</d-button>
...
})`,...(h=(v=s.parameters)==null?void 0:v.docs)==null?void 0:h.source}}};const w=["Default","StringOptions","CustomOptionColor","DisabledOption","HoverTrigger"];export{e as CustomOptionColor,t as Default,r as DisabledOption,s as HoverTrigger,o as StringOptions,w as __namedExportsOrder,T as default};
