import{au as c,h as P,_ as A}from"./DWysiwyg-6ecd24aa.js";import"./vue.esm-bundler-77038495.js";import"./_commonjsHelpers-042e6b4d.js";import"./floating-ui.dom-c3a31ea6.js";const z={title:"Forms/Checkbox",component:c,tags:["autodocs"],argTypes:{wrapperClass:{control:{type:"text"}},disabled:{control:{type:"boolean"}},alignToTop:{control:{type:"boolean"}},dashed:{control:{type:"boolean"}},label:{control:{type:"text"}},labelClass:{control:{type:"text"}},top:{control:{type:"boolean"}},alignRight:{control:{type:"boolean"}}}},l=e=>({components:{DCheckbox:c},data:()=>({value:!1}),setup:function(){return{args:e}},template:'<d-checkbox v-bind="args" v-model="value" />'}),L=e=>({components:{DCheckbox:c,DarkModeProvider:A},data:()=>({value:!1}),setup(){return{args:e}},template:`
  ...
  \`
})`,...(I=(F=d.parameters)==null?void 0:F.docs)==null?void 0:I.source}}};const G=["Default","DarkDefault","Dashed","DarkDashed","Disabled","DarkDisabled","Multiple"];export{r as DarkDashed,o as DarkDefault,n as DarkDisabled,t as Dashed,a as Default,s as Disabled,d as Multiple,G as __namedExportsOrder,z as default};
//# sourceMappingURL=DCheckbox.stories-ddbbeeb4.js.map
