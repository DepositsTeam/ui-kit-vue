import{x as l,y as A,_ as R}from"./DAccordion-15ab541e.js";import"./vue.esm-bundler-90c41ac5.js";import"./_commonjsHelpers-87174ba5.js";const J={title:"Forms/Dropdown",component:l,argTypes:{label:{control:{type:"text"}},placeholder:{control:{type:"text"}},disabled:{control:{type:"boolean"}},dropDown:{control:{type:"boolean"}},size:{control:{type:"select"},options:["small","medium","large","xlarge","huge","massive"]},errorMessage:{control:{type:"text"}},rightIcon:{control:{type:"object"}},leftIcon:{control:{type:"object"}},onlyNumbers:{control:{type:"boolean"}},wrapperClass:{control:{type:"text"}},fontFace:{control:{type:"select"},options:["circularSTD","heroNew"]},options:{control:{type:"object"}}}},m=e=>({components:{DDropdown:l,ThemeProvider:A},data:()=>({value:""}),setup(){return{args:e}},template:`
  ...
  `}),E=e=>({components:{DDropdown:l,DarkModeProvider:R},data:()=>({value:"identity"}),setup(){return{args:e}},template:`
    ...
    `}),$=e=>({components:{DDropdown:l,DarkModeProvider:R},data:()=>({value:""}),setup(){return{args:e}},template:`
    <dark-mode-provider :dark-mode="true">
      <d-dropdown v-bind="args" v-model="value" />
    </dark-mode-provider>
