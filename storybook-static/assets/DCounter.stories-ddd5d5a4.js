import{t as o,_ as g}from"./DAccordion-ecca0b56.js";import"./vue.esm-bundler-b2140274.js";import"./_commonjsHelpers-87174ba5.js";const M={title:"Forms/Counter",component:o,argTypes:{}},v=a=>({components:{DCounter:o},data:()=>({value:""}),setup(){return{args:a}},template:'<d-counter v-model="value" v-bind="args"></d-counter>'}),D=a=>({components:{DCounter:o,DarkModeProvider:g},data:()=>({value:""}),setup(){return{args:a}},template:`
...
//# sourceMappingURL=DCounter.stories-ddd5d5a4.js.map
