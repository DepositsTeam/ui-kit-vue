import{a1 as m,F as R,a2 as V,_ as N}from"./DAccordion-ab2571d1.js";import"./vue.esm-bundler-02a62393.js";import"./_commonjsHelpers-87174ba5.js";const ne={title:"Forms/Tag Dropdown",component:m,argTypes:{...R,placeholder:{control:{type:"text"}},showCheckboxes:{control:{type:"boolean"}},options:{control:{type:"object"}}}},g=e=>({components:{DTagDropdown:m},data:()=>({value:[]}),setup(){return{args:e}},template:'<d-tag-dropdown v-model="value" v-bind="args" />'}),v=e=>({components:{DTagDropdown:m},data:()=>({value:["banking","money"]}),setup(){return{args:e}},template:`
...
//# sourceMappingURL=DTagDropdown.stories-e8a72ab4.js.map
