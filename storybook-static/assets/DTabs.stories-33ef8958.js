import{B as D,a as ye,D as We,C as ke,E as _e,i as Ae}from"./WalletOutlineIcon-52115379.js";import"./vue.esm-bundler-d57a814c.js";import"./floating-ui.dom-c3a31ea6.js";import"./_commonjsHelpers-87174ba5.js";const Pe={title:"Tabs",component:D,tags:["autodocs"],argTypes:{tabs:{control:{type:"object"}},horizontal:{control:{type:"boolean"}},spacing:{control:{type:"text"}},initiallyActive:{control:{type:"text"}},inline:{control:{type:"boolean"}},scheme:{control:{type:"select"},options:["button","underline","inline","underline_card"]}}},e=t=>({components:{DTabs:D},setup(){return{args:t}},template:'<d-tabs v-bind="args" />'}),Fe=t=>({components:{DTabs:D,DarkModeProvider:Ae},setup(){return{args:t}},template:`
  ...
  template: \`
    ...
    <d-text>Active Tab Index: {{activeTabIndex}}</d-text>
  \`
})`,...(M=(w=v.parameters)==null?void 0:w.docs)==null?void 0:M.source}}};var E,j,z;s.parameters={...s.parameters,docs:{...(E=s.parameters)==null?void 0:E.docs,source:{originalSource:`args => ({
  components: {
    DTabs
  },
  setup() {
  ...
  template: \`<d-tabs v-bind="args" />\`
})`,...(z=(j=s.parameters)==null?void 0:j.docs)==null?void 0:z.source}}};var O,P,$;o.parameters={...o.parameters,docs:{...(O=o.parameters)==null?void 0:O.docs,source:{originalSource:`args => ({
  components: {
    DTabs
  },
  setup() {
...
//# sourceMappingURL=DTabs.stories-33ef8958.js.map
