import{Z as p,R as q,p as G,_ as Z}from"./DAccordion-a3e21a48.js";import{s as J}from"./selectProps-2e81a4d1.js";import"./vue.esm-bundler-e81cbe33.js";import"./iframe-003e986f.js";import"../sb-preview/runtime.js";import"./_commonjsHelpers-87174ba5.js";const ne={title:"Forms/Dropdown",component:p,tags:["autodocs"],argTypes:{...q,...J}},l=e=>({components:{DDropdown:p,ThemeProvider:G},data:()=>({value:""}),setup(){return{args:e}},template:`
  ...
  `}),K=e=>({components:{DDropdown:p,DarkModeProvider:Z},data:()=>({value:"identity"}),setup(){return{args:e}},template:`
    <dark-mode-provider :dark-mode="true">
      <d-dropdown v-bind="args" v-model="value" />
    </dark-mode-provider>
    `}),N=e=>({components:{DDropdown:p,DarkModeProvider:Z},data:()=>({value:""}),setup(){return{args:e}},template:`
    <dark-mode-provider :dark-mode="true">
      <d-dropdown v-bind="args" v-model="value" />
    </dark-mode-provider>
    `}),c=(e=null)=>{const v=e?e.bind({}):N.bind({});return v.decorators=[()=>({template:'<div style="padding: 3em; background: #121A26;"><story /></div>'})],v},n=[{text:"Banking kit",value:"banking"},{text:"Money kit",value:"money"},{text:"Identity kit",value:"identity"},{text:"UI kit",value:"ui"},{text:"Commerce kit",value:"commerce"}],t=l.bind({});t.args={options:[...n]};const r=l.bind({});r.args={options:[...n],errorMessage:"Error Message"};const a=l.bind({});a.args={options:["Banking kit","Money kit","Identity kit","UI kit","Commerce kit"]};const o=c();o.args={options:[...n]};const i=l.bind({});i.args={options:[...n],label:"Dropdown"};const d=c();d.args={options:[...n],label:"Dropdown"};const s=$.bind({});s.args={label:"Predefined Dropdown",options:[...n]};const m=$.bind({});m.args={label:"Predefined Dropdown",options:[...n],returnFullObject:!0};const u=c(K);u.args={label:"Predefined Dropdown",options:[...n]};var k,g,y;t.parameters={...t.parameters,docs:{...(k=t.parameters)==null?void 0:k.docs,source:{originalSource:`args => ({
  components: {
    DDropdown,
    ThemeProvider
  },
  ...
  template: \`
    ...
    <p>Selected value is: {{value}}</p>
  \`
})`,...(j=(L=m.parameters)==null?void 0:L.docs)==null?void 0:j.source}}};var A,R,H;u.parameters={...u.parameters,docs:{...(A=u.parameters)==null?void 0:A.docs,source:{originalSource:"DarkModeTemplateFactory(DarkModePredefinedTemplate)",...(H=(R=u.parameters)==null?void 0:R.docs)==null?void 0:H.source}}};const te=["Default","HasError","TextOptions","DefaultDark","Label","LabelDark","Predefined","PredefinedReturnFullObject","PredefinedDark"];export{t as Default,o as DefaultDark,r as HasError,i as Label,d as LabelDark,s as Predefined,u as PredefinedDark,m as PredefinedReturnFullObject,a as TextOptions,te as __namedExportsOrder,ne as default};
