import{A as l,b as X,e as Z,m as ee,c as re}from"./DTooltip-ca5caf4e.js";import"./vue.esm-bundler-673e2372.js";import"./floating-ui.dom-c3a31ea6.js";import"./_commonjsHelpers-042e6b4d.js";const me={component:l,title:"Stepper",argTypes:{steps:{control:{type:"object"}},currentStep:{control:{type:"number"}},scheme:{control:{type:"select"},options:["variant-1","variant-2"]},activeColor:{control:{type:"color"}},stepMode:{control:{type:"boolean"}}}},r=e=>({components:{DStepper:l},setup(){return{args:e}},template:'<d-stepper v-bind="args" />'}),te=e=>({components:{DStepper:l,DarkModeProvider:re},setup(){return{args:e}},template:`<dark-mode-provider :dark-mode="true">
  ...
  template: \`<d-stepper v-bind="args" />\`
})`,...(k=(M=a.parameters)==null?void 0:M.docs)==null?void 0:k.source}}};var B,A,h;o.parameters={...o.parameters,docs:{...(B=o.parameters)==null?void 0:B.docs,source:{originalSource:`args => ({
  components: {
    DStepper
  },
  setup() {
  ...
  template: \`<d-stepper v-bind="args" />\`
})`,...(h=(A=o.parameters)==null?void 0:A.docs)==null?void 0:h.source}}};var K,T,Y;p.parameters={...p.parameters,docs:{...(K=p.parameters)==null?void 0:K.docs,source:{originalSource:`args => ({
  components: {
    DStepper
  },
  setup() {
...
//# sourceMappingURL=DStepper.stories-d161ea91.js.map
