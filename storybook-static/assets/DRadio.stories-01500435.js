import{Y as s,v as x,_ as M}from"./DWysiwyg-d71235a5.js";import"./vue.esm-bundler-64d654d1.js";import"./floating-ui.dom-c3a31ea6.js";import"./_commonjsHelpers-87174ba5.js";const Y={title:"Forms/Radio",component:s,argTypes:{ringed:{control:{type:"boolean"}},alignToTop:{control:{type:"boolean"}},label:{control:{type:"text"}},value:{control:{type:"text"}},disabled:{control:{type:"boolean"}},alignRight:{control:{type:"boolean"}},ringSize:{control:{type:"text"},default:"16px"},ringThickness:{control:{type:"text"},default:"5px"}}},R=e=>({components:{DRadio:s},setup:function(){return{args:e}},template:'<d-radio v-bind="args" />'}),S=e=>({components:{DRadio:s,DarkModeProvider:M},data:()=>({value:""}),setup(){return{args:e}},template:`
  ...
  template: \`<d-radio v-bind="args" />\`
})`,...(k=(g=r.parameters)==null?void 0:g.docs)==null?void 0:k.source}}};var b,y,v;t.parameters={...t.parameters,docs:{...(b=t.parameters)==null?void 0:b.docs,source:{originalSource:"DarkModeTemplateFactory()",...(v=(y=t.parameters)==null?void 0:y.docs)==null?void 0:v.source}}};var D,f,h;n.parameters={...n.parameters,docs:{...(D=n.parameters)==null?void 0:D.docs,source:{originalSource:`args => ({
  components: {
    DRadio,
    DAutoLayout
  },
  ...
  template: \`
    ...
    \`
})`,...(h=(f=n.parameters)==null?void 0:f.docs)==null?void 0:h.source}}};const L=["Default","DarkDefault","Ringed","DarkRinged","Multiple"];export{o as DarkDefault,t as DarkRinged,a as Default,n as Multiple,r as Ringed,L as __namedExportsOrder,Y as default};
//# sourceMappingURL=DRadio.stories-01500435.js.map
