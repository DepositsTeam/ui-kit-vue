import { aw as g } from "./DAccordion-DdDUMQ09.js";
...
const M = {
    ...
    tags: ["autodocs"],
    argTypes: { timeline: { control: { type: "object" } } },
  },
  o = (v) => ({
    components: { DTransactionTimeline: g },
    setup() {
      return { args: v };
    },
...
r.parameters = {
  ...
  template: \`<d-transaction-timeline v-bind="args" />\`
      ...
      ...((l = (u = r.parameters) == null ? void 0 : u.docs) == null
        ? void 0
        : l.source),
    },
  },
...
s.parameters = {
  ...
  template: \`<d-transaction-timeline v-bind="args" />\`
      ...
      ...((f = (b = s.parameters) == null ? void 0 : b.docs) == null
        ? void 0
        : f.source),
    },
  },
};
const T = ["Active", "Successful", "Failed", "Pending"];
export {
  e as Active,
  r as Failed,
  s as Pending,
