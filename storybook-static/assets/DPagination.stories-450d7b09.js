import{a7 as c,h as f}from"./DVerticalMovable-256bb483.js";import"./vue.esm-bundler-aecd4be6.js";import"./_commonjsHelpers-042e6b4d.js";import"./floating-ui.dom-c3a31ea6.js";const F={title:"Pagination",component:c,tags:["autodocs"],argTypes:{totalPages:{control:{type:"number"}},currentPage:{control:{type:"number"}},currentPageSiblings:{control:{type:"number"}},smartColor:{control:{type:"color"}}}},s=e=>({components:{DPagination:c},setup(){return{args:e}},template:'<d-pagination v-bind="args" />'}),h=e=>({components:{DPagination:c,DarkModeProvider:f},methods:{console:function(k){console.log("Page changed to: ",k)}},setup(){return{args:e}},template:`
    <dark-mode-provider :dark-mode="true">
      <d-pagination @page-changed="console" v-bind="args" />
    </dark-mode-provider>
    `}),O=()=>{const e=h.bind({});return e.decorators=[()=>({template:'<div style="padding: 3em; background: #121A26;"><story /></div>'})],e},t=s.bind({}),o=O(),n=s.bind({});n.args={hidePages:!0,asyncPrevNext:!0};const r=s.bind({});r.args={hidePages:!0,asyncPrevNext:!0,prevDisabled:!0};const a=s.bind({});a.args={hidePages:!0,asyncPrevNext:!0,nextDisabled:!0};var d,i,p;t.parameters={...t.parameters,docs:{...(d=t.parameters)==null?void 0:d.docs,source:{originalSource:`args => ({
  components: {
    DPagination
  },
  setup() {
...
//# sourceMappingURL=DPagination.stories-450d7b09.js.map
