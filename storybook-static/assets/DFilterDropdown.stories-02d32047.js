import{x as s}from"./DVerticalMovable-b7d344e7.js";import"./vue.esm-bundler-c1de2c1e.js";import"./iframe-011ae96e.js";import"../sb-preview/runtime.js";import"./_commonjsHelpers-042e6b4d.js";import"./floating-ui.dom-c3a31ea6.js";const k={title:"Forms/Filter Dropdown",component:s,tags:["autodocs"],argTypes:{}},_=e=>({components:{DFilterDropdown:s},data:()=>({value:""}),setup(){return{args:e}},template:'<d-filter-dropdown v-model="value" v-bind="args" />'}),t=_.bind({});t.args={options:[{text:"All Time",value:"all_time"},{text:"Today",value:"today"},{text:"This month",value:"this_month"}]};const d=e=>({components:{DFilterDropdown:s},setup(){return{args:e}},data:()=>({value:""}),template:`
...
//# sourceMappingURL=DFilterDropdown.stories-02d32047.js.map
