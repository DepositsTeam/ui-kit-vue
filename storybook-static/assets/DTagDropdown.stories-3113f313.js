import{Q as g,R as ne,S as oe,_ as ae}from"./DWysiwyg-c45d111f.js";import"./vue.esm-bundler-41d8d808.js";import"./floating-ui.dom-c3a31ea6.js";import"./_commonjsHelpers-042e6b4d.js";const ce={title:"Forms/Tag Dropdown",component:g,tags:["autodocs"],argTypes:{...ne,placeholder:{control:{type:"text"}},showCheckboxes:{control:{type:"boolean"}},options:{control:{type:"object"}}}},v=e=>({components:{DTagDropdown:g},data:()=>({value:[]}),setup(){return{args:e}},template:'<d-tag-dropdown v-model="value" v-bind="args" />'}),D=e=>({components:{DTagDropdown:g},data:()=>({value:["banking","money"]}),setup(){return{args:e}},template:`
  ...
  template: \`
    ...
    <p>Selected value is {{value}}</p>
  \`
})`,...(R=(Q=i.parameters)==null?void 0:Q.docs)==null?void 0:R.source}}};var $,q,z;l.parameters={...l.parameters,docs:{...($=l.parameters)==null?void 0:$.docs,source:{originalSource:`args => ({
  components: {
    DTagDropdown
  },
  data: () => ({
  ...
  template: \`
    ...
    <p>Selected value is {{value}}</p>
  \`
})`,...(z=(q=l.parameters)==null?void 0:q.docs)==null?void 0:z.source}}};var G,J,K;c.parameters={...c.parameters,docs:{...(G=c.parameters)==null?void 0:G.docs,source:{originalSource:"DarkModeTemplateFactory(DarkModePredefinedTemplate)",...(K=(J=c.parameters)==null?void 0:J.docs)==null?void 0:K.source}}};var N,V,X;m.parameters={...m.parameters,docs:{...(N=m.parameters)==null?void 0:N.docs,source:{originalSource:`args => ({
  components: {
    DTagDropdown
  },
  data: () => ({
...
//# sourceMappingURL=DTagDropdown.stories-3113f313.js.map
