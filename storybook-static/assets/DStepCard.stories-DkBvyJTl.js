import { am as r } from "./DAccordion-DdDUMQ09.js";
...
const m = {
    ...
    argTypes: {
      ...
      lists: { control: { type: "object" } },
    },
  },
  n = (s) => ({
    components: { DStepCard: r },
    setup() {
      return { args: s };
    },
    template: `
...
t.args = {
  ...
  lists: [
    { text: "Complete account creation", active: !1, done: !0 },
    { text: "Complete basic KYB", active: !1, done: !0 },
    { text: "Select your program use case", active: !0, done: !1 },
    { text: "Configure your fintech program", active: !1, done: !1 },
    { text: "Launch your program", active: !1, done: !1 },
  ],
};
var e, o, a;
t.parameters = {
...
const d = ["Default"];
export { t as Default, d as __namedExportsOrder, m as default };
