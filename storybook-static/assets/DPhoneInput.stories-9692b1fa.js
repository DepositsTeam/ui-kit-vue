import{a3 as c,n as j,h as q}from"./DVerticalMovable-346dfdf9.js";import"./vue.esm-bundler-c1de2c1e.js";import"./_commonjsHelpers-042e6b4d.js";import"./floating-ui.dom-c3a31ea6.js";const R={title:"Forms/Phone Field",component:c,tags:["autodocs"],argTypes:{...j,size:{control:{type:"select"},options:["small","medium","large","xlarge","huge","massive"]},disabled:{control:{type:"boolean"}},errorMessage:{control:{type:"text"}},code:{control:{type:"text"}},phoneNumber:{control:{type:"boolean"}}}},m=e=>({components:{DPhoneInput:c},data:()=>({code:"",number:""}),setup(){return{args:e}},template:'<d-phone-input v-bind="args" v-model:code.lazy="code" v-model:phone-number="number"  />'}),w=e=>({components:{DPhoneInput:c},data:()=>({code:"",number:"+13332392383"}),setup(){return{args:e}},template:'<d-phone-input v-bind="args" v-model:code.lazy="code" v-model:phone-number="number"  />'}),r=w.bind({});r.args={isUs:!0};const C=e=>({components:{DPhoneInput:c,DarkModeProvider:q},data:()=>({code:"",number:""}),setup(){return{args:e}},template:`
...
//# sourceMappingURL=DPhoneInput.stories-9692b1fa.js.map
