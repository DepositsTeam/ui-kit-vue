import{a as f,b as s,c as i,d as l,e as d,f as a,g as o,h as b}from"./DWysiwyg-ceedb84c.js";import"./vue.esm-bundler-41d8d808.js";import"./floating-ui.dom-c3a31ea6.js";import"./_commonjsHelpers-042e6b4d.js";const _={components:{DQuickTool:f},title:"Vertical Movable",component:s,argTypes:{list:{control:{type:"object"}}}},g=t=>({components:{DVerticalMovable:s},data:()=>({list:[{id:1,title:"Send money",icon:i,isAdded:!1},{id:2,title:"New invoice",icon:l,isAdded:!1},{id:3,title:"New payment page",icon:d,isAdded:!1},{id:4,title:"Add customer",icon:a,isAdded:!1},{id:5,title:"Link bank / card",icon:o,isAdded:!1}]}),watch:{list:function(A){console.log("New value is",A)}},setup(){return{args:t}},template:`
      <d-vertical-movable v-bind="args" v-model="list"/>`}),e=g.bind({}),w=t=>({setup(){return{args:t}},data:()=>({list:[{id:1,title:"Send money",icon:i,isAdded:!1},{id:2,title:"New invoice",icon:l,isAdded:!1},{id:3,title:"New payment page",icon:d,isAdded:!1},{id:4,title:"Add customer",icon:a,isAdded:!1},{id:5,title:"Link bank / card",icon:o,isAdded:!1}],secondList:[{id:6,title:"New subscription plan",icon:i,isAdded:!1},{id:7,title:"Pay a bill",icon:l,isAdded:!1},{id:8,title:"Create new card",icon:d,isAdded:!1},{id:9,title:"Create new account",icon:a,isAdded:!1},{id:10,title:"Invite new team member",icon:o,isAdded:!1}]}),components:{DVerticalMovable:s,DAutoLayout:b,DQuickTool:f},template:`
...
//# sourceMappingURL=DVerticalMovable.stories-d6934b96.js.map
