import{d as G,Q as K,e as p,u as m,o as R,x as v,f as X}from"./vue.esm-bundler-64d654d1.js";import{ao as Y,ap as Z,aq as ee,ar as ae,u as o,v as ne,w as H,x as L,y as oe,b as te,c as ce}from"./DWysiwyg-01175861.js";import"./floating-ui.dom-c3a31ea6.js";import"./_commonjsHelpers-87174ba5.js";const P={__name:"DCheckboxCard",props:{...Y,checked:{type:Boolean,default:null},value:{type:[String,Number],default:""},modelValue:{default:!1},trueValue:{default:!0},falseValue:{default:!1},values:{type:Array,default:()=>[]},dashed:{type:Boolean},disabled:{type:Boolean}},emits:["update:modelValue"],setup(e,{emit:j}){const q=e,{isChecked:b,triggerChange:z}=Z(q,j),Q=()=>{z()};return(a,pe)=>(R(),G(ee,{heading:a.heading,description:a.description,expandable:a.expandable,label:a.label,"label-class":a.labelClass,"label-font-face":a.labelFontFace,"expand-on-checked":a.expandOnChecked,"is-checked":m(b),onClicked:Q},K({selector:p(()=>[X(m(ae),{dashed:e.dashed,size:"18px",checked:m(b)},null,8,["dashed","checked"])]),default:p(()=>[v(a.$slots,"default")]),_:2},[a.$slots.icon?{name:"icon",fn:p(()=>[v(a.$slots,"icon")]),key:"0"}:void 0]),1032,["heading","description","expandable","label","label-class","label-font-face","expand-on-checked","is-checked"]))}},n=P;P.__docgenInfo={exportName:"default",displayName:"DCheckboxCard",description:"",tags:{},props:[{name:"checked",type:{name:"boolean"},defaultValue:{func:!1,value:"null"}},{name:"value",type:{name:"string|number"},defaultValue:{func:!1,value:'""'}},{name:"modelValue",type:{name:"boolean"},defaultValue:{func:!1,value:"false"}},{name:"trueValue",type:{name:"boolean"},defaultValue:{func:!1,value:"true"}},{name:"falseValue",type:{name:"boolean"},defaultValue:{func:!1,value:"false"}},{name:"values",type:{name:"array"},defaultValue:{func:!1,value:"[]"}},{name:"dashed",type:{name:"boolean"}},{name:"disabled",type:{name:"boolean"}}],events:[{name:"update:modelValue"}],slots:[{name:"default"},{name:"icon"}],sourceFiles:["/Users/ericmcwinner/Documents/Work/Projects/Work/Vue/deposits-ui-kit-vue/src/d-checkbox-card/DCheckboxCard.vue"]};const ke={title:"Forms/Checkbox Card",component:n,tags:["autodocs"],argTypes:{}},J=e=>({components:{DCheckboxCard:n,CardIcon:o},data:()=>({value:!1}),setup(){return{args:e}},template:`
  ...
  template: \`
    ...
    <p>Checkbox value is: {{value}}</p>
  \`
})`,...(F=(B=r.parameters)==null?void 0:B.docs)==null?void 0:F.source}}};var O,W,w;l.parameters={...l.parameters,docs:{...(O=l.parameters)==null?void 0:O.docs,source:{originalSource:`args => ({
  components: {
    DCheckboxCard,
    DFilePicker,
    CardIcon
  ...
  template: \`
    ...
    <p>Checkbox value is: {{value}}</p>
  \`
})`,...(w=(W=l.parameters)==null?void 0:W.docs)==null?void 0:w.source}}};var E,N,U;s.parameters={...s.parameters,docs:{...(E=s.parameters)==null?void 0:E.docs,source:{originalSource:`args => ({
  components: {
    DCheckboxCard,
    DFilePicker,
    CardIcon
  ...
  template: \`
    ...
    <p>Checkbox value is: {{value}}</p>
  \`
})`,...(U=(N=s.parameters)==null?void 0:N.docs)==null?void 0:U.source}}};var M,_,$;i.parameters={...i.parameters,docs:{...(M=i.parameters)==null?void 0:M.docs,source:{originalSource:`args => ({
  components: {
    DCheckboxCard,
    CardIcon,
    DHeading,
...
//# sourceMappingURL=DCheckboxCard.stories-a8a9e7d6.js.map
