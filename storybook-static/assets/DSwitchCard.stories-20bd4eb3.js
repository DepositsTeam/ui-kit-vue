import{O as a,P as n,Q as V,h as P,R as N,S as $,p as Q,n as R,U as j}from"./DWysiwyg-c244d28d.js";import"./vue.esm-bundler-a99e1ba3.js";import"./floating-ui.dom-c3a31ea6.js";import"./_commonjsHelpers-042e6b4d.js";const oe={title:"Forms/Switch Card",component:a,argTypes:{},tags:["autodocs"]},J=e=>({components:{DSwitchCard:a,CardIcon:n},data:()=>({value:!1}),setup(){return{args:e}},template:`
  ...
  template: \`
    ...
    <p>Checkbox value is: {{values}}</p>
  \`
})`,...(f=(y=p.parameters)==null?void 0:y.docs)==null?void 0:f.source}}};var D,S,I;c.parameters={...c.parameters,docs:{...(D=c.parameters)==null?void 0:D.docs,source:{originalSource:`args => ({
  components: {
    DSwitchCard
  },
  data: () => ({
...
//# sourceMappingURL=DSwitchCard.stories-20bd4eb3.js.map
