import{aw as dt,ax as f,a9 as gt}from"./DWysiwyg-27c4e042.js";import"./vue.esm-bundler-c483924c.js";import"./_commonjsHelpers-042e6b4d.js";import"./floating-ui.dom-c3a31ea6.js";const St={components:{HomeFilledIcon:dt},title:"Composite Button",component:f,tags:["autodocs"],argTypes:{size:{control:{type:"select"},options:["small","medium","large","xlarge","huge","massive"]},is:{control:{type:"select"},options:["button","a","span","div"]},colorScheme:{control:{type:"select"},options:["primary","danger","success","outline","invisible"]},loaderType:{control:{type:"select"},options:["text","ring","equalizer","ringed-circle"],table:{defaultValue:"text"}}}},t=n=>({components:{DCompositeButton:f},setup(){return{args:n}},methods:{leftButtonClick:function(){alert("Left button clicked!")},rightButtonClick:function(){alert("Right button clicked!")}},template:'<d-composite-button v-bind="args" @left-button-click="leftButtonClick" @right-button-click="rightButtonClick" />'}),kt=n=>({components:{DCompositeButton:f,ThemeProvider:gt},setup(){return{args:n}},methods:{leftButtonClick:function(){alert("Left button clicked!")},rightButtonClick:function(){alert("Right button clicked!")}},template:`
  ...
  template: \`<d-composite-button v-bind="args" @left-button-click="leftButtonClick" @right-button-click="rightButtonClick" />\`
})`,...(H=(_=r.parameters)==null?void 0:_.docs)==null?void 0:H.source}}};var M,W,w;i.parameters={...i.parameters,docs:{...(M=i.parameters)==null?void 0:M.docs,source:{originalSource:`args => ({
  components: {
    DCompositeButton
  },
  setup() {
  ...
  template: \`<d-composite-button v-bind="args" @left-button-click="leftButtonClick" @right-button-click="rightButtonClick" />\`
})`,...(w=(W=i.parameters)==null?void 0:W.docs)==null?void 0:w.source}}};var O,F,X;s.parameters={...s.parameters,docs:{...(O=s.parameters)==null?void 0:O.docs,source:{originalSource:`args => ({
  components: {
    DCompositeButton
  },
  setup() {
  ...
  template: \`<d-composite-button v-bind="args" @left-button-click="leftButtonClick" @right-button-click="rightButtonClick" />\`
})`,...(X=(F=s.parameters)==null?void 0:F.docs)==null?void 0:X.source}}};var q,E,V;l.parameters={...l.parameters,docs:{...(q=l.parameters)==null?void 0:q.docs,source:{originalSource:`args => ({
  components: {
    DCompositeButton
  },
  setup() {
...
//# sourceMappingURL=DCompositeButton.stories-f8070f7c.js.map
