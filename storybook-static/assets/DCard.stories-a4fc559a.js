import{v as M,ay as r,o as tr,O as or,_ as sr}from"./DWysiwyg-c5a5aa53.js";import"./vue.esm-bundler-a99e1ba3.js";import"./_commonjsHelpers-042e6b4d.js";import"./floating-ui.dom-c3a31ea6.js";const ur={title:"Card",tags:["autodocs"],component:M,argTypes:{title:{control:{type:"text"}},icon:{control:{type:"object"}},selected:{control:{type:"boolean"}},radio:{control:{type:"boolean"}},checkbox:{control:{type:"boolean"}},desc:{control:{type:"text"}},value:{control:{type:"text"}},ringSize:{control:{type:"text"},default:"16px"},ringThickness:{control:{type:"text"},default:"5px"}}},a=o=>({components:{DCard:M},data:()=>({selected:!1}),setup(){return{args:o}},template:'<d-card v-model="selected" value="something" v-bind="args" />'}),nr=o=>({components:{DCard:M,DarkModeProvider:sr},data:()=>({selected:!1}),setup(){return{args:o}},template:'<dark-mode-provider :dark-mode="true"><d-card value="something" v-model="selected" v-bind="args" /></dark-mode-provider>'}),e=(o=null)=>{const B=o?o.bind({}):nr.bind({});return B.decorators=[()=>({template:'<div style="padding: 3em; background: #121A26;"><story /></div>'})],B},cr=o=>({components:{DCard:M,DBox:tr,DHeading:or},data:()=>({selected:!1}),setup(){return{args:o}},template:`<d-card v-model="selected"  value="selected" v-bind="args">
...
})`,...(A=(_=x.parameters)==null?void 0:_.docs)==null?void 0:A.source}}};var E,L,O;v.parameters={...v.parameters,docs:{...(E=v.parameters)==null?void 0:E.docs,source:{originalSource:"DarkModeTemplateFactory()",...(O=(L=v.parameters)==null?void 0:L.docs)==null?void 0:O.source}}};var P,$,j;f.parameters={...f.parameters,docs:{...(P=f.parameters)==null?void 0:P.docs,source:{originalSource:`args => ({
  components: {
    DCard
  },
  data: () => ({
  ...
  template: \`<d-card v-model="selected" value="something" v-bind="args" />\`
})`,...(Ae=(_e=u.parameters)==null?void 0:_e.docs)==null?void 0:Ae.source}}};var Ee,Le,Oe;g.parameters={...g.parameters,docs:{...(Ee=g.parameters)==null?void 0:Ee.docs,source:{originalSource:"DarkModeTemplateFactory()",...(Oe=(Le=g.parameters)==null?void 0:Le.docs)==null?void 0:Oe.source}}};var Pe,$e,je;D.parameters={...D.parameters,docs:{...(Pe=D.parameters)==null?void 0:Pe.docs,source:{originalSource:`args => ({
  components: {
    DCard
  },
  data: () => ({
...
//# sourceMappingURL=DCard.stories-a4fc559a.js.map
