import{av as i,$ as f,Z as B,Y as k,p as D}from"./DWysiwyg-df288270.js";import"./vue.esm-bundler-2d9db5c2.js";import"./iframe-f2f86901.js";import"../sb-preview/runtime.js";import"./_commonjsHelpers-042e6b4d.js";import"./floating-ui.dom-c3a31ea6.js";const T={title:"Card 3",component:i,argTypes:{title:{control:{type:"text"}},subtitle:{control:{type:"text"}},description:{control:{type:"text"}},image:{control:{type:"text"}},topBgColor:{control:{type:"color"}},bottomBgColor:{control:{type:"color"}},imageBgColor:{control:{type:"color"}}}},v=r=>({components:{DCard3:i,DCol:f,DRow:B,DResponsiveLayout:k,DBox:D},setup(){return{args:r}},template:`
      <d-responsive-layout>
        <d-row>
...
//# sourceMappingURL=DCard3.stories-d6f2ee65.js.map
