...
const S = {
    ...
    argTypes: {
      ...
      topBgColor: { control: { type: "color" } },
      bottomBgColor: { control: { type: "color" } },
      imageBgColor: { control: { type: "color" } },
    },
  },
  v = (r) => ({
    components: { DCard3: i, DCol: f, DRow: B, DResponsiveLayout: k, DBox: _ },
    setup() {
      return { args: r };
    },
    template: `
...
e.parameters = {
  ...
  docs: {
    ...
    source: {
      originalSource: "CardListTemplate.bind([])",
      ...((d = (n = e.parameters) == null ? void 0 : n.docs) == null
        ? void 0
        : d.source),
    },
  },
...
t.parameters = {
  ...
  template: \`
    ...
    \`
      ...
      ...((u = (l = t.parameters) == null ? void 0 : l.docs) == null
        ? void 0
        : u.source),
    },
  },
...
export {
  o as DarkModeCardList,
  t as Default,
  e as LightModeCardList,
  s as WithBackgroundColors,
