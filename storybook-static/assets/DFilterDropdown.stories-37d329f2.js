import{a1 as s}from"./DAccordion-c00eb372.js";import"./vue.esm-bundler-e81cbe33.js";import"./iframe-f71edc5d.js";import"../sb-preview/runtime.js";import"./_commonjsHelpers-87174ba5.js";const E={title:"Forms/Filter Dropdown",component:s,tags:["autodocs"],argTypes:{}},_=e=>({components:{DFilterDropdown:s},data:()=>({value:""}),setup(){return{args:e}},template:'<d-filter-dropdown v-model="value" v-bind="args" />'}),t=_.bind({});t.args={options:[{text:"All Time",value:"all_time"},{text:"Today",value:"today"},{text:"This month",value:"this_month"}]};const d=e=>({components:{DFilterDropdown:s},setup(){return{args:e}},data:()=>({value:""}),template:`
