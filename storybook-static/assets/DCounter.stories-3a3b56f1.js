import{al as d,h as f}from"./DVerticalMovable-b7d344e7.js";import"./vue.esm-bundler-c1de2c1e.js";import"./iframe-011ae96e.js";import"../sb-preview/runtime.js";import"./_commonjsHelpers-042e6b4d.js";import"./floating-ui.dom-c3a31ea6.js";const h={title:"Forms/Counter",component:d,tags:["autodocs"],argTypes:{fontFace:{control:{type:"text"}},errorMessage:{control:{type:"text"}},name:{control:{type:"text"}},label:{control:{type:"text"}},labelFontFace:{control:{type:"text"}},labelClass:{control:{type:"text"}},placeholder:{control:{type:"text"}}}},o=s=>({components:{DCounter:d},data:()=>({value:""}),setup(){return{args:s}},template:'<d-counter v-model="value" v-bind="args"></d-counter>'}),I=s=>({components:{DCounter:d,DarkModeProvider:f},data:()=>({value:""}),setup(){return{args:s}},template:`
  ...
  template: \`<d-counter v-model="value" v-bind="args"></d-counter>\`
})`,...(M=(C=n.parameters)==null?void 0:C.docs)==null?void 0:M.source}}};const H=["Default","Label","HasError","DarkDefault","MaxIs10AndMinIs0"];export{t as DarkDefault,a as Default,r as HasError,e as Label,n as MaxIs10AndMinIs0,H as __namedExportsOrder,h as default};
//# sourceMappingURL=DCounter.stories-3a3b56f1.js.map
