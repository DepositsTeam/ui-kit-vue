var u=Object.defineProperty;var n=(o,t)=>u(o,"name",{value:t,configurable:!0});import{Z as s,$ as c,_ as d,g as p}from"./DAccordion-a261f9c8.js";import{v as i}from"./vue.esm-bundler-da4a8dbf.js";import"./iframe-b399bdf6.js";const m=n(()=>{const o=i("d__pushToast"),t=i("d__clearToasts");return{pushToast:n(l=>{if(o&&typeof o=="function")return o(l);throw Error("The `pushToast` function is not enabled. You probably omitted the ToastProvider.")},"pushToast"),clearToasts:n(()=>t(),"clearToasts")}},"useToast"),S={parameters:{storySource:{source:`import DToast from "./DToast.vue";
...
`,locationsMap:{default:{startLoc:{col:23,line:103},endLoc:{col:37,line:103},startBody:{col:23,line:103},endBody:{col:37,line:103}},"toast-with-description":{startLoc:{col:36,line:110},endLoc:{col:50,line:110},startBody:{col:36,line:110},endBody:{col:50,line:110}},"toast-with-only-description":{startLoc:{col:40,line:118},endLoc:{col:54,line:118},startBody:{col:40,line:118},endBody:{col:54,line:118}},"default-dark":{startLoc:{col:27,line:125},endLoc:{col:45,line:125},startBody:{col:27,line:125},endBody:{col:45,line:125}},"toast-with-description-dark":{startLoc:{col:40,line:132},endLoc:{col:58,line:132},startBody:{col:40,line:132},endBody:{col:58,line:132}},"toast-with-only-description-dark":{startLoc:{col:44,line:140},endLoc:{col:62,line:140},startBody:{col:44,line:140},endBody:{col:62,line:140}}}}},title:"Toast",component:s,argTypes:{autoClose:{control:{type:"text"}},position:{control:{type:"select"},options:["top-right","top-left","bottom-left","bottom-right"]},onClose:{control:{type:"function"}}}},T=n(o=>({components:{DToast:s,DButton:p},inject:["d__pushToast","d__clearToasts"],data:()=>({count:1}),setup(){const{pushToast:t,clearToasts:r}=m();return{args:o,pushToast:t,clearToasts:r}},methods:{pushToastFunction(){const t={...o};t.message+=this.count,this.pushToast(t),this.count+=1},clearToastsFunction(){this.clearToasts()}},template:`
  ...
  `}),"DarkModeTemplate"),a=n(()=>{const o=h.bind({});return o.decorators=[()=>({components:{ToastProvider:c,DarkModeProvider:d},template:`
        ...
        `})],o},"DarkToastWrapper"),D=e();D.args={colorScheme:"info",message:"I am a tooltip no ",autoClose:3};const f=e();f.args={colorScheme:"error",message:"I am a tooltip no ",autoClose:3,description:"I am a random one with a description"};const g=e();g.args={colorScheme:"success",autoClose:3,description:"I am a random one with a description"};const k=a();k.args={colorScheme:"info",message:"I am a tooltip no ",timeout:3};const y=a();y.args={colorScheme:"info",message:"I am a tooltip no ",timeout:3,description:"I am a random one with a description"};const v=a();v.args={colorScheme:"success",timeout:3,description:"I am a random one with a description"};const I=["Default","ToastWithDescription","ToastWithOnlyDescription","DefaultDark","ToastWithDescriptionDark","ToastWithOnlyDescriptionDark"];export{D as Default,k as DefaultDark,f as ToastWithDescription,y as ToastWithDescriptionDark,g as ToastWithOnlyDescription,v as ToastWithOnlyDescriptionDark,I as __namedExportsOrder,S as default};
//# sourceMappingURL=DToast.stories-c136e701.js.map
