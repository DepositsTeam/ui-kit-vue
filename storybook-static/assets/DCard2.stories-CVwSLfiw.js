import{u as a}from"./DAccordion-BVk4RD25.js";import"./vue.esm-bundler-CUqwZzoc.js";import"./iframe-DyUYSNBQ.js";import"../sb-preview/runtime.js";import"./_commonjsHelpers-BosuxZz1.js";const T={title:"Card 2",component:a,argTypes:{title:{control:{type:"text"}},description:{control:{type:"text"}},docLink:{control:{type:"text"}},demoLink:{control:{type:"text"}},icon:{control:{type:"text"}},checked:{control:{type:"boolean"}}}},p=s=>({components:{DCard2:a},setup(){return{args:s}},template:`
      <d-card2 v-bind="args"/>
