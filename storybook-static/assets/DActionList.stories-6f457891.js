import{aE as a,aF as T,z}from"./DWysiwyg-2b801905.js";import"./vue.esm-bundler-6f1630d7.js";import"./iframe-6b342987.js";import"../sb-preview/runtime.js";import"./_commonjsHelpers-042e6b4d.js";import"./floating-ui.dom-c3a31ea6.js";const W={title:"Action List",component:a,tags:["autodocs"],argTypes:{label:{control:{type:"text"}},list:{control:{type:"object"}},size:{control:{type:"select"},options:["small","medium","large","xlarge","huge","massive"]}}},r=l=>({components:{DActionList:a},setup(){return{args:l}},methods:{alertMessage(J){alert("Hello"),console.log(J)}},template:`
      <d-action-list @list-action-clicked="alertMessage" v-bind="args"/>`}),R=l=>({components:{DActionList:a,DActionListItem:T,DButton:z},setup(){return{args:l}},template:`
  ...
  template: \`
      <d-action-list @list-action-clicked="alertMessage" v-bind="args"/>\`
})`,...(P=(D=s.parameters)==null?void 0:D.docs)==null?void 0:P.source}}};const B=["Default","ActionListWithoutListProps","DifferentButtonColors","WithImage","WithDescription","WithDifferentButtonSizes"];export{e as ActionListWithoutListProps,t as Default,o as DifferentButtonColors,n as WithDescription,s as WithDifferentButtonSizes,i as WithImage,B as __namedExportsOrder,W as default};
//# sourceMappingURL=DActionList.stories-6f457891.js.map
