import{ap as i,U as f,S as B,R as k,n as D}from"./DWysiwyg-a2525844.js";import"./vue.esm-bundler-a99e1ba3.js";import"./floating-ui.dom-c3a31ea6.js";import"./_commonjsHelpers-042e6b4d.js";const S={title:"Card 3",component:i,argTypes:{title:{control:{type:"text"}},subtitle:{control:{type:"text"}},description:{control:{type:"text"}},image:{control:{type:"text"}},topBgColor:{control:{type:"color"}},bottomBgColor:{control:{type:"color"}},imageBgColor:{control:{type:"color"}}}},v=r=>({components:{DCard3:i,DCol:f,DRow:B,DResponsiveLayout:k,DBox:D},setup(){return{args:r}},template:`
      <d-responsive-layout>
        <d-row>
  ...
  template: \`
      <d-card3 v-bind="args"/>
    \`
})`,...(h=(b=s.parameters)==null?void 0:b.docs)==null?void 0:h.source}}};const x=["LightModeCardList","DarkModeCardList","Default","WithBackgroundColors"];export{o as DarkModeCardList,t as Default,e as LightModeCardList,s as WithBackgroundColors,x as __namedExportsOrder,S as default};
//# sourceMappingURL=DCard3.stories-a48ea8b6.js.map
