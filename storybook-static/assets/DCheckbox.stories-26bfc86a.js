import{au as d,i as I}from"./WalletOutlineIcon-52115379.js";import"./vue.esm-bundler-d57a814c.js";import"./floating-ui.dom-c3a31ea6.js";import"./_commonjsHelpers-87174ba5.js";const O={title:"Forms/Checkbox",component:d,tags:["autodocs"],argTypes:{wrapperClass:{control:{type:"text"}},disabled:{control:{type:"boolean"}},alignToTop:{control:{type:"boolean"}},dashed:{control:{type:"boolean"}},label:{control:{type:"text"}},labelClass:{control:{type:"text"}},top:{control:{type:"boolean"}},alignRight:{control:{type:"boolean"}}}},c=e=>({components:{DCheckbox:d},data:()=>({value:!1}),setup:function(){return{args:e}},template:'<d-checkbox v-bind="args" v-model="value" />'}),_=e=>({components:{DCheckbox:d,DarkModeProvider:I},data:()=>({value:!1}),setup(){return{args:e}},template:`
    <dark-mode-provider :dark-mode="true">
      <d-checkbox v-bind="args" v-model="value" />
    </dark-mode-provider>
    `}),l=()=>{const e=_.bind({});return e.decorators=[()=>({template:'<div style="padding: 3em; background: #121A26;"><story /></div>'})],e},a=c.bind({});a.args={label:"I agree to the terms and conditions"};const r=l();r.args={label:"I agree to the terms and conditions"};const o=c.bind({});o.args={label:"I agree to the terms and conditions",dashed:!0};const t=l();t.args={label:"I agree to the terms and conditions",dashed:!0};const s=c.bind({});s.args={label:"Disabled checkbox",disabled:!0};const n=l();n.args={label:"I agree to the terms and conditions",disabled:!0};var p,m,i;a.parameters={...a.parameters,docs:{...(p=a.parameters)==null?void 0:p.docs,source:{originalSource:`args => ({
  components: {
    DCheckbox
  },
  data: () => ({
  ...
  template: \`<d-checkbox v-bind="args" v-model="value" />\`
})`,...(C=(T=s.parameters)==null?void 0:T.docs)==null?void 0:C.source}}};var M,S,F;n.parameters={...n.parameters,docs:{...(M=n.parameters)==null?void 0:M.docs,source:{originalSource:"DarkModeTemplateFactory()",...(F=(S=n.parameters)==null?void 0:S.docs)==null?void 0:F.source}}};const P=["Default","DarkDefault","Dashed","DarkDashed","Disabled","DarkDisabled"];export{t as DarkDashed,r as DarkDefault,n as DarkDisabled,o as Dashed,a as Default,s as Disabled,P as __namedExportsOrder,O as default};
//# sourceMappingURL=DCheckbox.stories-26bfc86a.js.map
