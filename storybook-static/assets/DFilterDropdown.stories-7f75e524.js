import{L as s}from"./DVerticalMovable-2454bcb3.js";import"./vue.esm-bundler-c1de2c1e.js";import"./iframe-b809c49e.js";import"../sb-preview/runtime.js";import"./_commonjsHelpers-042e6b4d.js";import"./floating-ui.dom-c3a31ea6.js";const L={title:"Forms/Filter Dropdown",component:s,tags:["autodocs"],argTypes:{}},_=e=>({components:{DFilterDropdown:s},data:()=>({value:""}),setup(){return{args:e}},template:'<d-filter-dropdown v-model="value" v-bind="args" />'}),t=_.bind({});t.args={options:[{text:"All Time",value:"all_time"},{text:"Today",value:"today"},{text:"This month",value:"this_month"}]};const d=e=>({components:{DFilterDropdown:s},setup(){return{args:e}},data:()=>({value:""}),template:`
  ...
  template: \`
    ...
    <p>{{value}}</p>
  \`
})`,...(V=(D=l.parameters)==null?void 0:D.docs)==null?void 0:V.source}}};const k=["Default","ReturnFullObject","ReturnOnlyValue","PredefinedValueWithOnlyValue","PredefinedValueWithOnlyFullObject","CustomOptionTitleAndValue"];export{l as CustomOptionTitleAndValue,t as Default,o as PredefinedValueWithOnlyFullObject,r as PredefinedValueWithOnlyValue,n as ReturnFullObject,a as ReturnOnlyValue,k as __namedExportsOrder,L as default};
//# sourceMappingURL=DFilterDropdown.stories-7f75e524.js.map
