import{Y as e,l as B,I as s,K as E,L as U,o as H,h as L,n as O,J as W}from"./DWysiwyg-e75f37b2.js";import"./vue.esm-bundler-a99e1ba3.js";import"./_commonjsHelpers-042e6b4d.js";import"./floating-ui.dom-c3a31ea6.js";const q={title:"Forms/Radio Card",component:e,tags:["autodocs"],argTypes:{...B,value:{control:{type:"text"}},ringed:{control:{type:"boolean"}},ringSize:{control:{type:"text"}},ringThickness:{control:{type:"text"}}}},P=a=>({components:{DRadioCard:e,CardIcon:s},data:()=>({value:""}),setup(){return{args:a}},template:`<d-radio-card v-model="value" value="value" v-bind="args">
  ...
  template: \`
    ...
    <p>The selected value is {{value}}</p>
  \`
})`,...(A=(_=c.parameters)==null?void 0:_.docs)==null?void 0:A.source}}};const G=["Default","WithLabel","NoIcon","ExpandMode","ExpandModeWithoutIcon","CustomHeadingAndDescription","MultipleCards"];export{i as CustomHeadingAndDescription,n as Default,d as ExpandMode,r as ExpandModeWithoutIcon,c as MultipleCards,o as NoIcon,t as WithLabel,G as __namedExportsOrder,q as default};
//# sourceMappingURL=DRadioCard.stories-2c7c7fe6.js.map
