import{az as d,_ as F}from"./DWysiwyg-e35b52a3.js";import"./vue.esm-bundler-c483924c.js";import"./_commonjsHelpers-042e6b4d.js";import"./floating-ui.dom-c3a31ea6.js";const E={title:"Forms/Checkbox",component:d,tags:["autodocs"],argTypes:{wrapperClass:{control:{type:"text"}},disabled:{control:{type:"boolean"}},alignToTop:{control:{type:"boolean"}},dashed:{control:{type:"boolean"}},label:{control:{type:"text"}},labelClass:{control:{type:"text"}},top:{control:{type:"boolean"}},alignRight:{control:{type:"boolean"}}}},c=e=>({components:{DCheckbox:d},data:()=>({value:!1}),setup:function(){return{args:e}},template:'<d-checkbox v-bind="args" v-model="value" />'}),I=e=>({components:{DCheckbox:d,DarkModeProvider:F},data:()=>({value:!1}),setup(){return{args:e}},template:`
...
//# sourceMappingURL=DCheckbox.stories-74723d70.js.map
