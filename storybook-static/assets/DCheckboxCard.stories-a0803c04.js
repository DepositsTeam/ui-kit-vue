import{ay as a,I as n,J as w,h as M,K as U,L as J,n as N,j as P}from"./DWysiwyg-e35b52a3.js";import"./vue.esm-bundler-c483924c.js";import"./_commonjsHelpers-042e6b4d.js";import"./floating-ui.dom-c3a31ea6.js";const Y={title:"Forms/Checkbox Card",component:a,tags:["autodocs"],argTypes:{labelClass:{control:{type:"text"}},labelFontFace:{control:{type:"text"}},heading:{control:{type:"text"}},description:{control:{type:"text"}},label:{control:{type:"text"}},expandOnChecked:{control:{type:"text"}},expandable:{control:{type:"text"}}}},H=e=>({components:{DCheckboxCard:a,CardIcon:n},data:()=>({value:!1}),setup(){return{args:e}},template:`
  ...
  `}),t=H.bind({});t.args={heading:"Card",description:"Add your debit / credit card information",label:"Select card option"};const V=e=>({components:{DCheckboxCard:a,CardIcon:n},data:()=>({value:!1}),setup(){return{args:e}},template:`
    ...
    <p>Checkbox value is: {{value}}</p>
  `}),o=V.bind({});o.args={heading:"Card",description:"Add your debit / credit card information"};const c=H.bind({});c.args={heading:"Card",description:"Add your debit / credit card information"};const $=e=>({components:{DCheckboxCard:a,CardIcon:n,BankIcon:w,DAutoLayout:M},data:()=>({values:[]}),setup(){return{args:e}},template:`
  ...
  `}),i=$.bind({}),j=e=>({components:{DCheckboxCard:a},data:()=>({value:""}),setup(){return{args:e}},template:`
    <d-checkbox-card v-model="value" value="value" v-bind="args">
    </d-checkbox-card>
    <p>Checkbox value is: {{value}}</p>
  `}),r=j.bind({});r.args={heading:"One time payment",description:"Use this option to collect a one off payment"};const K=e=>({components:{DCheckboxCard:a,DFilePicker:U,CardIcon:n},data:()=>({value:""}),setup(){return{args:e}},template:`
    <d-checkbox-card v-model="value" value="value" v-bind="args">
      <template #icon>
        <card-icon />
      </template>
    ...
    <p>Checkbox value is: {{value}}</p>
  `}),d=K.bind({});d.args={heading:"One time payment",description:"Use this option to collect a one off payment",expandable:!0};const q=e=>({components:{DCheckboxCard:a,DFilePicker:U,CardIcon:n},data:()=>({value:""}),setup(){return{args:e}},template:`
    <d-checkbox-card v-model="value" value="value" v-bind="args">
      <d-file-picker />
    </d-checkbox-card>
    <p>Checkbox value is: {{value}}</p>
  ...
  template: \`
    ...
    <p>Checkbox value is: {{value}}</p>
  \`
})`,...(E=(_=s.parameters)==null?void 0:_.docs)==null?void 0:E.source}}};var W,B,L;l.parameters={...l.parameters,docs:{...(W=l.parameters)==null?void 0:W.docs,source:{originalSource:`args => ({
  components: {
    DCheckboxCard,
    CardIcon,
    DHeading,
  ...
  <p>Checkbox value is: {{value}}</p>
  \`
})`,...(L=(B=l.parameters)==null?void 0:B.docs)==null?void 0:L.source}}};const Z=["WithLabel","TrueOrFalseCheckbox","CheckboxWithValue","CheckboxArray","NoIcon","ExpandMode","ExpandModeWithoutIcon","CustomHeadingAndDescription"];export{i as CheckboxArray,c as CheckboxWithValue,l as CustomHeadingAndDescription,d as ExpandMode,s as ExpandModeWithoutIcon,r as NoIcon,o as TrueOrFalseCheckbox,t as WithLabel,Z as __namedExportsOrder,Y as default};
//# sourceMappingURL=DCheckboxCard.stories-a0803c04.js.map
