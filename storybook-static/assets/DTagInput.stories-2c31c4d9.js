import{$ as h,n as te,h as re}from"./DVerticalMovable-37a23178.js";import"./vue.esm-bundler-c1de2c1e.js";import"./_commonjsHelpers-042e6b4d.js";import"./floating-ui.dom-c3a31ea6.js";const ie={title:"Forms/Tag Input",component:h,tags:["autodocs"],argTypes:{...te,label:{control:{type:"text"}},size:{control:{type:"select"},options:["small","medium","large","xlarge","huge","massive"]},values:{control:{type:"object"},table:{defaultValue:["Option 1","Option 2","Option 3"]}},tagDelimiterKey:{control:{type:"select"},options:["enter","comma","space"],table:{defaultValue:"enter"}}}},n=o=>({components:{DTagInput:h},data:()=>({input:["Option one","Option 2","Option 3"]}),methods:{onTagAdded:function(e,a){console.log(e,a)},onTagChanged:function(e,a){console.log(e,a)},onTagDeleted:function(e,a){console.log(e,a)},onTextChanged:function(e){console.log(e)}},setup(){return{args:o}},template:'<d-tag-input @tag-added="onTagAdded" @text-changed="onTextChanged" @tag-deleted="onTagDeleted" @tag-changed="onTagChanged" v-model="input" v-bind="args" />'}),ge=o=>({components:{DTagInput:h,DarkModeProvider:re},data:()=>({input:["Option one","Option 2","Option 3"]}),methods:{onTagAdded:function(e,a){console.log(e,a)},onTagChanged:function(e,a){console.log(e,a)},onTagDeleted:function(e,a){console.log(e,a)},onTextChanged:function(e){console.log(e)}},setup(){return{args:o}},template:`
    ...
    `}),t=()=>{const o=ge.bind({});return o.decorators=[()=>({template:'<div style="padding: 3em; background: #121A26;"><story /></div>'})],o},r=n.bind({});r.args={label:"Form Label",size:"massive"};const g=n.bind({});g.args={label:"Form Label",size:"massive",errorMessage:"Random, default error"};const s=t();s.args={label:"Form Label",size:"massive"};const d=n.bind({});d.args={label:"Form Label",size:"huge"};const l=t();l.args={label:"Form Label",size:"huge"};const c=n.bind({});c.args={label:"Form Label",size:"xlarge"};const i=t();i.args={label:"Form Label",size:"xlarge"};const p=n.bind({});p.args={label:"Form Label",size:"large"};const u=t();u.args={label:"Form Label",size:"large"};const T=n.bind({});T.args={label:"Form Label",size:"medium"};const m=t();m.args={label:"Form Label",size:"medium"};const A=n.bind({});A.args={label:"Form Label",size:"small"};const y=t();y.args={label:"Form Label",size:"small"};var D,b,v;r.parameters={...r.parameters,docs:{...(D=r.parameters)==null?void 0:D.docs,source:{originalSource:`args => ({
  components: {
    DTagInput
  },
  data: () => ({
  ...
  template: \`<d-tag-input @tag-added="onTagAdded" @text-changed="onTextChanged" @tag-deleted="onTagDeleted" @tag-changed="onTagChanged" v-model="input" v-bind="args" />\`
})`,...(P=(K=p.parameters)==null?void 0:K.docs)==null?void 0:P.source}}};var R,$,q;u.parameters={...u.parameters,docs:{...(R=u.parameters)==null?void 0:R.docs,source:{originalSource:"DarkModeTemplateFactory()",...(q=($=u.parameters)==null?void 0:$.docs)==null?void 0:q.source}}};var G,J,N;T.parameters={...T.parameters,docs:{...(G=T.parameters)==null?void 0:G.docs,source:{originalSource:`args => ({
  components: {
    DTagInput
  },
  data: () => ({
  ...
  template: \`<d-tag-input @tag-added="onTagAdded" @text-changed="onTextChanged" @tag-deleted="onTagDeleted" @tag-changed="onTagChanged" v-model="input" v-bind="args" />\`
})`,...(N=(J=T.parameters)==null?void 0:J.docs)==null?void 0:N.source}}};var Q,U,W;m.parameters={...m.parameters,docs:{...(Q=m.parameters)==null?void 0:Q.docs,source:{originalSource:"DarkModeTemplateFactory()",...(W=(U=m.parameters)==null?void 0:U.docs)==null?void 0:W.source}}};var Y,Z,ee;A.parameters={...A.parameters,docs:{...(Y=A.parameters)==null?void 0:Y.docs,source:{originalSource:`args => ({
  components: {
    DTagInput
  },
  data: () => ({
  ...
  template: \`<d-tag-input @tag-added="onTagAdded" @text-changed="onTextChanged" @tag-deleted="onTagDeleted" @tag-changed="onTagChanged" v-model="input" v-bind="args" />\`
})`,...(ee=(Z=A.parameters)==null?void 0:Z.docs)==null?void 0:ee.source}}};var ae,ne,oe;y.parameters={...y.parameters,docs:{...(ae=y.parameters)==null?void 0:ae.docs,source:{originalSource:"DarkModeTemplateFactory()",...(oe=(ne=y.parameters)==null?void 0:ne.docs)==null?void 0:oe.source}}};const pe=["SizeMassive","HasError","SizeMassiveDark","SizeHuge","SizeHugeDark","SizeXLarge","SizeXLargeDark","SizeLarge","SizeLargeDark","SizeMedium","SizeMediumDark","SizeSmall","SizeSmallDark"];export{g as HasError,d as SizeHuge,l as SizeHugeDark,p as SizeLarge,u as SizeLargeDark,r as SizeMassive,s as SizeMassiveDark,T as SizeMedium,m as SizeMediumDark,A as SizeSmall,y as SizeSmallDark,c as SizeXLarge,i as SizeXLargeDark,pe as __namedExportsOrder,ie as default};
//# sourceMappingURL=DTagInput.stories-2c31c4d9.js.map
