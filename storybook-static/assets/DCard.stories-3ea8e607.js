import{u as M,ax as r,o as tr,J as or,_ as sr}from"./DWysiwyg-2b801905.js";import"./vue.esm-bundler-6f1630d7.js";import"./iframe-6b342987.js";import"../sb-preview/runtime.js";import"./_commonjsHelpers-042e6b4d.js";import"./floating-ui.dom-c3a31ea6.js";const Dr={title:"Card",tags:["autodocs"],component:M,argTypes:{title:{control:{type:"text"}},icon:{control:{type:"object"}},selected:{control:{type:"boolean"}},radio:{control:{type:"boolean"}},checkbox:{control:{type:"boolean"}},desc:{control:{type:"text"}},value:{control:{type:"text"}},ringSize:{control:{type:"text"},default:"16px"},ringThickness:{control:{type:"text"},default:"5px"}}},a=o=>({components:{DCard:M},data:()=>({selected:!1}),setup(){return{args:o}},template:'<d-card v-model="selected" value="something" v-bind="args" />'}),nr=o=>({components:{DCard:M,DarkModeProvider:sr},data:()=>({selected:!1}),setup(){return{args:o}},template:'<dark-mode-provider :dark-mode="true"><d-card value="something" v-model="selected" v-bind="args" /></dark-mode-provider>'}),e=(o=null)=>{const B=o?o.bind({}):nr.bind({});return B.decorators=[()=>({template:'<div style="padding: 3em; background: #121A26;"><story /></div>'})],B},cr=o=>({components:{DCard:M,DBox:tr,DHeading:or},data:()=>({selected:!1}),setup(){return{args:o}},template:`<d-card v-model="selected"  value="selected" v-bind="args">
  ...
  template: \`<d-card v-model="selected" value="something" v-bind="args" />\`
})`,...(z=(j=f.parameters)==null?void 0:j.docs)==null?void 0:z.source}}};var J,O,q;N.parameters={...N.parameters,docs:{...(J=N.parameters)==null?void 0:J.docs,source:{originalSource:"DarkModeTemplateFactory()",...(q=(O=N.parameters)==null?void 0:O.docs)==null?void 0:q.source}}};var G,K,Q;y.parameters={...y.parameters,docs:{...(G=y.parameters)==null?void 0:G.docs,source:{originalSource:`args => ({
  components: {
    DCard
  },
  data: () => ({
  ...
  template: \`<d-card v-model="selected" value="something" v-bind="args" />\`
})`,...(ze=(je=D.parameters)==null?void 0:je.docs)==null?void 0:ze.source}}};var Je,Oe,qe;h.parameters={...h.parameters,docs:{...(Je=h.parameters)==null?void 0:Je.docs,source:{originalSource:"DarkModeTemplateFactory()",...(qe=(Oe=h.parameters)==null?void 0:Oe.docs)==null?void 0:qe.source}}};var Ge,Ke,Qe;k.parameters={...k.parameters,docs:{...(Ge=k.parameters)==null?void 0:Ge.docs,source:{originalSource:`args => ({
  components: {
    DCard
  },
  data: () => ({
...
//# sourceMappingURL=DCard.stories-3ea8e607.js.map
