import{P as w,Q as O,R as T}from"./DAccordion-DPvhlSJk.js";import"./vue.esm-bundler-CUqwZzoc.js";import{s as F}from"./selectProps-BklhDr32.js";import"./iframe-CY1HI4ps.js";import"../sb-preview/runtime.js";import"./_commonjsHelpers-BosuxZz1.js";const V={component:w,title:"Forms/Country Dropdown",tags:["autodocs"],argTypes:{...O,...F}},r=x=>({components:{DCountryDropdown:w,DSelect:T},data:()=>({country:"",states:[],selectedState:""}),setup(){return{args:x}},methods:{hydrateStates:function(C){this.states=C.map(o=>({text:o.name,value:o.name}))}},template:`
