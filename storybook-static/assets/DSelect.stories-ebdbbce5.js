import{B as V,m as e,_ as rr}from"./DWysiwyg-a2525844.js";import"./vue.esm-bundler-a99e1ba3.js";import"./floating-ui.dom-c3a31ea6.js";import"./_commonjsHelpers-042e6b4d.js";const dr={title:"Forms/Select Field",component:V,tags:["autodocs"],argTypes:{label:{control:{type:"text"}},size:{control:{type:"select"},options:["small","medium","large","xlarge","huge","massive"]},leftIcon:{control:{type:"object"}},errorMessage:{control:{type:"text"}},wrapperClass:{control:{type:"text"}},options:{control:{type:"object"},table:{defaultValue:["Item 1","Item 2","Item 3"]}},placeholderEffect:{control:{type:"boolean"},table:{defaultValue:!0}},disabled:{control:{type:"boolean"}},optionTitle:{control:{type:"text"}},optionValue:{control:{type:"text"}},returnFullObject:{control:{type:"boolean"}}}},ar=o=>({components:{DSelect:V,DarkModeProvider:rr},data:()=>({value:""}),setup(){return{args:o}},template:`
  ...
  template: \`
    <d-select v-bind="args" />\`
})`,...(X=(R=n.parameters)==null?void 0:R.docs)==null?void 0:X.source}}};var C,O,B;c.parameters={...c.parameters,docs:{...(C=c.parameters)==null?void 0:C.docs,source:{originalSource:"DarkModeTemplateFactory()",...(B=(O=c.parameters)==null?void 0:O.docs)==null?void 0:B.source}}};var Y,$,q;l.parameters={...l.parameters,docs:{...(Y=l.parameters)==null?void 0:Y.docs,source:{originalSource:`args => ({
  components: {
    DSelect
  },
  setup() {
  ...
  template: \`
    <d-select v-bind="args" />\`
})`,...(Xe=(Re=z.parameters)==null?void 0:Re.docs)==null?void 0:Xe.source}}};var Ce,Oe,Be;y.parameters={...y.parameters,docs:{...(Ce=y.parameters)==null?void 0:Ce.docs,source:{originalSource:"DarkModeTemplateFactory()",...(Be=(Oe=y.parameters)==null?void 0:Oe.docs)==null?void 0:Be.source}}};var Ye,$e,qe;I.parameters={...I.parameters,docs:{...(Ye=I.parameters)==null?void 0:Ye.docs,source:{originalSource:`args => ({
  components: {
    DSelect
  },
  setup() {
...
//# sourceMappingURL=DSelect.stories-ebdbbce5.js.map
