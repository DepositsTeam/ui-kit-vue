import{v as i,w as f,x as B,y as k,h as _}from"./DAccordion-CN3Js_XK.js";import"./vue.esm-bundler-DYd614QV.js";import"./iframe-DxcWvM7r.js";import"../sb-preview/runtime.js";import"./_commonjsHelpers-BosuxZz1.js";const S={title:"Card 3",component:i,argTypes:{title:{control:{type:"text"}},subtitle:{control:{type:"text"}},description:{control:{type:"text"}},image:{control:{type:"text"}},topBgColor:{control:{type:"color"}},bottomBgColor:{control:{type:"color"}},imageBgColor:{control:{type:"color"}}}},v=r=>({components:{DCard3:i,DCol:f,DRow:B,DResponsiveLayout:k,DBox:_},setup(){return{args:r}},template:`
      <d-responsive-layout>
        <d-row>
