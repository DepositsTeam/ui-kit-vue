import{at as a,C as n,E as w,h as U,F as H,G as N,o as P,m as J}from"./DWysiwyg-ceedb84c.js";import"./vue.esm-bundler-41d8d808.js";import"./floating-ui.dom-c3a31ea6.js";import"./_commonjsHelpers-042e6b4d.js";const Y={title:"Forms/Checkbox Card",component:a,tags:["autodocs"],argTypes:{}},L=e=>({components:{DCheckboxCard:a,CardIcon:n},data:()=>({value:!1}),setup(){return{args:e}},template:`
  ...
  `}),l=$.bind({}),G=e=>({components:{DCheckboxCard:a},data:()=>({value:""}),setup(){return{args:e}},template:`
    ...
    <p>Checkbox value is: {{value}}</p>
  `}),r=G.bind({});r.args={heading:"One time payment",description:"Use this option to collect a one off payment"};const j=e=>({components:{DCheckboxCard:a,DFilePicker:H,CardIcon:n},data:()=>({value:""}),setup(){return{args:e}},template:`
    <d-checkbox-card v-model="value" value="value" v-bind="args">
      <template #icon>
        <card-icon />
      </template>
  ...
  `}),d=j.bind({});d.args={heading:"One time payment",description:"Use this option to collect a one off payment",expandable:!0};const q=e=>({components:{DCheckboxCard:a,DFilePicker:H,CardIcon:n},data:()=>({value:""}),setup(){return{args:e}},template:`
    ...
    <p>Checkbox value is: {{value}}</p>
  `}),s=q.bind({});s.args={heading:"One time payment",description:"Use this option to collect a one off payment",expandable:!0};const z=e=>({components:{DCheckboxCard:a,CardIcon:n,DHeading:N,DText:P,DAutoLayout:U,DBox:J},data:()=>({value:""}),setup(){return{args:e}},template:`<d-checkbox-card v-model="value" value="value" v-bind="args">
  <template #icon>
    <card-icon />
  </template>
  <template #heading>
  ...
  template: \`
    ...
    <p>Checkbox value is: {{value}}</p>
  \`
})`,...(_=(S=d.parameters)==null?void 0:S.docs)==null?void 0:_.source}}};var E,F,O;s.parameters={...s.parameters,docs:{...(E=s.parameters)==null?void 0:E.docs,source:{originalSource:`args => ({
  components: {
    DCheckboxCard,
    DFilePicker,
    CardIcon
  ...
  template: \`
    ...
    <p>Checkbox value is: {{value}}</p>
  \`
})`,...(O=(F=s.parameters)==null?void 0:F.docs)==null?void 0:O.source}}};var W,B,M;i.parameters={...i.parameters,docs:{...(W=i.parameters)==null?void 0:W.docs,source:{originalSource:`args => ({
  components: {
    DCheckboxCard,
    CardIcon,
    DHeading,
...
//# sourceMappingURL=DCheckboxCard.stories-e6c8f074.js.map
