import{a2 as g,_ as L}from"./DWysiwyg-c17e0e8e.js";import"./vue.esm-bundler-ea20084a.js";import"./_commonjsHelpers-042e6b4d.js";import"./floating-ui.dom-c3a31ea6.js";const X={title:"Progress bar",component:g,tags:["autodocs"],argTypes:{percentage:{control:{type:"text"}},totalSteps:{control:{type:"number"}},currentStep:{control:{type:"number"}},fillColor:{control:{type:"color"}},emptyColor:{control:{type:"color"}},darkFillColor:{control:{type:"color"}},darkEmptyColor:{control:{type:"color"}},variant:{control:{type:"select"},options:["variant-1","variant-2"],default:"variant-1"},height:{control:{type:"text"},default:"6px"}}},e=r=>({components:{DProgressBar:g},setup(){return{args:r}},template:'<d-progress-bar v-bind="args" />'}),N=r=>({components:{DProgressBar:g,DarkModeProvider:L},setup(){return{args:r}},template:`
...
//# sourceMappingURL=DProgressBar.stories-ab68f783.js.map
