import{v as f,D as k}from"./UndoOutlineIcon-7f54b2d3.js";import"./vue.esm-bundler-d253c880.js";import"./floating-ui.dom-c3a31ea6.js";import"./_commonjsHelpers-042e6b4d.js";const I={title:"Menu (Context or Dropdown menu)",component:f,argTypes:{}},i=n=>({components:{DMenu:f,DButton:k},data:()=>({}),methods:{consoleOption:function(B){}},setup(){return{args:n}},template:`<d-menu v-bind="args" @option-clicked="(option) => consoleOption(option, item)">
  <d-button>...</d-button>
...
//# sourceMappingURL=DMenu.stories-d410289c.js.map
