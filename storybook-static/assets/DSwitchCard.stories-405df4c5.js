import{E as a,F as n,G as V,f as J,H as N,I as $,p as G,n as j,J as q}from"./DVerticalMovable-99916a1b.js";import"./vue.esm-bundler-aecd4be6.js";import"./_commonjsHelpers-042e6b4d.js";import"./floating-ui.dom-c3a31ea6.js";const oe={title:"Forms/Switch Card",component:a,argTypes:{},tags:["autodocs"]},P=e=>({components:{DSwitchCard:a,CardIcon:n},data:()=>({value:!1}),setup(){return{args:e}},template:`
  ...
  `}),t=P.bind({});t.args={heading:"Card",description:"Add your debit / credit card information",label:"Select card option"};const z=e=>({components:{DSwitchCard:a,CardIcon:n},data:()=>({value:!1}),setup(){return{args:e}},template:`
    ...
    <p>Checkbox value is: {{value}}</p>
  `}),o=z.bind({});o.args={heading:"Card",description:"Add your debit / credit card information"};const r=P.bind({});r.args={heading:"Card",description:"Add your debit / credit card information"};const K=e=>({components:{DSwitchCard:a,CardIcon:n,BankIcon:V,DAutoLayout:J},data:()=>({values:[]}),setup(){return{args:e}},template:`
  ...
  `}),d=R.bind({});d.args={heading:"One time payment",description:"Use this option to collect a one off payment",expandable:!0};const X=e=>({components:{DSwitchCard:a,DFilePicker:N,CardIcon:n},data:()=>({value:""}),setup(){return{args:e}},template:`
    ...
    <p>Checkbox value is: {{value}}</p>
  `}),s=X.bind({});s.args={heading:"One time payment",description:"Use this option to collect a one off payment",expandable:!0};const Y=e=>({components:{DSwitchCard:a,CardIcon:n,DHeading:$,DText:G,DAutoLayout:J,DBox:j},data:()=>({value:""}),setup(){return{args:e}},template:`<d-switch-card v-model="value" value="value" v-bind="args">
  <template #icon>
    <card-icon />
  </template>
  <template #heading>
...
//# sourceMappingURL=DSwitchCard.stories-405df4c5.js.map
