import{al as d,_ as f}from"./DWysiwyg-02771dd6.js";import"./vue.esm-bundler-77038495.js";import"./iframe-468a85b4.js";import"../sb-preview/runtime.js";import"./_commonjsHelpers-042e6b4d.js";import"./floating-ui.dom-c3a31ea6.js";const H={title:"Forms/Counter",component:d,tags:["autodocs"],argTypes:{fontFace:{control:{type:"text"}},errorMessage:{control:{type:"text"}},name:{control:{type:"text"}},label:{control:{type:"text"}},labelFontFace:{control:{type:"text"}},labelClass:{control:{type:"text"}},placeholder:{control:{type:"text"}}}},o=s=>({components:{DCounter:d},data:()=>({value:""}),setup(){return{args:s}},template:'<d-counter v-model="value" v-bind="args"></d-counter>'}),_=s=>({components:{DCounter:d,DarkModeProvider:f},data:()=>({value:""}),setup(){return{args:s}},template:`
...
//# sourceMappingURL=DCounter.stories-3828676a.js.map
