import{n as h,_ as te}from"./DWysiwyg-688f494a.js";import"./vue.esm-bundler-673e2372.js";import"./floating-ui.dom-c3a31ea6.js";import"./_commonjsHelpers-042e6b4d.js";const ce={title:"Forms/Tag Input",component:h,argTypes:{label:{control:{type:"text"}},size:{control:{type:"select"},options:["small","medium","large","xlarge","huge","massive"]},values:{control:{type:"object"},table:{defaultValue:["Option 1","Option 2","Option 3"]}},tagDelimiterKey:{control:{type:"select"},options:["enter","comma","space"],table:{defaultValue:"enter"}}}},a=o=>({components:{DTagInput:h},data:()=>({input:["Option one","Option 2","Option 3"]}),methods:{onTagAdded:function(e,n){console.log(e,n)},onTagChanged:function(e,n){console.log(e,n)},onTagDeleted:function(e,n){console.log(e,n)},onTextChanged:function(e){console.log(e)}},setup(){return{args:o}},template:'<d-tag-input @tag-added="onTagAdded" @text-changed="onTextChanged" @tag-deleted="onTagDeleted" @tag-changed="onTagChanged" v-model="input" v-bind="args" />'}),re=o=>({components:{DTagInput:h,DarkModeProvider:te},data:()=>({input:["Option one","Option 2","Option 3"]}),methods:{onTagAdded:function(e,n){console.log(e,n)},onTagChanged:function(e,n){console.log(e,n)},onTagDeleted:function(e,n){console.log(e,n)},onTextChanged:function(e){console.log(e)}},setup(){return{args:o}},template:`
    ...
    `}),t=()=>{const o=re.bind({});return o.decorators=[()=>({template:'<div style="padding: 3em; background: #121A26;"><story /></div>'})],o},r=a.bind({});r.args={label:"Form Label",size:"massive"};const g=a.bind({});g.args={label:"Form Label",size:"massive",errorMessage:"Random, default error"};const s=t();s.args={label:"Form Label",size:"massive"};const d=a.bind({});d.args={label:"Form Label",size:"huge"};const l=t();l.args={label:"Form Label",size:"huge"};const c=a.bind({});c.args={label:"Form Label",size:"xlarge"};const i=t();i.args={label:"Form Label",size:"xlarge"};const p=a.bind({});p.args={label:"Form Label",size:"large"};const u=t();u.args={label:"Form Label",size:"large"};const m=a.bind({});m.args={label:"Form Label",size:"medium"};const T=t();T.args={label:"Form Label",size:"medium"};const A=a.bind({});A.args={label:"Form Label",size:"small"};const y=t();y.args={label:"Form Label",size:"small"};var D,b,v;r.parameters={...r.parameters,docs:{...(D=r.parameters)==null?void 0:D.docs,source:{originalSource:`args => ({
  components: {
    DTagInput
  },
  data: () => ({
