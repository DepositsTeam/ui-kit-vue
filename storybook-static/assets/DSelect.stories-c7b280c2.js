import{K as V,o as e,_ as rr}from"./DWysiwyg-9bf70373.js";import"./vue.esm-bundler-7e79c529.js";import"./floating-ui.dom-c3a31ea6.js";import"./_commonjsHelpers-87174ba5.js";const dr={title:"Forms/Select Field",component:V,argTypes:{label:{control:{type:"text"}},size:{control:{type:"select"},options:["small","medium","large","xlarge","huge","massive"]},leftIcon:{control:{type:"object"}},errorMessage:{control:{type:"text"}},wrapperClass:{control:{type:"text"}},options:{control:{type:"object"},table:{defaultValue:["Item 1","Item 2","Item 3"]}},placeholderEffect:{control:{type:"boolean"},table:{defaultValue:!0}},disabled:{control:{type:"boolean"}},optionTitle:{control:{type:"text"}},optionValue:{control:{type:"text"}},returnFullObject:{control:{type:"boolean"}}}},ar=o=>({components:{DSelect:V,DarkModeProvider:rr},data:()=>({value:""}),setup(){return{args:o}},template:`
...
//# sourceMappingURL=DSelect.stories-c7b280c2.js.map
