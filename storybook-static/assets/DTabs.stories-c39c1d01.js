import{z as x,d as Q,e as R,A as V,B as X,_ as Y}from"./DWysiwyg-3bd6c6b4.js";import"./vue.esm-bundler-673e2372.js";import"./floating-ui.dom-c3a31ea6.js";import"./_commonjsHelpers-042e6b4d.js";const oe={title:"Tabs",component:x,argTypes:{tabs:{control:{type:"object"}},horizontal:{control:{type:"boolean"}},spacing:{control:{type:"text"}},initiallyActive:{control:{type:"text"}},inline:{control:{type:"boolean"}},scheme:{control:{type:"select"},options:["button","underline","inline","underline_card"]}}},t=e=>({components:{DTabs:x},setup(){return{args:e}},template:'<d-tabs v-bind="args" />'}),Z=e=>({components:{DTabs:x,DarkModeProvider:Y},setup(){return{args:e}},template:`
  ...
  template: \`<d-tabs v-bind="args" />\`
})`,...(k=(y=n.parameters)==null?void 0:y.docs)==null?void 0:k.source}}};var B,_,A;s.parameters={...s.parameters,docs:{...(B=s.parameters)==null?void 0:B.docs,source:{originalSource:`args => ({
  components: {
    DTabs
  },
  setup() {
  ...
  template: \`<d-tabs v-bind="args" />\`
})`,...(A=(_=s.parameters)==null?void 0:_.docs)==null?void 0:A.source}}};var U,W,F;d.parameters={...d.parameters,docs:{...(U=d.parameters)==null?void 0:U.docs,source:{originalSource:`args => ({
  components: {
    DTabs
  },
  setup() {
  ...
  template: \`<d-tabs v-bind="args" />\`
})`,...(F=(W=d.parameters)==null?void 0:W.docs)==null?void 0:F.source}}};var w,M,z;o.parameters={...o.parameters,docs:{...(w=o.parameters)==null?void 0:w.docs,source:{originalSource:`args => ({
  components: {
    DTabs,
    DFilterDropdown
  },
  ...
  \`
})`,...(z=(M=o.parameters)==null?void 0:M.docs)==null?void 0:z.source}}};var j,E,O;b.parameters={...b.parameters,docs:{...(j=b.parameters)==null?void 0:j.docs,source:{originalSource:`args => ({
  components: {
    DTabs
  },
  setup() {
...
//# sourceMappingURL=DTabs.stories-c39c1d01.js.map
