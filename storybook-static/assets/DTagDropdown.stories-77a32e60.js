import{I as g,J as ne,K as oe,_ as ae}from"./DWysiwyg-12d27571.js";import"./vue.esm-bundler-d57a814c.js";import"./floating-ui.dom-c3a31ea6.js";import"./_commonjsHelpers-87174ba5.js";const ce={title:"Forms/Tag Dropdown",component:g,tags:["autodocs"],argTypes:{...ne,placeholder:{control:{type:"text"}},showCheckboxes:{control:{type:"boolean"}},options:{control:{type:"object"}}}},v=e=>({components:{DTagDropdown:g},data:()=>({value:[]}),setup(){return{args:e}},template:'<d-tag-dropdown v-model="value" v-bind="args" />'}),D=e=>({components:{DTagDropdown:g},data:()=>({value:["banking","money"]}),setup(){return{args:e}},template:`
  ...
  template: \`<d-tag-dropdown v-model="value" v-bind="args" />\`
})`,...(M=(x=o.parameters)==null?void 0:x.docs)==null?void 0:M.source}}};var F,I,L;t.parameters={...t.parameters,docs:{...(F=t.parameters)==null?void 0:F.docs,source:{originalSource:`args => ({
  components: {
    DTagDropdown
  },
  data: () => ({
  ...
  template: \`
    ...
    <p>Selected value is {{value}}</p>
  \`
})`,...(K=(J=i.parameters)==null?void 0:J.docs)==null?void 0:K.source}}};var $,q,z;l.parameters={...l.parameters,docs:{...($=l.parameters)==null?void 0:$.docs,source:{originalSource:`args => ({
  components: {
    DTagDropdown
  },
  data: () => ({
  ...
  template: \`
    ...
    <p>Selected value is {{value}}</p>
  \`
})`,...(z=(q=l.parameters)==null?void 0:q.docs)==null?void 0:z.source}}};var G,N,Q;c.parameters={...c.parameters,docs:{...(G=c.parameters)==null?void 0:G.docs,source:{originalSource:"DarkModeTemplateFactory(DarkModePredefinedTemplate)",...(Q=(N=c.parameters)==null?void 0:N.docs)==null?void 0:Q.source}}};var R,V,X;m.parameters={...m.parameters,docs:{...(R=m.parameters)==null?void 0:R.docs,source:{originalSource:`args => ({
  components: {
    DTagDropdown
  },
  data: () => ({
...
//# sourceMappingURL=DTagDropdown.stories-77a32e60.js.map
