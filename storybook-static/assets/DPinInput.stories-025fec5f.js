import{$ as c,_ as K}from"./DWysiwyg-688f494a.js";import"./vue.esm-bundler-673e2372.js";import"./floating-ui.dom-c3a31ea6.js";import"./_commonjsHelpers-042e6b4d.js";const Z={title:"Forms/Pin Input",component:c,argTypes:{spacing:{control:{type:"text"}},password:{control:{type:"boolean"}},noOfCharacters:{control:{type:"number"}}}},l=r=>({components:{DPinInput:c},data:()=>({pin:""}),setup(){return{args:r}},template:`
  ...
  template: \`
    <d-pin-input v-model="pin" v-bind="args" />\`
})`,...(h=(V=o.parameters)==null?void 0:V.docs)==null?void 0:h.source}}};var A,B,$;t.parameters={...t.parameters,docs:{...(A=t.parameters)==null?void 0:A.docs,source:{originalSource:"DarkModeTemplateFactory()",...($=(B=t.parameters)==null?void 0:B.docs)==null?void 0:$.source}}};var j,q,z;p.parameters={...p.parameters,docs:{...(j=p.parameters)==null?void 0:j.docs,source:{originalSource:`args => ({
  components: {
    DPinInput
  },
  data: () => ({
  ...
  template: \`
    <d-pin-input v-model="pin" v-bind="args" />\`
})`,...(z=(q=p.parameters)==null?void 0:q.docs)==null?void 0:z.source}}};var C,G,J;d.parameters={...d.parameters,docs:{...(C=d.parameters)==null?void 0:C.docs,source:{originalSource:"DarkModeTemplateFactory()",...(J=(G=d.parameters)==null?void 0:G.docs)==null?void 0:J.source}}};const rr=["DefaultVal","DarkDefaultVal","Password","DarkPassword","Text","DarkText","OnlyNumbers","DarkOnlyNumbers","HasError","DarkHasError"];export{u as DarkDefaultVal,d as DarkHasError,t as DarkOnlyNumbers,a as DarkPassword,s as DarkText,i as DefaultVal,p as HasError,o as OnlyNumbers,e as Password,n as Text,rr as __namedExportsOrder,Z as default};
//# sourceMappingURL=DPinInput.stories-025fec5f.js.map
