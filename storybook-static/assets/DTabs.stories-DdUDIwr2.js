import{ar as v,h as ye,n as _e,r as We,a1 as ke,f as Ae}from"./DAccordion-BcJ7fCmy.js";import"./vue.esm-bundler-XIZ-WwZ4.js";import"./iframe-CdPvGOON.js";import"../sb-preview/runtime.js";import"./_commonjsHelpers-BosuxZz1.js";const Pe={title:"Tabs",component:v,tags:["autodocs"],argTypes:{tabs:{control:{type:"object"}},horizontal:{control:{type:"boolean"}},spacing:{control:{type:"text"}},initiallyActive:{control:{type:"text"}},inline:{control:{type:"boolean"}},scheme:{control:{type:"select"},options:["button","underline","inline","underline_card"]}}},e=t=>({components:{DTabs:v},setup(){return{args:t}},template:'<d-tabs v-bind="args" />'}),Fe=t=>({components:{DTabs:v,DarkModeProvider:Ae},setup(){return{args:t}},template:`
...
})`,...(I=(C=a.parameters)==null?void 0:C.docs)==null?void 0:I.source}}};var U,y,_;r.parameters={...r.parameters,docs:{...(U=r.parameters)==null?void 0:U.docs,source:{originalSource:`args => ({
  components: {
    DTabs
  },
  setup() {
  ...
  template: \`<d-tabs v-bind="args" />\`
})`,...(_=(y=r.parameters)==null?void 0:y.docs)==null?void 0:_.source}}};var W,k,A;n.parameters={...n.parameters,docs:{...(W=n.parameters)==null?void 0:W.docs,source:{originalSource:"DarkModeTemplateFactory()",...(A=(k=n.parameters)==null?void 0:k.docs)==null?void 0:A.source}}};var F,w,M;D.parameters={...D.parameters,docs:{...(F=D.parameters)==null?void 0:F.docs,source:{originalSource:`args => ({
  components: {
    DTabs,
    DBox,
    DText,
  ...
  template: \`
    ...
    <d-text>Active Tab Index: {{activeTabIndex}}</d-text>
  \`
})`,...(M=(w=D.parameters)==null?void 0:w.docs)==null?void 0:M.source}}};var $,j,z;s.parameters={...s.parameters,docs:{...($=s.parameters)==null?void 0:$.docs,source:{originalSource:`args => ({
  components: {
    DTabs
  },
  setup() {
  ...
  template: \`<d-tabs v-bind="args" />\`
})`,...(z=(j=s.parameters)==null?void 0:j.docs)==null?void 0:z.source}}};var E,O,P;o.parameters={...o.parameters,docs:{...(E=o.parameters)==null?void 0:E.docs,source:{originalSource:`args => ({
  components: {
    DTabs
  },
  setup() {
  ...
  template: \`<d-tabs v-bind="args" />\`
})`,...(P=(O=o.parameters)==null?void 0:O.docs)==null?void 0:P.source}}};var q,G,H;d.parameters={...d.parameters,docs:{...(q=d.parameters)==null?void 0:q.docs,source:{originalSource:`args => ({
  components: {
    DTabs
  },
  setup() {
