import{av as c,Q as w,f as H}from"./DAccordion-DYIgxZVa.js";import"./vue.esm-bundler-XIZ-WwZ4.js";import"./iframe-C0jbynlU.js";import"../sb-preview/runtime.js";import"./_commonjsHelpers-BosuxZz1.js";const P={title:"Forms/Text Area",component:c,tags:["autodocs"],argTypes:{...w,label:{control:{type:"text"}},disabled:{control:{type:"boolean"}},errorMessage:{control:{type:"text"}},textAreaClassName:{control:{type:"text"}},size:{control:{type:"select"},options:["small","medium","large","xlarge","huge","massive"]},fontFace:{control:{type:"select"},options:["circularSTD","heroNew"]},rows:{control:{type:"text"}},minHeight:{control:{type:"text"}},maxHeight:{control:{type:"text"}}}},d=e=>({components:{DTextarea:c},data:()=>({text:"dd"}),setup:function(){return{args:e}},template:'<d-textarea v-bind="args" v-model="text" />'}),N=e=>({components:{DTextarea:c,DarkModeProvider:H},data:()=>({value:""}),setup(){return{args:e}},template:`
