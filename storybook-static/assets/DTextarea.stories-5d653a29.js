import{a7 as c,_ as A}from"./DAccordion-a61d52f6.js";import"./vue.esm-bundler-02a62393.js";import"./_commonjsHelpers-87174ba5.js";const B={title:"Forms/Text Area",component:c,argTypes:{label:{control:{type:"text"}},disabled:{control:{type:"boolean"}},errorMessage:{control:{type:"text"}},textAreaClassName:{control:{type:"text"}},size:{control:{type:"select"},options:["small","medium","large","xlarge","huge","massive"]},fontFace:{control:{type:"select"},options:["circularSTD","heroNew"]},rows:{control:{type:"text"}},minHeight:{control:{type:"text"}},maxHeight:{control:{type:"text"}}}},d=e=>({components:{DTextarea:c},data:()=>({text:"dd"}),setup:function(){return{args:e}},template:'<d-textarea v-bind="args" v-model="text" />'}),H=e=>({components:{DTextarea:c,DarkModeProvider:A},data:()=>({value:""}),setup(){return{args:e}},template:`
  ...
  template: \`<d-textarea v-bind="args" v-model="text" />\`
})`,...(w=(_=l.parameters)==null?void 0:_.docs)==null?void 0:w.source}}};const C=["Default","DefaultDark","Disabled","DisabledDark","Error","ErrorDark","FullWidth"];export{r as Default,a as DefaultDark,t as Disabled,o as DisabledDark,s as Error,n as ErrorDark,l as FullWidth,C as __namedExportsOrder,B as default};
//# sourceMappingURL=DTextarea.stories-5d653a29.js.map
