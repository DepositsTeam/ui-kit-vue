import{N as a,r as b,_ as g}from"./DWysiwyg-f68a34dd.js";import"./vue.esm-bundler-a99e1ba3.js";import"./floating-ui.dom-c3a31ea6.js";import"./_commonjsHelpers-042e6b4d.js";const k={title:"Forms/Switch",component:a,tags:["autodocs"],argTypes:{colorScheme:{control:{type:"select"},options:["primary","danger","success","outline","invisible"]},label:{control:{type:"text"}},disabled:{control:{type:"boolean"}},thumbColor:{control:{type:"color"}},switchColor:{control:{type:"color"}},alignRight:{control:{type:"boolean"}},thumbSize:{control:{type:"text"},default:"18px"},switchWidth:{control:{type:"text"},default:"56px"},switchHeight:{control:{type:"text"},default:"26px"}}},h=e=>({components:{DSwitch:a},setup(){return{args:e}},template:'<d-switch v-bind="args" />'}),x=e=>({components:{DSwitch:a,DarkModeProvider:g},setup(){return{args:e}},template:`
...
//# sourceMappingURL=DSwitch.stories-3497b7aa.js.map
